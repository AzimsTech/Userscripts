...
`).pop():/^\[[\s\S]+[^\]]$/.test(m)&&(m=m+"]")),JSON.parse(m)}catch{return null}};d.read().then(function m({done:h,value:f}){if(ri==l){if(h){t({text:p,json:u,finalUrl:n.finalUrl||l});return}a=e.streamMode==="standalone"?Array.from(f):a.concat(Array.from(f));try{p=new TextDecoder("utf-8").decode(new Uint8Array(a)),e.onstream({text:p,json:u,finalUrl:n.finalUrl||l})}catch(b){console.log(b)}return d.read().then(m)}})}),Be(s)})):null:qe=fetch,St?nt=(l,e)=>{}:typeof GM_registerMenuCommand<"u"?nt=GM_registerMenuCommand:typeof GM<"u"&&typeof GM.registerMenuCommand<"u"?nt=GM.registerMenuCommand:nt=(l,e)=>{},typeof GM_openInTab<"u"?ge=GM_openInTab:typeof GM<"u"&&typeof GM.openInTab<"u"?ge=GM.openInTab:ge=(l,e)=>{window.open(l)},typeof GM_notification<"u"?Ce=l=>GM_notification({text:l,onclick:e=>ge(Ae,{active:!0})}):typeof GM<"u"&&typeof GM.notification<"u"?Ce=l=>GM.notification({text:l,onclick:e=>ge(Ae,{active:!0})}):Ce=l=>{},typeof GM_setClipboard<"u"?Re=GM_setClipboard:typeof GM<"u"&&typeof GM.setClipboard<"u"?Re=GM.setClipboard:Re=(l,e)=>{try{nr.writeText(l).then(()=>{console.log("Text copied to clipboard")}).catch(t=>{document.execCommand("copy"),console.error("Failed to copy text: ",t)})}catch{document.execCommand("copy")}},Me=l=>{if(l=l.replace(/\n\s*/g,""),typeof GM_addStyle<"u")return GM_addStyle(l);{let e=document.createElement("style");return e.innerHTML=ee(l),document.head.appendChild(e),e}},typeof GM_info<"u"?pt=GM_info:typeof GM<"u"&&typeof GM.info<"u"?pt=GM.info:pt={script:{name:"SearchJumper",version:0}},ye.searchJumperAddons||(ye.searchJumperAddons=[]);const $i=document.referrer;let ue=location.href.slice(0,500);var K={supportGM:typeof GM_getValue=="function"&&typeof GM_getValue("a","b")<"u",supportGMPromise:typeof GM<"u"&&typeof GM.getValue=="function"&&typeof GM.getValue("a","b")<"u",supportCrossSave:function(){return this.supportGM||this.supportGMPromise},listItemCache:[],mxAppStorage:function(){try{return window.external.mxGetRuntime().storage}catch{}}(),operaUJSStorage:function(){try{return window.opera.scriptStorage}catch{}}(),setItem:function(l,e){this.supportGMPromise?(GM.setValue(l,e),e===""&&typeof GM<"u"&&typeof GM.deleteValue<"u"&&GM.deleteValue(l)):this.supportGM?(GM_setValue(l,e),e===""&&typeof GM_deleteValue<"u"&&GM_deleteValue(l)):this.operaUJSStorage?this.operaUJSStorage.setItem(l,e):this.mxAppStorage?this.mxAppStorage.setConfig(l,e):window.localStorage&&window.localStorage.setItem(l,e)},getItem:async function(l,e){var t;return this.supportGMPromise?t=await GM.getValue(l):this.supportGM?t=GM_getValue(l):this.operaUJSStorage?t=this.operaUJSStorage.getItem(l):this.mxAppStorage?t=this.mxAppStorage.getConfig(l):window.localStorage&&(t=window.localStorage.getItem(l)),e&&e(t),t},getListItem:async function(l,e){var t=this.listItemCache[l];if(typeof t>"u"&&(t=await this.getItem(l),this.listItemCache[l]=t||null),!t)return null;for(var r=0;r<t.length;r++){let i=t[r];if(i.k==e)return i.v}return null},setListItem:async function(l,e,t){var r=this.listItemCache[l];typeof r>"u"&&(r=await this.getItem(l)),r||(r=[]),r=r.filter(i=>i&&i.k!=e),t&&(r.unshift({k:e,v:t}),r.length>50&&r.pop()),this.setItem(l,r),this.listItemCache[l]=r}};class cr{constructor(e,t,r){this.webDAVUrl=e,this.username=t,this.password=r}init(){this.inited||(this.inited=!0,this.auth=btoa(`${this.username}:${this.password}`))}request(e,t,r,i,s,n){{this.init();let a=this.webDAVUrl+r,o={referer:a,origin:a,"Content-Type":"text/xml; charset=UTF-8",Authorization:`Basic ${this.auth}`};for(let p in n)o[p]=n[p];Be({method:e,url:a,data:t,headers:o,onload:function(p){let d=p.response;if((p.status>=400||!d)&&(d=""),i=="xml"){var u=p.responseXML;u&&(d=u.firstChild.nextSibling?u.firstChild.nextSibling:u.firstChild)}s&&s(d)},onerror:function(p){he(p),s&&s(p)},ontimeout:function(p){he(p),s&&s(p)}})}}GET(e,t){return this.request("GET",null,e,"text",t,{})}PROPFIND(e,t){return this.request("PROPFIND",null,e,"xml",t,{Depth:"1"})}MKCOL(e,t){return this.request("MKCOL",null,e,"text",t,{})}DELETE(e,t){return this.request("DELETE",null,e,"text",t,{})}PUT(e,t,r){return this.request("PUT",t,e,"text",r,{})}async read(e){let t=this;return new Promise(r=>{t.GET(e,r)})}async write(e,t){let r=this;return new Promise(i=>{r.PUT(e,t,i)})}async rm(e){let t=this;return new Promise(r=>{t.DELETE(e,r)})}}var ot;async function Dt(l,e){if(Te)return;let t=await K.getItem("searchData");if(t&&(c=t),!ot)return l&&l();if(!e){let r=await ot.read("lastModified");if(r&&(r=parseFloat(r)),r&&(!c.lastModified||r>c.lastModified)){c.lastModified=r,jt=c.lastModified;let i=await ot.read("sitesConfig.json");if(i)try{i=JSON.parse(i),c.sitesConfig=i}catch(n){he(n)}let s=await ot.read("inPageRule.json");if(s)try{s=JSON.parse(s),c.prefConfig.inPageRule=s}catch(n){he(n)}}}l&&l(),await ot.write("lastModified",""+c.lastModified),await ot.write("sitesConfig.json",JSON.stringify(c.sitesConfig)),await ot.write("inPageRule.json",JSON.stringify(c.prefConfig.inPageRule))}var si;ye.trustedTypes&&ye.trustedTypes.createPolicy&&(si=ye.trustedTypes.createPolicy("searchjumper_default",{createHTML:(l,e)=>l}));const ai=Object.getPrototypeOf(async function(){}).constructor;typeof String.prototype.replaceAll!="function"&&(String.prototype.replaceAll=function(l,e){var t=this;return t.split(l).join(e)}),typeof String.prototype.endsWith!="function"&&(String.prototype.endsWith=function(l,e){return(e===void 0||e>this.length)&&(e=this.length),this.substring(e-l.length,e)===l}),typeof String.prototype.startsWith!="function"&&(String.prototype.startsWith=function(l,e){return this.slice(e||0,l.length)===l});function _(l){return l.body||l.querySelector("body")}function ht(l){return l.type.indexOf("touch")===0?l.changedTouches?l.changedTouches[0].clientX:0:l.clientX}function dt(l){return l.type.indexOf("touch")===0?l.changedTouches?l.changedTouches[0].clientY:0:l.clientY}function pr(l){return l.type.indexOf("touch")===0?l.changedTouches?l.changedTouches[0].pageX:0:l.pageX}function hr(l){return l.type.indexOf("touch")===0?l.changedTouches?l.changedTouches[0].pageY:0:l.pageY}function dr(l,e,t){t=t||document,e=e||t;var r=[];try{for(var i=t.evaluate(l,e,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null),s=0;s<i.snapshotLength;s++){var n=i.snapshotItem(s);n.nodeType===1&&r.push(n)}}catch{he(`Invalid xpath: ${l}`)}return r}function ur(l,e,t){t=t||document,e=e||t;try{let r=(s,n,a)=>{let o=n.evaluate(s,a,null,XPathResult.ANY_UNORDERED_NODE_TYPE,null);return o.singleNodeValue&&o.singleNodeValue.nodeType===1&&o.singleNodeValue},i=l.split(" =>> ");if(i.length===2){let s=r(i[0],t,e);if(s&&s.shadowRoot)return r(i[1],s.shadowRoot,s.shadowRoot)}else return r(l,t,e)}catch{return he(`Invalid xpath: ${l}`),!1}}function Wi(l){return l?/^\(*(descendant::|\.\/|\/\/|id\()/.test(l):!1}function ni(l,e,t){e||(e=document);try{if(!Wi(l))return e.querySelectorAll(l)}catch(r){he(r,"Error selector")}return dr(l,t,e)}function bt(l,e){e||(e=document);try{if(!Wi(l)){let t=l.split(" =>> ");if(t.length===2){let r=e.querySelector(t[0]);return r&&r.shadowRoot&&r.shadowRoot.querySelector(t[1])}else return e.querySelector(l)}}catch(t){he(t)}return ur(l,e,e)}function fr(l,e){for(var t=l.offsetTop,r=l.offsetParent;r;)t+=r.offsetTop,r=r.offsetParent;if(e){for(r=e;r;)t+=r.offsetTop,r=r.offsetParent;try{let i=e.contentWindow.parent;for(e=i.frameElement;e;){for(r=e;r;)t+=r.offsetTop,r=r.offsetParent;i=i.parent,e=i.frameElement}}catch{}}return t}function Or(l){for(var e=l.offsetLeft,t=l.offsetParent;t;)e+=t.offsetLeft,t=t.offsetParent;if(!document.isSameNode(l.ownerDocument)){let r=document.getElementsByTagName("iframe");for(let i=0;i<r.length;i++){let s=r[i],n;try{n=s.contentDocument||s.contentWindow.document}catch{break}if(n.isSameNode(l.ownerDocument)){for(t=s;t;)e+=t.offsetLeft,t=t.offsetParent;break}}}return e}function oi(l){const e=l.activeElement;return e?e.shadowRoot?oi(e.shadowRoot):e:null}function Di(l){if(l&&(/INPUT|TEXTAREA/i.test(l.nodeName)&&l.getAttribute("aria-readonly")!="true"||l.contentEditable=="true"))return!0;for(;l&&l.nodeName;){if(l.contentEditable=="true")return!0;if(l.nodeName.toUpperCase()=="BODY")break;l=l.parentNode}return!1}function Ct(l){let e=oi(l);return Di(e)}async function mr(l){for(;document.hidden;)await $e(500);var e=100,t="\uF0C8",r=function(){var i,s;e-=1,i=document.createElement("canvas"),i.width=20,i.height=20,s=i.getContext("2d",{willReadFrequently:!0}),s.fillStyle="rgba(0,0,0,1.0)",s.fillRect(0,0,20,20),s.font="16pt FontAwesome",s.textAlign="center",s.fillStyle="rgba(255,255,255,1.0)",s.fillText(t,10,18);var n=s.getImageData(2,10,1,1).data;n[0]==0&&n[1]==0&&n[2]==0?(s.font='16pt "Font Awesome 6 Free"',s.fillText(t,10,18),n=s.getImageData(2,10,1,1).data,n[0]==0&&n[1]==0&&n[2]==0?e>0&&setTimeout(r,150):typeof l=="function"&&l()):typeof l=="function"&&l()};setTimeout(r,100)}var lt,k,Se=[],ae=!1,li=!1,Ee,xt,tt,Oe,Tt,Ge,be,Ve,kt,Le,Pe,Je=[],Jt=[],It,Ne,Ye,zt,Ht,Ji,ci,zi=!1,jt=0,_e;const pi=`<svg class="search-jumper-logoBtnSvg" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><title>${pt.script.name}</title><path d="M.736 510.464c0-281.942 228.335-510.5 510-510.5 135.26 0 264.981 53.784 360.625 149.522 95.643 95.737 149.375 225.585 149.375 360.978 0 281.94-228.335 510.5-510 510.5-281.665 0-510-228.56-510-510.5zm510-510.5v1021m-510-510.5h1020" fill="#fefefe"/><path d="M237.44 346.624a48.64 48.64 0 1 0 97.28 0 48.64 48.64 0 1 0-97.28 0zM699.904 346.624a48.64 48.64 0 1 0 97.28 0 48.64 48.64 0 1 0-97.28 0zM423.296 759.296c-64 0-115.712-52.224-115.712-115.712 0-26.624 9.216-52.224 25.6-72.704 9.216-11.776 26.112-13.312 37.888-4.096s13.312 26.112 4.096 37.888c-9.216 11.264-13.824 24.576-13.824 38.912 0 34.304 27.648 61.952 61.952 61.952s61.952-27.648 61.952-61.952c0-4.096-.512-8.192-1.024-11.776-2.56-14.848 6.656-28.672 21.504-31.744 14.848-2.56 28.672 6.656 31.744 21.504 1.536 7.168 2.048 14.336 2.048 22.016-.512 63.488-52.224 115.712-116.224 115.712z" fill="#333"/><path d="M602.08 760.296c-64 0-115.712-52.224-115.712-115.712 0-14.848 12.288-27.136 27.136-27.136s27.136 12.288 27.136 27.136c0 34.304 27.648 61.952 61.952 61.952s61.952-27.648 61.952-61.952c0-15.36-5.632-30.208-15.872-41.472-9.728-11.264-9.216-28.16 2.048-37.888 11.264-9.728 28.16-9.216 37.888 2.048 19.456 21.504 29.696 48.64 29.696 77.824 0 62.976-52.224 115.2-116.224 115.2z" fill="#333"/><ellipse ry="58" rx="125" cy="506.284" cx="201.183" fill="#faf"/><ellipse ry="58" rx="125" cy="506.284" cx="823.183" fill="#faf"/></svg>`,ut="data:image/svg+xml;base64,",hi="data:image/svg+xml;base64,",Hi='<path d="M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64z m165.4 618.2l-66-0.3L512 563.4l-99.3 118.4-66.1 0.3c-4.4 0-8-3.5-8-8 0-1.9 0.7-3.7 1.9-5.2l130.1-155L340.5 359c-1.2-1.5-1.9-3.3-1.9-5.2 0-4.4 3.6-8 8-8l66.1 0.3L512 464.6l99.3-118.4 66-0.3c4.4 0 8 3.5 8 8 0 1.9-0.7 3.7-1.9 5.2L553.5 514l130 155c1.2 1.5 1.9 3.3 1.9 5.2 0 4.4-3.6 8-8 8z"></path>',di="%s[lurest]?\\b",ft=new RegExp(di);var B,ui,Et,Ze,Ri=!1;function gr(l,e,t){if(!l&&!e&&!t){let N=new Date,W=N.getFullYear(),I=N.getMonth(),H=N.getDate();l=N.getFullYear(),e=N.getMonth()+1,t=N.getDate()}let r=2e3,i=2,s=5,n=[51552,55636,54432,55888,30034,22176,43959,9680,37584,51893,43344,46240,47780,44368,21977,19360,42416,86390,21168,43312,31060,27296,44368,23378,19296,42726,42208,53856,60005,54576,23200,30371,38608,19195,19152,42192,118966,53840,54560,56645,46496,22224,21938,18864,42359,42160,43600,111189,27936,44448,84835,37744,18936,18800,25776,92326,59984,27424,108228,43744,41696,53987,51552,54615,54432,55888,23893,22176,42704,21972,21200,43448,43344,46240,46758,44368,21920,43940,42416,21168,45683,26928,29495,27296,44368,84821,19296,42352,21732,53600,59752,54560,55968,92838,22224,19168,43476,41680,53584,62034,54560],a="\u6B63\u4E8C\u4E09\u56DB\u4E94\u516D\u4E03\u516B\u4E5D\u5341\u51AC\u81D8",o="\u4E00\u4E8C\u4E09\u56DB\u4E94\u516D\u4E03\u516B\u4E5D\u5341\u521D\u5EFF",p="\u7532\u4E59\u4E19\u4E01\u620A\u5DF1\u5E9A\u8F9B\u58EC\u7678",d="\u5B50\u4E11\u5BC5\u536F\u8FB0\u5DF3\u5348\u672A\u7533\u9149\u620C\u4EA5",u="\u9F20\u725B\u864E\u5154\u9F8D\u86C7\u99AC\u7F8A\u7334\u96DE\u72D7\u8C6C";function m(N,W,I){W-=1;let H=(Date.UTC(N,W,I)-Date.UTC(r,i-1,s))/(1440*60*1e3)+1,V,F,y,j;for(let A=0;A<n.length;A++)if(H-=b(n[A]),H<=0){V=r+A,j=n[A],H+=b(j);break}if(!j)return null;for(let A=0;A<S(j).length;A++)if(H-=S(j)[A],H<=0){h(j)&&h(j)<=A?h(j)<A?F=A:h(j)===A?F="\u95F0"+A:F=A+1:F=A+1,H+=S(j)[A];break}return y=H,h(j)&&typeof F=="string"&&F.indexOf("\u95F0")>-1?F=`\u95F0${a[/\d/.exec(F)-1]}`:F=a[F-1],V=L(V)+x(V),y<11?y=`${o[10]}${o[y-1]}`:y>10&&y<20?y=`${o[9]}${o[y-11]}`:y===20?y=`${o[1]}${o[9]}`:y>20&&y<30?y=`${o[11]}${o[y-21]}`:y===30&&(y=`${o[2]}${o[9]}`),{lunarYear:V,lunarMonth:F,lunarDay:y}}function h(N){return N&15?N&15:!1}function f(N){return h(N)?N&983040?30:29:0}function b(N){let W=0;for(let I=32768;I>8;I>>=1){let H=N&I?30:29;W+=H}return h(N)&&(W+=f(N)),W}function S(N){let W=[];for(let I=32768;I>8;I>>=1)W.push(N&I?30:29);return h(N)&&W.splice(h(N),0,f(N)),W}function L(N){let W=(N-3)%10;return W===0&&(W=10),p[W-1]}function x(N){let W=(N-3)%12;return W===0&&(W=12),W--,d[W]+` (${u[W]}) `}return m(l,e,t)}class yr{constructor(){let e=this;this.scale=c.prefConfig.customSize/100,this.tilesZoom=c.prefConfig.tilesZoom/100,this.tipsZoom=c.prefConfig.tipsZoom/100,Et=`
                ...
                `,c.prefConfig.cssText&&(Et+=c.prefConfig.cssText);let t=document.createElement("span");t.className="search-jumper-searchBar";let r=document.createElement("input");r.id="search-jumper-tileInput",r.addEventListener("mousedown",y=>{y&&y.stopPropagation&&y.stopPropagation()},!0),this.tileInput=r;let i=document.createElement("span");i.className="search-jumper-logo",lt=document.createElement("span"),lt.innerHTML=ee(pi),lt.className="search-jumper-btn",i.addEventListener("mouseenter",y=>{this.preList&&(this.preList.style.visibility="hidden",this.listArrow.style.cssText="")}),i.appendChild(lt),t.appendChild(i);let s=document.createElement("div");s.id="search-jumper",s.style.display="none",s.className="search-jumper-searchBarCon",s.appendChild(t),s.setAttribute("translate","no");let n=document.createElement("div");n.id="search-jumper-alllist",s.appendChild(n),this.alllist=n;let a=document.createElement("span");a.className="groupTab",s.appendChild(a),this.groupTab=a;let o=document.createElement("div");o.className="search-jumper-showallBg",s.appendChild(o);let p=document.createElement("div");p.className="sitelistBox",n.appendChild(p),this.sitelistBox=p;const d=/#[^\s#]+/g;p.addEventListener("mouseover",y=>{if(!n.classList.contains("new-mode"))return;let j=y.target;j.parentNode&&j.parentNode.dataset.name&&(j=j.parentNode);let A=j.title;if(!j.dataset.name||!A||j.initedTag)return;let P=document.createElement("p"),$=A.match(d);$&&($.forEach(Z=>{let pe=document.createElement("span");pe.innerText=Z.slice(1),pe.addEventListener("click",te=>{e.searchInput.value=Z,e.searchInput.dispatchEvent(new CustomEvent("input"))}),P.appendChild(pe)}),j.appendChild(P)),j.initedTag=!0});let u=document.createElement("span");u.className="timeInAll",n.appendChild(u),this.timeInAll=u,this.modeSwitch=document.createElement("div"),this.modeSwitch.className="modeSwitch",this.modeSwitch.innerHTML=ee('<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" version="1.1"><rect height="450" width="520" y="287" x="253" fill="#fff"></rect><path d="m511.8,64.2c-247.5,0 -448.2,200.7 -448.2,448.2s200.7,448.2 448.2,448.2s448.2,-200.6 448.2,-448.2s-200.7,-448.2 -448.2,-448.2zm-260.4,353.9c0,-7.8 6.3,-14.2 14.2,-14.2l315.6,0l0,-102.5c0,-12.3 14.7,-18.8 23.7,-10.4l165.1,151.7c9.5,8.7 3.3,24.6 -9.6,24.6l-495,0c-7.8,0 -14.2,-6.3 -14.2,-14.2l0,-35l0.2,0zm523.2,188.5c0,7.8 -6.3,14.2 -14.2,14.2l-315.5,0l0,102.6c0,12.3 -14.7,18.8 -23.7,10.4l-165.2,-151.8c-9.5,-8.7 -3.3,-24.6 9.6,-24.6l495,0c7.8,0 14.2,6.3 14.2,14.2l0,35l-0.2,0z"></path></svg>'),n.appendChild(this.modeSwitch),this.modeSwitch.addEventListener("click",y=>{y.preventDefault(),y.stopPropagation(),n.classList.toggle("new-mode"),n.classList.remove("showbg"),K.setItem("allPageNewMode",n.classList.contains("new-mode"))}),this.modeSwitch.addEventListener("mouseenter",y=>{_e&&(y.preventDefault(),y.stopPropagation(),n.classList.add("showbg"))}),this.modeSwitch.addEventListener("mouseleave",y=>{_e&&(y.preventDefault(),y.stopPropagation(),n.classList.remove("showbg"))}),this.modeSwitch.addEventListener("contextmenu",y=>{_e&&(y.preventDefault(),y.stopPropagation(),n.classList.remove("showbg"),ge(_e,{active:!0,insert:!0}))}),zi&&n.classList.add("new-mode");let m=document.createElement("span");m.className="dayInAll",n.appendChild(m),this.dayInAll=m,n.addEventListener(Mt(),y=>{if(e.tips.style.display="none",clearTimeout(e.requestShowTipsTimer),!(y.target!=n&&y.target!=o&&y.target!=p)&&!n.classList.contains("new-mode")){var j,A;if(y.type!=="wheel"){var P=0,$=0;typeof y.axis=="number"?y.axis==2?$=y.detail:P=y.detail:typeof y.wheelDeltaY>"u"||y.wheelDeltaY!=0?$=-y.wheelDelta/40:P=-y.wheelDelta/40,A=$,j=P}else j=y.deltaX,A=y.deltaY;y.preventDefault(),y.stopPropagation(),n.scrollLeft+=A}},{passive:!1,capture:!1});let h=document.createElement("span");h.innerHTML=ee(pi),h.className="search-jumper-btn",h.addEventListener("click",y=>{ge(Ae,{active:!0,insert:!0})}),n.appendChild(h);let f=document.createElement("div");f.className="search-jumper-historylistcon",n.appendChild(f);let b=document.createElement("div");if(b.className="search-jumper-historylist",f.appendChild(b),this.historylist=b,t.addEventListener("mouseenter",y=>{t.classList.contains("grabbing")||(this.hideTimeout&&clearTimeout(this.hideTimeout),this.checkScroll(!0),c.prefConfig.mouseLeaveToHide&&t.classList.remove("initShow"))},!1),t.addEventListener("mouseleave",y=>{if(c.prefConfig.mouseLeaveToHide){if(t.classList.contains("grabbing"))return;e.waitForHide()}e.preList&&(e.preList.style.visibility="hidden",e.listArrow.style.cssText="")},!1),this.touched=!0,c.prefConfig.initShow?t.classList.add("initShow"):this.touched=!1,c.prefConfig.minSizeMode&&(t.classList.add("minSizeMode"),t.classList.add("minSizeModeClose")),Wt&&!c.prefConfig.resizePage){let y=A=>{this.touched=!1,t.classList.remove("initShow")},j=A=>{this.touched||this.funcKeyCall||(this.touched=!0,t.classList.add("disable-pointer"),A.stopPropagation(),setTimeout(()=>{t.classList.remove("disable-pointer")},250))};_(document).addEventListener("touchstart",y,{passive:!0,capture:!1}),t.addEventListener("touchstart",j,{passive:!1,capture:!0})}this.bar=t,this.con=s;let S=document.createElement("span");S.className="search-jumper-tips",S.style.opacity=0,s.appendChild(S),S.addEventListener("mouseenter",y=>{e.hideTimeout&&clearTimeout(e.hideTimeout)},!1),S.addEventListener("click",y=>{let j=y.target.dataset,A=y.target.innerText;if(j){if(typeof j.read<"u"){let P=new SpeechSynthesisUtterance("");P.volume=j.volume||1,P.rate=j.rate||1,P.pitch=j.pitch||1,P.lang=j.lang||"",P.text=j.read||A,window.speechSynthesis.speak(P)}typeof j.copy<"u"&&Re(j.copy||A),j.search&&(Nt=A,e.searchBySiteName(j.search)),typeof j.paste<"u"&&B&&(/INPUT|TEXTAREA/i.test(B.nodeName)&&B.getAttribute("aria-readonly")!="true"||B.contentEditable=="true")&&Ot(B,j.paste||A),typeof j.close<"u"&&(e.tips.style.opacity=0,e.tips.style.display="none",e.tips.innerHTML=ee(""))}},!1);let L,x,N=y=>{let j=ht(y)-L.x,A=dt(y)-L.y;Math.abs(j)+Math.abs(A)<5||(S.style.right===""?S.style.setProperty("left",x.left+j+"px","important"):S.style.setProperty("right",x.right-j+"px","important"),S.style.bottom===""?S.style.setProperty("top",x.top+A+"px","important"):S.style.setProperty("bottom",x.bottom-A+"px","important"),S.classList.add("draging"))},W=y=>{document.removeEventListener("mouseup",W,!1),document.removeEventListener("mousemove",N,!1),document.removeEventListener("touchend",W,!1),document.removeEventListener("touchmove",N,!1),S.classList.remove("draging")},I=(y,j)=>{if(!y.target||y.target!==S&&typeof y.target.dataset.drag>"u")return;y.preventDefault(),y.stopPropagation(),L={x:ht(y),y:dt(y)};let A=getComputedStyle(S);x={left:parseFloat(A.left),right:parseFloat(A.right),top:parseFloat(A.top),bottom:parseFloat(A.bottom)},j&&j()};S.addEventListener("mousedown",y=>{I(y,()=>{document.addEventListener("mouseup",W,!1),document.addEventListener("mousemove",N,!1)})},!1),S.addEventListener("touchstart",y=>{I(y,()=>{document.addEventListener("touchend",W,!1),document.addEventListener("touchmove",N,!1)})},{passive:!1,capture:!1}),this.tips=S;let H=document.createElement("div");H.className="searchJumperNavBar",H.style.display="none",H.innerHTML=ee(`
                ...
                `),s.appendChild(H);let V=document.createElement("span");V.title=M("expand"),V.className="searchJumperExpand search-jumper-btn",V.innerHTML=ee(`
                ...
                `),this.searchJumperExpand=V,this.navMarks=H.querySelector("#navMarks"),this.closeNavBtn=H.querySelector(".closeNavBtn"),this.minNavBtn=H.querySelector(".minNavBtn"),this.maxNavBtn=H.querySelector(".maxNavBtn"),this.searchJumperNavBar=H,this.navPointer=H.querySelector(".navPointer"),this.navPointer.style.display="none";let F=document.createElement("div");F.className="search-jumper-input",F.innerHTML=ee(`<span class="closeBtn">\xD7</span>
                <input type="radio" id="filterSitesTab" name="tab" ${c.prefConfig.defaultFindTab?"":'checked="checked"'} />
                <label for="filterSitesTab">${M("filterSites")}</label>
                <input type="radio" id="searchInPageTab" name="tab" ${c.prefConfig.defaultFindTab?'checked="checked"':""} />
                <label for="searchInPageTab">${M("searchInPage")}</label>
                <div class="line"></div>
                <div class="content-container">
                  <div class="inputGroup" id="filterSites">
                    <input spellcheck="false" id="searchJumperInput" autocomplete="on" title="${M("inputTitle")}" placeholder="${M("inputPlaceholder")}" list="filterGlob" />
                    <input spellcheck="false" id="searchJumperInputKeyWords" autocomplete="on" placeholder="${M("inputKeywords")}" list="suggest" />
                        ...
                        `),d=document.createElement("div");this.customInputFrame=d,d.innerHTML=ee(`
                         <div class="customInputFrame-body">
                             <a href="${Ae}" class="customInputFrame-title" target="_blank">
                                 <img width="32px" height="32px" src="${ut}" />${M("customInputFrame")}
                             </a>
                             <div id="customGroup">
                             </div>
                             <div class="customInputFrame-input-title">${M("finalSearch")}</div>
                             <textarea name="finalSearch" type="text"></textarea>
                             <div class="customInputFrame-buttons">
                                 <button id="cancel" type="button">${M("cancel")}</button>
                                 <button id="customSubmit" type="button">${M("customSubmit")}</button>
                             </div>
                         </div>
                        `),Ke||d.appendChild(p),d.querySelector("#cancel").addEventListener("click",b=>{d.parentNode&&d.parentNode.removeChild(d),r("")}),d.addEventListener("keydown",b=>{b.keyCode==13&&f.click()});let m=this.customInputFrame.querySelector("#customGroup");this.customGroup=m;let h=this.customInputFrame.querySelector("[name='finalSearch']");this.finalSearch=h,h.addEventListener("click",b=>{i()});let f=d.querySelector("#customSubmit");f.addEventListener("click",b=>{i(),h.value&&this.customInputCallback&&this.customInputCallback(h.value),r(h.value),d.parentNode&&d.parentNode.removeChild(d)})}this.customInputFrame.parentNode&&this.customInputFrame.parentNode.removeChild(this.customInputFrame),this.customGroup.innerHTML=ee();let s=e,n=s.match(/%input{(.*?[^\\])}/);for(;n;){let o=n[1];if(/^".*","/.test(o)?o=o.substr(1,o.length-2).split('","'):o=o.replace(/\\,/g,"\u25CESJ").split(",").map(p=>p.replace(/◎SJ/g,",")),o.length===1){o=o[0].replace(/\\\|/g,"\u25CESJ").split("|").map(u=>u.replace(/◎SJ/g,"|"));let p=document.createElement("div");p.className="customInputFrame-input-title",p.innerText=o[0],this.customGroup.appendChild(p);let d=document.createElement("input");d.type="text",o.length>1&&(d.title=o[1]),this.customGroup.appendChild(d)}else if(o.length>=2){let p=o[0].replace(/\\}/g,"}");/^'.*'\/'/.test(p)?p=p.substr(1,p.length-2).split("'/'"):p=p.replace(/\\\//g,"\u25CESJ").split("/").map(x=>x.replace(/◎SJ/g,"/"));let d=o.slice(1).join(",");/^'.*'\/'/.test(d)?d=d.substr(1,d.length-2).split("'/'"):d=d.replace(/\\\//g,"\u25CESJ").split("/").map(x=>x.replace(/◎SJ/g,"/"));let u=p.length===d.length+1,m=document.createElement("div");m.className="customInputFrame-input-title",m.innerText=p[0],this.customGroup.appendChild(m);let h=document.createElement("input");h.type="text";let f=document.createElement("div");f.className="select",f.appendChild(h);let b=document.createElement("p");b.innerText="Select option",f.appendChild(b);let S=document.createElement("div");S.className="options",f.appendChild(S);let L=document.createElement("p");L.setAttribute("value",""),L.innerHTML=ee("<b>Select option</b>"),S.appendChild(L),L.addEventListener("click",x=>{S.style.visibility="hidden",setTimeout(()=>{S.style.visibility=""},0),h.value="",b.innerText="Select option",i()});for(let x=0;x<d.length;x++){let N=d[x],W=document.createElement("p");if(W.setAttribute("value",N),u){let I=p[x+1];I=I.replace(/\\\|/g,"\u25CESJ").split("|").map(H=>H.replace(/◎SJ/g,"|")),W.innerText=I[0],I.length>1&&(W.title=I[1])}else W.innerText=N;W.addEventListener("click",I=>{S.style.visibility="hidden",setTimeout(()=>{S.style.visibility=""},0),h.value=W.getAttribute("value"),b.innerText="",i()}),S.appendChild(W)}h.addEventListener("change",x=>{b.innerText=""}),f.addEventListener("mouseenter",x=>{f.focus(),S.style.marginTop=-this.customGroup.scrollTop+20+"px"}),this.customGroup.appendChild(f)}s=s.replace(n[0],"\u25CE"),n=s.match(/%input{(.*?[^\\])}/)}this.finalSearch.dataset.url=s,this.finalSearch.value=s.replace(/◎/g,""),this.addToShadow(this.customInputFrame);let a=this.customInputFrame.children[0];a.style.marginTop=-a.offsetHeight/2+"px"})}showModifyWindow(e,t){let r;if(this.modifyWord={},this.addNew=!e&&!t,!this.addNew){if(r=e.oriWord,!r)return;this.modifyWord=e,this.modifySpan=t}if(!this.modifyFrame){let h=Me(`
                    ...
                    `),f=document.createElement("div");this.modifyFrame=f,f.id="searchJumperModifyWord",f.innerHTML=ee(`
                     <div class="searchJumperModify-body">
                         <a href="${Ae}" class="searchJumperModify-title" target="_blank">
                             <img onerror="this.style.display='none'" width="32px" height="32px" src="${ut}" />${M("modifyWord")}
                         </a>
                         <div class="searchJumperModify-input-title">${M("wordContent")}</div>
                         ...
                         <div class="searchJumperModify-checkGroup">
                             ...
                             <label for="searchJumperModify-re">${M("re")}</label>
                             <input id="searchJumperModify-case" type="checkbox"/>
                             <label for="searchJumperModify-case">${M("ignoreCase")}</label>
                             <input id="searchJumperModify-link" type="checkbox"/>
                             <label for="searchJumperModify-link">${M("filterLink")}</label>
                         </div>
                         <div class="searchJumperModify-input-title">${M("wordHide")}</div>
                         <input name="wordHide" min="0" placeholder="${M("wordHideTips")}" type="number" />
                         <div class="searchJumperModify-input-title">${M("wordRange")}</div>
                         <input name="wordRange" placeholder="#main" type="text" />
                         <svg id="rangePickerBtn" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><title>${M("pickerBtn")}</title><path d="M874.048 533.333333C863.424 716.629333 716.629333 863.424 533.333333 874.048V917.333333a21.333333 21.333333 0 0 1-42.666666 0v-43.285333C307.370667 863.424 160.576 716.629333 149.952 533.333333H106.666667a21.333333 21.333333 0 0 1 0-42.666666h43.285333C160.576 307.370667 307.370667 160.576 490.666667 149.952V106.666667a21.333333 21.333333 0 0 1 42.666666 0v43.285333c183.296 10.624 330.090667 157.418667 340.714667 340.714667h42.816a21.333333 21.333333 0 1 1 0 42.666666H874.026667z m-42.752 0h-127.786667a21.333333 21.333333 0 0 1 0-42.666666h127.786667C820.778667 330.922667 693.056 203.221333 533.333333 192.704V320a21.333333 21.333333 0 0 1-42.666666 0V192.704C330.922667 203.221333 203.221333 330.944 192.704 490.666667H320a21.333333 21.333333 0 0 1 0 42.666666H192.704c10.517333 159.744 138.24 287.445333 297.962667 297.962667V704a21.333333 21.333333 0 0 1 42.666666 0v127.296c159.744-10.517333 287.445333-138.24 297.962667-297.962667zM512 554.666667a42.666667 42.666667 0 1 1 0-85.333334 42.666667 42.666667 0 0 1 0 85.333334z"></path></svg>
                         <div class="searchJumperModify-input-title">${M("wordStyle")}</div>
                         <input name="wordStyle" placeholder="orange or #333333;color:red;" type="text" />
                         <div class="searchJumperModify-input-title">${M("wordTitle")}</div>
...
`:E.text[R+T+1])),w&&g&&(/[a-z]/i.test(w)||/[a-rt-z]/i.test(g)||g.toLowerCase()=="s"&&/[a-z]/i.test(C))))break;R<0&&(R=0);let ce=Math.min(T,E.text.length-R);if(T-=ce,!E.text.trim()){U==="start"&&(O+=E.text.length);continue}let oe;for(let fe=0;fe<te.length;fe++)if(te[fe].node==E.node){oe=te[fe];break}if(oe?oe.match.push({pos:R,len:ce,type:U,matched:re}):te.push({node:E.node,text:E.text,match:[{pos:R,len:ce,type:U,matched:re}]}),T<=0)break}},G=function(){if(L=-1,f.isRe){let O=j.match(new RegExp(f.content,f.reCase));O&&(S=O[0].length,L=O.index)}else{let O=o.findPosInStr(j,f.content,A,$,P);S=O.len,L=O.pos}if(L>-1){let O=j.slice(L,L+S);j=j.slice(L+S),A=A.slice(L+S),P=P.slice(L+S),L+=pe,pe=L+S,z(L,S,O),G()}},y=o.anylizeDomWithTextPos(h),j=y.text,A=j.toUpperCase(),P=[];for(let O=0;O<A.length;O++){const ie=A[O].normalize("NFD").replace(/[\u0300-\u036f]/g,"");P.push(ie)}let $=f.content.toUpperCase(),Z=y.data,pe=0,te=[],v=(f.init||s)&&/^[a-z]+$/i.test(f.content);G(),te.length&&te.forEach(O=>{if(typeof f.hideParent<"u"){let ie=f.hideParent,re=O.node.parentElement;for(;ie-- >0&&re;)re=re.parentElement;re&&re.classList&&!re.classList.contains("searchJumper-hide")&&(re.innerHTML=ee(""),re.dataset.content=f.showWords,re.classList.add("searchJumper-hide"))}else{let ie=o.marks[f.showWords],re=ie.length,D,T,w="";O.node.parentNode.nodeType==1&&(w=getComputedStyle(O.node.parentNode).display),w.indexOf("flex")!=-1||w.indexOf("grid")!=-1||w.indexOf("layer")!=-1?(T=document.createElement("span"),T.style.all="unset"):T=document.createDocumentFragment();let g=document.createTextNode(O.text);T.appendChild(g);let C=O.match.reverse(),E=[],J=C.length-1;C.forEach(R=>{switch(D=o.createHighlightMark(f,re+J,ie),R.type){case"start":D.style.borderTopRightRadius=0,D.style.borderBottomRightRadius=0,J--;break;case"middle":D.style.borderRadius=0;break;case"end":D.style.borderTopLeftRadius=0,D.style.borderBottomLeftRadius=0;break;default:J--;break}W=g.splitText(R.pos),R.type!="start"&&R.type!="middle"&&W.data.length&&W.splitText(R.len),I=W.cloneNode(!0),D.appendChild(I),R.type!="full"&&R.type!="start"&&(D.dataset.type=R.type),R.matched&&(D.dataset.matched=R.matched),T.replaceChild(D,W),E.unshift(D)}),O.node.parentNode.replaceChild(T,O.node),o.marks[f.showWords].push(...E),E.forEach(R=>{R.dataset.type||u.push([R,f,re,ie,d])})}})}let V=!0;if(f.link){if(h.nodeType==1&&h.href&&h.href.match&&(V=!1,h.href.match(new RegExp(f.content,f.reCase))))if(typeof f.hideParent<"u"){let j=f.hideParent,A=h;for(;j-- >0&&A;)A=A.parentElement;if(A)return A.innerHTML=ee(""),A.dataset.content=f.showWords,A.classList.add("searchJumper-hide"),0}else{let j=o.marks[f.showWords],A=j.length;h.classList.add("searchJumper"),f.title&&(h.title=JSON.parse('"'+f.title+'"')),f.popup&&o.highlightPopup(h,f),h.dataset.css||(h.dataset.css=h.style.cssText),f.style&&(h.style.cssText+=f.style),h.addEventListener("click",P=>{if(P.altKey)return P.stopPropagation(),P.preventDefault(),!1}),h.dataset.content=f.showWords,h.addEventListener("mousedown",P=>{if(!P.altKey)return;let $;P.button===0?A!=j.length-1?o.focusIndex=A+1:o.focusIndex=0:P.button===2&&(A!=0?o.focusIndex=A-1:o.focusIndex=j.length-1),$=j[o.focusIndex],o.focusHighlight($),o.setHighlightSpan(o.getHighlightSpanByText(f.showWords),o.focusIndex,j),o.focusText=f.showWords}),o.marks[f.showWords].push(h),u.push([h,f,A,j,d])}}else{let y="";if(h.nodeType==1&&h.value&&(h.offsetParent||h.offsetHeight)&&!f.init&&/^(button|select|input|textarea)$/i.test(h.nodeName)&&!/^(hidden|file|password|radio|range|checkbox|image)$/i.test(h.type)&&(y=h.value),y){let G=function(O,ie){if(O){if(!P){P=document.createElement("pre"),P.className="searchJumper";let T=document.createTextNode(y);P.appendChild(T);let w,g=/^(number|string)$/,C=[],E=h.style;for(w in E)if(!/^(content|outline|outlineWidth)$/.test(w)){let J=$[w];J!==""&&g.test(typeof J)&&(w=w.replace(/([A-Z])/g,"-$1").toLowerCase(),C.push(w),C.push(":"),C.push(J),C.push(";"))}C=C.join(""),P.style.cssText=C,P.style.position="fixed",P.style.left="0px",P.style.top="0px",P.style.margin="0",h.nodeName&&h.nodeName.toLowerCase&&h.nodeName.toLowerCase()!=="textarea"&&(P.style.display="inline-grid",P.style.lineHeight=P.style.height,P.style.boxSizing=="border-box"&&(P.style.paddingTop=0)),o.fakeTextareas.set(h,P)}document.body.appendChild(P);let re=document.createRange();re.setStart(P.firstChild,Math.min(P.firstChild.length,ie)),re.setEnd(P.firstChild,Math.min(P.firstChild.length,ie+1));let D=re.getBoundingClientRect();if(document.body.removeChild(P),typeof f.hideParent<"u"){let T=f.hideParent,w=h.parentElement;for(;T-- >0&&w;)w=w.parentElement;if(w)return w.innerHTML=ee(""),w.dataset.content=f.showWords,w.classList.add("searchJumper-hide"),0}else{let T=o.marks[f.showWords],w=T.length,g=document.createElement("mark");g.className="searchJumper",g.dataset.block=!0,f.title&&(g.title=JSON.parse('"'+f.title+'"')),g.style.cssText=f.style,g.dataset.content=f.showWords,g.innerText=O,g.style.padding="0",g.style.position="absolute",g.style.fontSize=P.style.fontSize,g.style.fontFamily=P.style.fontFamily,g.style.lineHeight="1",g.style.pointerEvents="none",h.parentNode.appendChild(g);let C=D.left+Z,E=D.top+pe;if(g.style.left=C+"px",g.style.top=E+"px",o.marks[f.showWords].push(g),u.push([g,f,w,T,d]),h.nodeName&&h.nodeName.toLowerCase&&h.nodeName.toLowerCase()=="textarea"){let J=R=>{g.parentNode?(g.style.left=C-h.scrollLeft+"px",g.style.top=E-h.scrollTop+"px"):(g.parentNode.removeChild(g),h.removeEventListener("scroll",J))};h.addEventListener("scroll",J)}}}};V=!1;let j=!1,A=0,P=o.fakeTextareas.get(h);if(p&&P)return 0;let $=getComputedStyle(h),Z=h.offsetLeft,pe=h.offsetTop,te=y.toUpperCase(),v=[];for(let O=0;O<te.length;O++){const ie=te[O].normalize("NFD").replace(/[\u0300-\u036f]/g,"");v.push(ie)}let z=f.content.toUpperCase();for(;;){if(f.isRe)j=y.match(new RegExp(f.content,f.reCase)),j&&(L=j.index,j=j[0]);else{let O=o.findPosInStr(y,f.content,te,z,v);S=O.len,L=O.pos,(f.init||s)&&L>=0&&/^[a-z]+$/i.test(f.content)&&(L!==0&&/[a-z]/i.test(y[L-1])&&(L=-1),L+f.content.length!==y.length&&/[a-z]/i.test(y[L+S])&&(L=-1)),j=L>=0?y.slice(L,L+S):!1}if(j)G(j,A+L),A+=L+j.length,y=y.slice(L+j.length),te=te.slice(L+j.length),v=v.slice(L+j.length);else break}}}if(V&&(!r||h===t)&&(h.nodeType==1||h.nodeType==11)&&h.childNodes&&!/^(SCRIPT|STYLE|MARK|SVG|TEXTAREA)$/i.test(h.nodeName)&&(!f.init||h.ariaHidden!="true"&&h.role!="search"&&(!h.hasAttribute||h.hasAttribute("jsname")==!1)))if(!a&&/^(PRE|CODE)$/i.test(h.nodeName))n.push(h);else{for(var F=0;F<h.childNodes.length;++F)F=F+m(h.childNodes[F],f);try{h.shadowRoot&&(F=F+m(h.shadowRoot,f,!0))}catch(y){he(y)}}return x}e.forEach(h=>{if(o.marks[h.showWords]||(o.marks[h.showWords]=[]),h.inRange){let f=t;t.parentNode&&(f=t.parentNode),[].forEach.call(f.querySelectorAll(h.inRange),b=>{(b==t||t.contains(b))&&m(b,h,!0)})}else m(t,h,!0)}),u.forEach(h=>{o.createNavMark(...h)}),this.navMarks.style.display="",setTimeout(()=>{o.navMarks.style.display="none",u=[],a=!0,e.forEach(h=>{o.marks[h.showWords]||(o.marks[h.showWords]=[]),n.forEach(f=>{m(f,h,!0)})}),u.forEach(h=>{o.createNavMark(...h)}),o.navMarks.style.display=""},1e3),this.navMarks.innerHTML!=""&&(this.searchJumperNavBar.classList.add("sjNavShow"),Ye&&(this.appendBar(),this.con.style.display="",this.setNav(!0,!0)))}refreshPageWords(e){this.lockWords="",this.searchJumperInPageInput.value="",this.searchInPageLockWords.innerHTML=ee(),this.searchJumperInPageInput.style.paddingLeft="",this.submitInPageWords();let t=e||Ne;t&&(this.searchJumperInPageInput.value=t,this.submitInPageWords(t==this.lastSearchEngineWords),this.appendBar())}refreshNav(){this.setNav(Ye)}refreshNavMarks(){this.refreshNavMarksTimer&&clearTimeout(this.refreshNavMarksTimer),this.refreshNavMarksTimer=setTimeout(()=>{let e=Math.max(document.documentElement.scrollHeight,_(document).scrollHeight);this.navPointer.style.display="none",this.navMarks.style.display="none",[].forEach.call(this.navMarks.children,t=>{t.style.top=t.dataset.top/e*100+"%"}),this.navMarks.style.display=""},1e3)}checkCharacterData(e){setTimeout(()=>{this.highlight("insert",e,!0)},0)}removeMark(e){let t=e.dataset.content,r=this.marks[t];if(!r)return;var i=r.indexOf(e);if(i===-1)return;r.splice(i,1),this.marks[t]=r;let s=this.navMarks.querySelectorAll(`span[data-content="${t}"]`)[i];s&&this.navMarks.removeChild(s)}submitIgnoreSpace(e){e&&(!this.lockWords&&e.indexOf("$c")!==0&&e.indexOf("$o")!==0&&e.indexOf(" ")!==-1&&(this.splitSep="\u25CE"),this.searchJumperInPageInput.value=e,this.submitInPageWords())}siteBtnReturnHome(e){e.parentNode&&e.parentNode.removeChild(e)}closeShowAll(){if(!(!this.con.classList.contains("search-jumper-showall")||et)){if(this.clearInputHide(),clearInterval(this.showAllTimeTimer),document.removeEventListener("mousedown",self.showAllMouseHandler),document.removeEventListener("keydown",self.showAllKeydownHandler),this.con.classList.remove("search-jumper-showall"),document.documentElement.style.scrollbarWidth=this.preScrollbarWidth,this.searchJumperInputKeyWords.value="",this.historylist.innerHTML=ee(),this.touched=!1,this.initPos(),this.funcKeyCall&&this.setFuncKeyCall(!1),!c.prefConfig.disableAutoOpen&&!c.prefConfig.disableTypeOpen){let e=this.bar.querySelector(".search-jumper-type:nth-child(1)>span");if(e&&!e.classList.contains("search-jumper-open"))if(e.onmousedown)e.onmousedown();else{let t=new PointerEvent("mousedown");e.dispatchEvent(t)}}this.bar.style.display=""}}toggleShowAll(){this.appendBar(),!(!this.con||!this.con.parentNode)&&(this.con.classList.contains("search-jumper-showall")?this.closeShowAll():this.showAllSites())}showAllSites(){if(!this.con||!this.con.parentNode||this.con.classList.contains("search-jumper-showall"))return;this.con.style.display="",this.clearInputHide(),this.alllist.appendChild(this.filterSites),this.filterGlob.innerHTML=ee();let e=this,t=this.tileInput.value;this.setFuncKeyCall(!1),this.hideSearchInput(),this.con.classList.add("search-jumper-showall"),this.preScrollbarWidth=document.documentElement.style.scrollbarWidth||"",document.documentElement.style.scrollbarWidth="none",clearInterval(this.showAllTimeTimer);const r=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];window.innerWidth<1e3?(e.timeInAll.style.fontSize="15px",e.dayInAll.style.fontSize="15px"):(e.timeInAll.style.fontSize="",e.dayInAll.style.fontSize="");let i=new Date,s=i.getFullYear(),n=i.getMonth(),a=i.getDate(),o=M(r[i.getDay()])+"<br/>"+s+"-"+(++n<10?"0"+n:n)+"-"+(a<10?"0"+a:a);if(Fe.indexOf("zh")==0){let u=gr(s,n,a);if(u){let m=`${u.lunarYear}\u5E74${u.lunarMonth}\u6708${u.lunarDay}`;o=o+"<br/>"+m}}e.dayInAll.innerHTML=ee(o);let p=()=>{let u=new Date,m=u.getHours(),h=u.getMinutes(),f=u.getSeconds();e.timeInAll.innerText=(m<10?"0"+m:m)+":"+(h<10?"0"+h:h)+":"+(f<10?"0"+f:f)};this.showAllTimeTimer=setInterval(p,1e3),p(),Se.forEach(u=>{if(u.style.display!="none"){let m=u.querySelector(".sitelist");m&&(e.sitelistBox.appendChild(m),e.initList(m))}}),this.historySiteBtns.slice(0,20).forEach(u=>{let m=u.querySelector("img");m&&m.dataset.src&&(m.src=m.dataset.src,delete m.dataset.src),e.historylist.appendChild(u)});let d="";B&&(B.nodeName.toUpperCase()=="A"||B.parentNode&&B.parentNode.nodeName.toUpperCase()=="A")&&(d=B.textContent.trim()),t=t||Xe()||d||Ee,this.searchJumperInputKeyWords.value=t,setTimeout(()=>{e.showAllMouseHandler||(e.showAllMouseHandler=u=>{(u.isTrusted==!1||u.target.className==="sitelistBox"||u.target.className==="search-jumper-showallBg")&&e.closeShowAll()}),e.con.addEventListener("mousedown",e.showAllMouseHandler),e.showAllKeydownHandler||(e.showAllKeydownHandler=u=>{u.keyCode==27&&e.closeShowAll()}),document.addEventListener("keydown",e.showAllKeydownHandler,!0),this.searchJumperInputKeyWords.value&&(this.searchJumperInputKeyWords.focus(),this.searchJumperInputKeyWords.select())},0)}switchSite(e){if(!ae||this.bar.style.display=="none")return;let t=this.con.querySelector(".search-jumper-btn.current");if(e)for(t=t.nextElementSibling;t&&!(!t.classList.contains("notmatch")&&t.style.display!="none"&&t.dataset.current!="true"&&t.dataset.isPage=="true");)t=t.nextElementSibling;else for(t=t.previousElementSibling;t&&!(!t.classList.contains("notmatch")&&t.style.display!="none"&&t.dataset.current!="true"&&t.dataset.isPage=="true");)t=t.previousElementSibling;t&&this.openSiteBtn(t,"_self")}clearInputHide(){Se.forEach(e=>{e.classList.remove("input-hide")}),this.allSiteBtns.forEach(e=>{e[0].classList.remove("input-hide")}),this.allListBtns.forEach(e=>{e.classList.remove("input-hide")}),this.allLists.forEach(e=>{e.classList.remove("input-hide")})}showSearchInput(){if(this.con&&this.con.classList.contains("search-jumper-showall"))return;this.recoveHistory(),this.con.classList.add("in-input"),this.searchInput.value="",this.contentContainer.appendChild(this.filterSites);let e=We();if(e&&(this.searchJumperInputKeyWords.value=e),this.filterSitesTab.checked){this.con.classList.remove("in-find"),c.prefConfig.defaultPicker&&this.togglePicker(),this.searchJumperInputKeyWords.value||(this.searchJumperInputKeyWords.value=Xe()||Ee);let t=this.bar.querySelector(".search-jumper-needInPage:not(.notmatch)>span");if(t&&!t.parentNode.classList.contains("search-jumper-open"))if(t.onmousedown)t.onmousedown();else{let r=new PointerEvent("mousedown");t.dispatchEvent(r)}xt&&(this.searchInput.value=xt,this.searchInput.dispatchEvent(new Event("input"))),this.searchJumperInputKeyWords.focus(),this.searchJumperInputKeyWords.select()}else this.searchInPageTab.checked&&(this.con.classList.add("in-find"),this.searchJumperInPageInput.focus(),setTimeout(()=>{e&&this.lockWords.indexOf(e)==-1?(this.searchJumperInPageInput.value="",this.navMarks.innerHTML?(this.searchJumperInPageInput.value=e,this.submitInPageWords()):this.submitIgnoreSpace(e)):this.searchJumperInPageInput.value?this.submitInPageWords():!this.initShowSearchInput&&Ee&&this.lockWords!==Ee&&(this.searchJumperInPageInput.value=Ee,this.initShowSearchInput=!0,this.searchJumperInPageInput.select())},10));this.inInput=!0,this.clearInputHide(),this.lockWords?this.searchJumperInPageInput.style.paddingLeft=this.searchInPageLockWords.clientWidth+3+"px":this.searchJumperInPageInput.style.paddingLeft="",c.prefConfig.altToHighlight&&(document.removeEventListener("mouseup",this.checkSelHandler),document.addEventListener("mouseup",this.checkSelHandler))}togglePicker(){this.pickerBtn.classList.toggle("checked"),this.con.classList.toggle("in-pick"),this.searchJumperInputKeyWords.disabled=!this.searchJumperInputKeyWords.disabled,ke.toggle(!0),this.searchJumperInputKeyWords.disabled&&(this.searchJumperInputKeyWords.value="")}hideSearchInput(){this.inInput=!1,this.clearInputHide(),this.con.classList.remove("in-find"),this.con.classList.remove("in-input"),this.con.classList.remove("lock-input"),this.bar.classList.remove("initShow"),this.searchInput.value="",this.searchJumperInputKeyWords.value="",this.pickerBtn.classList.remove("checked"),this.searchJumperInputKeyWords.disabled=!1,ke.close(),document.removeEventListener("mouseup",this.checkSelHandler),this.setFuncKeyCall(!1),this.closeOpenType()}removeBar(){this.shadowContainer&&this.shadowContainer.parentNode&&this.shadowContainer.parentNode.removeChild(this.shadowContainer),this.con.parentNode&&this.con.parentNode.removeChild(this.con)}async testCSP(){let e=this,t=i=>{!i.violatedDirective||i.violatedDirective.indexOf("style-src")==-1||(Ke=!0)};window.addEventListener("securitypolicyviolation",t);let r=Me("html {color: #000;}");this.addToShadow(r),await $e(0),window.removeEventListener("securitypolicyviolation",t),r.parentNode&&r.parentNode.removeChild(r)}addToShadow(e){this.shadowContainer||(this.shadowContainer=document.createElement("div")),this.shadowContainer.parentNode||(Te?document.body.appendChild(this.shadowContainer):document.documentElement.appendChild(this.shadowContainer));let t;if(Ke){if(/^style$/i.test(e.nodeName))return!0;t=this.shadowContainer}else if(this.shadowRoot)t=this.shadowRoot;else{this.shadowContainer.className="search-jumper-shadow";let r=Me(`
                        ...
                        `);this.shadowContainer.appendChild(r);let i=this.shadowContainer.attachShadow({mode:"closed"});t=document.createElement("div"),t.id="search-jumper-root",t.style.display="none",t.setAttribute("contenteditable","false");let s=document.createElement("style");s.innerHTML=ee("#search-jumper-root{display: block!important;}"),t.appendChild(s),i.appendChild(t),this.shadowRoot=t}return e.parentNode!=t&&t.appendChild(e),!0}contains(e){return e==this.shadowContainer||this.bar.contains(e)}appendBar(){if((!Ze||!Ze.parentNode)&&(Ze=Me(Et),Ke||this.addToShadow(Ze)),this.addToShadow(this.con)){let e=this,t=()=>{setTimeout(()=>{if(e.shadowContainer&&!e.shadowContainer.parentNode){Te?document.body.appendChild(e.shadowContainer):document.documentElement.appendChild(e.shadowContainer),t();return}!et&&e.con.parentNode&&getComputedStyle(e.con).zIndex!="2147483647"&&(this.removeBar(),Ke?he(M("cspDisabled")):(Ke=!0,Ze=Me(Et),e.shadowContainer.parentNode.removeChild(e.shadowContainer),e.shadowContainer=document.createElement("div"),e.shadowContainer.setAttribute("contenteditable","false"),document.documentElement.appendChild(e.shadowContainer),e.appendBar()))},100)};t()}}async searchBySiteName(e,t,r){t||(t={}),t&&t.type==="drop"&&this.closeShowAll();for(let[i,s]of this.allSiteBtns)if(i.dataset.name==e){if(i.dataset.showTips){i.dispatchEvent(new CustomEvent("showTips"));return}await this.siteSetUrl(i,{button:t.button,altKey:t.altKey,ctrlKey:t.ctrlKey,shiftKey:t.shiftKey,metaKey:t.metaKey});let n=/^(https?|ftp):/.test(i.href);n&&i.setAttribute("target",r?"_self":"_blank"),i.click(),n&&i.setAttribute("target",i.dataset.target==1?"_blank":"_self");return}for(let i=Se.length-1;i>=0;i--){let s=Se[i];if(s.dataset.type==e){s.firstChild.onmouseup&&s.firstChild.onmouseup({button:2});return}}}async searcAllhByTypeName(e){for(let t=Se.length-1;t>=0;t--){let r=Se[t];if(r.dataset.type==e){r.firstChild.onmouseup&&r.firstChild.onmouseup({button:2});return}}}autoGetFirstType(){B||(B=_(document));let e;switch(B.nodeName.toUpperCase()){case"IMG":e=this.bar.querySelector(".search-jumper-targetImg:not(.notmatch)");break;case"AUDIO":e=this.bar.querySelector(".search-jumper-targetAudio:not(.notmatch)");break;case"VIDEO":e=this.bar.querySelector(".search-jumper-targetVideo:not(.notmatch)");break;case"A":We()?e=this.bar.querySelector(".search-jumper-needInPage:not(.notmatch)"):e=this.bar.querySelector(".search-jumper-targetLink:not(.notmatch)");break;default:We()?e=this.bar.querySelector(".search-jumper-needInPage:not(.notmatch)"):B.parentNode.nodeName.toUpperCase()==="A"?e=this.bar.querySelector(".search-jumper-targetLink:not(.notmatch)"):e=this.bar.querySelector(".search-jumper-targetPage:not(.notmatch)");break}if(e||(e=this.bar.querySelector(".search-jumper-targetAll:not(.notmatch)")||this.bar.querySelector(".search-jumper-type")),e){this.setFuncKeyCall(!1);let t=new PointerEvent("mousedown");e.classList.contains("search-jumper-open")&&(e.children[0].onmousedown?e.children[0].onmousedown():e.children[0].dispatchEvent(t)),e.children[0].onmousedown?e.children[0].onmousedown():e.children[0].dispatchEvent(t)}return e}searchAuto(e,t){e||(e=0);let r=this.autoGetFirstType();if(!r)return;let i=r.querySelectorAll("a.search-jumper-btn:not(.notmatch)");if(e<i.length){let s=i[e];this.searchBySiteName(s.dataset.name,t)}}setNav(e,t){!t&&Ye!=e&&(K.setItem("navEnable",e||""),Ye=e),e?(t||this.locBtn.classList.add("checked"),this.searchJumperNavBar.style.display=""):(t||this.locBtn.classList.remove("checked"),this.searchJumperNavBar.style.display="none",this.navPointer.style.display="none")}lockSearchInput(e){this.lockSiteKeywords=!0,this.searchLockInput.innerText=e,this.con.classList.add("lock-input"),this.searchInput.value="",this.searchInput.style.paddingLeft=`${15+this.searchLockInput.scrollWidth}px`,this.searchInput.placeholder=M("inputKeywords")}async initRun(){let e=this;this.siteIndex=1,this.customInput=!1,this.fontPool=[],this.allSiteBtns=[],this.allListBtns=[],this.allLists=[],this.dockerScaleBtns=[],this.bar.style.visibility="hidden";let t=0,r=[];this.checkSelHandler=v=>{v.altKey&&this.searchInPageTab.checked&&window.getSelection().toString()&&this.showSearchInput()},this.splitSep="\u25CE",this.lockWords="",this.marks={},this.initInPageWords=[],this.highlightSpans={},this.curHighlightWords=[],this.curWordIndex=0;let i=()=>{this.searchJumperInPageInput.focus(),this.highlight("");let v=this.lockWords.trim();if(!v){this.submitInPageWords();return}this.searchJumperInPageInput.value&&(v+=this.splitSep+this.searchJumperInPageInput.value),this.lockWords="",this.searchJumperInPageInput.value=v,this.searchInPageLockWords.innerHTML=ee(),this.searchJumperInPageInput.style.paddingLeft=""};document.addEventListener("keydown",v=>{v.keyCode===27&&(et?(this.searchInput.value="",this.searchInput.dispatchEvent(new CustomEvent("input"))):this.inInput?this.hideSearchInput():this.lockWords?(this.highlight(""),this.searchJumperInPageInput.value=this.lockWords,this.lockWords="",this.searchInPageLockWords.innerHTML=ee(),this.setNav(!1,!0)):this.funcKeyCall&&this.removeBar())},!0),this.searchJumperInPageInput.addEventListener("focus",v=>{this.searchInputDiv.classList.add("active")}),this.searchJumperInPageInput.addEventListener("blur",v=>{this.searchInputDiv.classList.remove("active")}),this.searchJumperInPageInput.addEventListener("keydown",v=>{switch(v.stopPropagation(),v.keyCode){case 8:if(!this.searchJumperInPageInput.value){let z=this.searchInPageLockWords.lastChild;z&&(z.dispatchEvent(new CustomEvent("editword")),v.preventDefault())}break;case 9:v.preventDefault(),this.filterSitesTab.checked=!0,this.con.classList.remove("in-find"),this.searchInput.focus();break;case 13:{let z=this.searchJumperInPageInput.value?this.submitInPageWords():[];if(z&&z.length>0){let G=z.pop();this.currentSearchInPageLockWords&&(this.currentSearchInPageLockWords.firstChild.style.transform=""),this.currentSearchInPageLockWords=G;let O=new PointerEvent("mousedown",{button:v.shiftKey?2:0});G.dispatchEvent(O)}else if(this.lockWords){this.currentSearchInPageLockWords||(this.currentSearchInPageLockWords=this.searchInPageLockWords.lastChild,this.currentSearchInPageLockWords.firstChild.style.transform="scale(1.1)");let G=new PointerEvent("mousedown",{button:v.shiftKey?2:0});this.currentSearchInPageLockWords.dispatchEvent(G)}}break;case 37:this.searchJumperInPageInput.value==""&&this.lockWords&&(this.currentSearchInPageLockWords?this.currentSearchInPageLockWords.previousElementSibling&&(this.currentSearchInPageLockWords.firstChild.style.transform="",this.currentSearchInPageLockWords=this.currentSearchInPageLockWords.previousElementSibling,this.currentSearchInPageLockWords.firstChild.style.transform="scale(1.1)"):(this.currentSearchInPageLockWords=this.searchInPageLockWords.lastChild,this.currentSearchInPageLockWords.firstChild.style.transform="scale(1.1)"));break;case 39:this.searchJumperInPageInput.value==""&&this.lockWords&&(this.currentSearchInPageLockWords?this.currentSearchInPageLockWords.nextElementSibling&&(this.currentSearchInPageLockWords.firstChild.style.transform="",this.currentSearchInPageLockWords=this.currentSearchInPageLockWords.nextElementSibling,this.currentSearchInPageLockWords.firstChild.style.transform="scale(1.1)"):(this.currentSearchInPageLockWords=this.searchInPageLockWords.lastChild,this.currentSearchInPageLockWords.firstChild.style.transform="scale(1.1)"));break;default:break}},!0),this.editBtn.addEventListener("click",v=>{i()}),this.addWord.addEventListener("click",v=>{this.showModifyWindow()}),this.searchInPageTab.addEventListener("change",v=>{this.initSetInPageWords(),this.searchJumperInPageInput.focus(),this.con.classList.add("in-find")}),this.filterSitesTab.addEventListener("change",v=>{this.searchInput.focus(),this.con.classList.remove("in-find")}),Ne?(this.recoverBtn.addEventListener("click",v=>{this.lockWords="",this.searchJumperInPageInput.value=Ne,this.searchInPageLockWords.innerHTML=ee(),this.highlight(""),this.submitInPageWords(),this.searchJumperInPageInput.focus()}),this.pinBtn.classList.add("checked")):this.recoverBtn.style.display="none",this.pinBtn.addEventListener("click",v=>{this.submitInPageWords(),this.pinBtn.classList.contains("checked")?(Ne="",this.pinBtn.classList.remove("checked")):this.lockWords&&(Ne=this.lockWords,this.pinBtn.classList.add("checked")),K.setItem("globalInPageWords",Ne)}),this.wordModeBtn.addEventListener("click",v=>{this.wordModeBtn.classList.contains("checked")?this.wordModeBtn.classList.remove("checked"):this.wordModeBtn.classList.add("checked"),this.lockWords&&this.refreshPageWords(this.lockWords)}),this.saveRuleBtn.addEventListener("click",v=>{this.lockWords&&(Te||Dt(()=>{let z=c.prefConfig.inPageRule||{};z[this.inPageRuleKey||ue.replace(/([&\?]_i=|#).*/,"")]=this.lockWords,c.prefConfig.inPageRule=z,c.lastModified=new Date().getTime(),jt=c.lastModified,K.setItem("searchData",c),Ce(M("save completed"))}))}),this.emptyBtn.addEventListener("click",v=>{this.lockWords="",this.searchJumperInPageInput.value="",this.searchInPageLockWords.innerHTML=ee(),this.searchJumperInPageInput.style.paddingLeft="",this.submitInPageWords(),this.searchJumperInPageInput.focus()}),this.copyInPageBtn.addEventListener("click",v=>{this.lockWords&&(Re(this.lockWords.replace(/◎/g,`
`)),Ce("Copied successfully!"))}),this.setNav(Ye),this.locBtn.addEventListener("click",v=>{this.setNav(!this.locBtn.classList.contains("checked"))}),this.closeNavBtn.addEventListener("click",v=>{this.lockWords?(this.searchJumperInPageInput.value=this.lockWords||"",this.lockWords="",this.searchInPageLockWords.innerHTML=ee(),this.searchJumperInPageInput.style.paddingLeft="",this.highlight(""),this.searchJumperInPageInput.focus(),this.setNav(!1,!0),K.setItem("disableHighlight",location.hostname),this.bar.style.display==="none"&&this.removeBar()):this.setNav(!1)}),this.minNavBtn.addEventListener("click",v=>{if(this.searchJumperNavBar.classList.contains("minimize")){if(this.searchJumperNavBar.classList.remove("minimize"),this.lockWords.trim())return;this.submitInPageWords()}else{this.searchJumperNavBar.classList.add("minimize"),this.highlight("");let z=this.lockWords.trim();if(!z)return;this.searchJumperInPageInput.value&&(z+=this.splitSep+this.searchJumperInPageInput.value),this.lockWords="",this.searchJumperInPageInput.value=z,this.searchInPageLockWords.innerHTML=ee(),this.searchJumperInPageInput.style.paddingLeft=""}}),this.maxNavBtn.addEventListener("click",v=>{e.showInPage(),e.showInPageSearch()}),this.navMarks.addEventListener("click",v=>{let z=v.offsetY/this.navMarks.clientHeight*100,G=[].slice.call(this.navMarks.querySelectorAll("span"));G.sort((ie,re)=>(ie=parseFloat(ie.style.top),re=parseFloat(re.style.top),ie>re?1:ie<re?-1:0));let O;for(let ie=0;ie<G.length;ie++){O=G[ie];let re=parseFloat(O.style.top);if(re>z){if(ie>0){let D=G[ie-1],T=parseFloat(D.style.top);re-z>z-T&&(O=D)}break}}O&&O.click()}),this.bar.addEventListener("mousedown",v=>{v&&v.stopPropagation&&v.stopPropagation(),v&&v.preventDefault&&v.preventDefault()}),this.con.addEventListener("dblclick",v=>{v.stopPropagation(),v.preventDefault()});let s=v=>{v.stopPropagation(),v.preventDefault();let z=e.searchJumperExpand.parentNode;if(!z||!z.classList.contains("not-expand"))return;z.classList.remove("not-expand"),z.classList.remove("search-jumper-move");let G=e.con.classList.contains("search-jumper-left")||e.con.classList.contains("search-jumper-right");z.removeChild(e.searchJumperExpand);let O=Math.max(z.scrollWidth,z.scrollHeight)+5+"px";G?(z.style.height=O,z.style.width=""):(z.style.width=O,z.style.height=""),setTimeout(()=>{e.checkScroll(),z.classList.add("search-jumper-move")},251)},n;this.searchJumperExpand.addEventListener("click",s,!0),this.searchJumperExpand.addEventListener("contextmenu",s,!0),this.searchJumperExpand.addEventListener("mouseenter",v=>{c.prefConfig.overOpen&&(clearTimeout(n),n=setTimeout(()=>{s(v)},500));let z=new CustomEvent("sitelist",{detail:{bind:v.currentTarget}});v.currentTarget.parentNode.dispatchEvent(z)},!1),c.prefConfig.overOpen&&this.searchJumperExpand.addEventListener("mouseleave",v=>{clearTimeout(n)},!1),this.pickerBtn.addEventListener("click",v=>{this.togglePicker()}),this.maxEleBtn.addEventListener("click",v=>{ke.expand()}),this.minEleBtn.addEventListener("click",v=>{ke.collapse()}),this.copyEleBtn.addEventListener("click",v=>{ke.copy()}),this.openLinkBtn.addEventListener("click",v=>{ke.openLinks()});let a=document.createElement("div");a.className="listArrow",this.listArrow=a,this.con.appendChild(a);for(let v of c.sitesConfig){if(v.bookmark||v.sites.length>100||/^BM/.test(v.type)&&v.icon==="bookmark"){r.push(v);continue}await this.createType(v),t+=v.sites.length,t>100&&(await $e(1),t=0)}this.initHistorySites(),this.initSort(),this.bar.style.visibility="",this.bar.style.display="none",this.searchInPageRule(),ae&&ft.test(ae.url)?this.inSearchEngine():c.prefConfig.alwaysShow&&!St&&!at&&(this.bar.style.display="",this.initPos(),this.appendBar()),Tt&&(B=Tt.target,this.batchOpen(Tt.sites,{button:2})),Tt=!1,Ge&&(this.submitAction(Ge),setTimeout(()=>{K.setListItem("inPagePostParams",location.hostname,"")},1e4));let o=v=>{clearTimeout(p);let z,G="";ae&&!e.searchInput.value?(z=e.con.querySelector(".search-jumper-btn.current"),G="_self"):(z=e.con.querySelector(".search-jumper-type.search-jumper-open>a.search-jumper-btn:not(.input-hide)")||e.con.querySelector(".search-jumper-needInPage>a.search-jumper-btn:not(.input-hide)")||e.con.querySelector("a.search-jumper-btn:not(.input-hide)"),G="_blank"),z&&e.openSiteBtn(z,G,!v.ctrlKey)},p;this.inInput=!1;let d=()=>{xt!==e.searchInput.value&&(xt=e.searchInput.value,K.setItem("cacheFilter",xt))};this.searchInput.addEventListener("input",v=>{clearTimeout(p),p=setTimeout(()=>{e.searchSiteBtns(e.searchInput.value)},500)}),this.searchInput.addEventListener("click",v=>{e.searchInput.select()}),this.searchInput.addEventListener("blur",v=>{d()}),this.searchInput.addEventListener("keydown",v=>{switch(v.stopPropagation(),v.keyCode){case 9:v.shiftKey&&(v.preventDefault(),this.searchInPageTab.checked=!0,this.con.classList.add("in-find"),this.searchJumperInPageInput.focus(),this.initSetInPageWords());break;case 13:if(this.searchJumperInputKeyWords.disabled){clearTimeout(p);let z,G="";ae&&!e.searchInput.value?(z=e.con.querySelector(".search-jumper-btn.current"),G="_self"):(z=e.con.querySelector(".search-jumper-type.search-jumper-open>a.search-jumper-btn:not(.input-hide)")||e.con.querySelector(".search-jumper-needInPage>a.search-jumper-btn:not(.input-hide)")||e.con.querySelector("a.search-jumper-btn:not(.input-hide)"),G="_blank"),z&&e.openSiteBtn(z,G,!v.ctrlKey)}else this.searchJumperInputKeyWords.value?o(v):this.searchJumperInputKeyWords.focus(),d();break;case 8:break;default:break}}),this.searchJumperInputKeyWords.addEventListener("input",v=>{clearTimeout(p),p=setTimeout(()=>{e.getSuggest(e.searchJumperInputKeyWords.value)},200)}),this.searchJumperInputKeyWords.addEventListener("keydown",v=>{switch(v.keyCode!==27&&v.stopPropagation(),v.keyCode){case 9:this.inInput?v.shiftKey||(v.preventDefault(),this.searchInPageTab.checked=!0,this.con.classList.add("in-find"),this.searchJumperInPageInput.focus(),this.initSetInPageWords()):(v.preventDefault(),this.searchInput.focus());break;case 13:o(v);break;default:break}},!0),this.con.addEventListener("keypress",v=>{v.stopPropagation()},!0),this.closeBtn.addEventListener("mousedown",v=>{e.hideSearchInput(),c.prefConfig.emptyAfterCloseInput&&(e.highlight(""),e.searchJumperInPageInput.value=e.lockWords||"",e.lockWords="",e.searchInPageLockWords.innerHTML=ee(),e.setNav(!1,!0))});let u=window.innerWidth/2,m,h,f,b,S=v=>v.type.indexOf("mouse")===0?v.clientX:v.changedTouches[0].clientX,L=v=>v.type.indexOf("mouse")===0?v.clientY:v.changedTouches[0].clientY,x=v=>{let z=.25*window.innerWidth,G=u+S(v)-f;if(e.searchInputDiv.style.top="unset",e.searchInputDiv.style.left=G+"px",e.searchInputDiv.style.bottom=m-(L(v)-b)+"px",G>window.innerWidth/2){let O=window.innerWidth-G+z-50;e.searchInputDiv.style.maxWidth=O+"px"}else{let O=G+z;G<z&&(G+=z-G,e.searchInputDiv.style.left=G+"px"),e.searchInputDiv.style.maxWidth=O+"px"}v.stopPropagation(),v.preventDefault()},N=v=>{document.removeEventListener("mouseup",N),document.removeEventListener("mousemove",x),document.removeEventListener("touchend",N),document.removeEventListener("touchmove",x),h.style.cursor="",u+=S(v)-f,m-=L(v)-b},W=()=>{m||(m=e.con.classList.contains("search-jumper-bottom")?window.innerHeight*.95-60:window.innerHeight*.03)},I=!1;this.searchInputDiv.addEventListener("touchstart",v=>{I=!0,(v.target.className==="inputGroup"||v.target.nodeName.toUpperCase()==="LABEL")&&(W(),h=v.target,h.style.cursor="grabbing",f=S(v),b=L(v),document.addEventListener("touchend",N),document.addEventListener("touchmove",x))},{passive:!0,capture:!1}),this.searchInputDiv.addEventListener("mousedown",v=>{if(I){I=!1;return}(v.target.className==="inputGroup"||v.target.nodeName.toUpperCase()==="LABEL")&&(W(),h=v.target,h.style.cursor="grabbing",f=v.clientX,b=v.clientY,document.addEventListener("mouseup",N),document.addEventListener("mousemove",x),v.stopPropagation(),v.preventDefault())});let H,V,F=v=>{let z=v.clientX-V+H+20;this.searchInputDiv.style.width=z+"px"},y=v=>{document.removeEventListener("mousemove",F),document.removeEventListener("mouseup",y)};this.rightSizeChange.addEventListener("mousedown",v=>{V=v.clientX,H=this.searchInput.clientWidth*2+2,document.addEventListener("mousemove",F),document.addEventListener("mouseup",y),v.stopPropagation(),v.preventDefault()});let j,A=v=>{if(!this.contains(v.target)){let z=/^(https?|ftp):/.test(j.href);z&&j.setAttribute("target","_blank"),z?ge(j.href,{active:!1,insert:!0}):j.click(),z&&j.setAttribute("target",j.dataset.target==1?"_blank":"_self")}_(document).removeEventListener("dragover",P),document.removeEventListener("drop",A),document.removeEventListener("dragover",P)},P=v=>{v.preventDefault()},$=v=>{_(document).removeEventListener("dragover",P),document.removeEventListener("drop",A),document.removeEventListener("dragover",P)};this.bar.addEventListener("dragstart",v=>{let z=v.target,G=z.parentNode;z.nodeName.toUpperCase()!=="IMG"&&z.nodeName.toUpperCase()!=="A"||(z.classList&&z.classList.contains("search-jumper-btn")?(j=z,_(document).addEventListener("dragover",P),document.addEventListener("drop",A),document.addEventListener("dragend",$)):G&&G.classList&&G.classList.contains("search-jumper-btn")&&(j=G,_(document).addEventListener("dragover",P),document.addEventListener("drop",A),document.addEventListener("dragend",$)))},!0),t=0;let Z=ae!==!1;for(let v of r)await this.createType(v),t+=v.sites.length,t>200&&(await $e(1),t=0);if(!this.findInpageAddons){this.findInpageAddons=ye.searchJumperAddons.filter(O=>O.type=="findInPage").sort((O,ie)=>(O.sort||0)-(ie.sort||0));let v=this,z=0,G={};this.findInpageAddons.forEach(O=>{let ie=O.name||"addon"+z++;G[O.sort]||c.prefConfig.disableAddon[ie]===!0?O.disable=!0:(c.prefConfig.disableAddon[ie],O.disable=!1),G[O.sort]=!0,v.createAddonSpan(ie,O)})}if(this.fontPool.length>0||at){let v=document.createElement("link");v.rel="stylesheet",v.href=c.prefConfig.fontAwesomeCss||"https://lib.baomitu.com/font-awesome/6.1.2/css/all.css",document.documentElement.insertBefore(v,document.documentElement.children[0]),this.addToShadow(v.cloneNode()),mr(()=>{let z=!1;this.fontPool.forEach(G=>{G.innerText="",G.style.fontSize="",G.style.color="",z=!0,Jt.unshift(G)}),z&&(at||ue===Ni)&&setTimeout(()=>{Vi()},3e3),this.buildAllPageGroupTab()})}else this.buildAllPageGroupTab();if(et)return;Ht&&Ht!=location.hostname&&window.top==window.self&&K.setItem("disableHighlight",""),await this.testCSP();let pe=ae&&ft.test(ae.url);if(!Z&&pe?this.inSearchEngine():!ae&&window.top==window.self&&this.checkSearchJump(),/^#sjhl=/.test(location.hash)){let v=location.hash.match(/^#sjhl=(.*?)(&i=(\d+))?$/),z=v[1],G=parseInt(v[3]||1)-1;try{z=decodeURIComponent(z)}catch(O){console.log(O)}this.setInPageWords(z,()=>{let ie=document.querySelectorAll("mark.searchJumper")[G];ie&&ie.scrollIntoView({behavior:"smooth",block:"center",inline:"center"})})}else if(location.pathname==="/hoothin/SearchJumper/discussions/new"&&location.search==="?category=search-engines"){let v=c.sitesConfig.filter(z=>z&&!(/^BM/.test(z.type)&&z.icon==="bookmark"));Fi("#discussion_body","```json\n"+JSON.stringify(v,null,2)+"\n```")}let te=this.initInPageWords&&this.initInPageWords.length;(Ri||this.bar.style.display==="none"&&(!Ye||!te))&&this.removeBar()}buildAllPageGroupTab(){let e=this;this.groupTab.innerHTML=ee(),Se.forEach(t=>{if(t.classList.contains("notmatch"))return;let r=t.dataset.type,i=t.firstElementChild.cloneNode(!0),s=document.createElement("span");s.appendChild(i),s.dataset.type=r,s.addEventListener("click",n=>{let a=e.sitelistBox.querySelector(`[data-type="${r}"]`);a&&a.scrollIntoView({behavior:"smooth",block:"start",inline:"center"})}),e.groupTab.appendChild(s)})}async refreshEngines(){if(c&&!this.refreshing){this.refreshing=!0,setTimeout(()=>{this.refreshing=!1},500),jt=c.lastModified,this.removeBar(),Se&&Se.length&&Se.forEach(e=>{e.parentNode&&e.parentNode.removeChild(e)}),Se=[],this.allSiteBtns=[],this.allListBtns=[],this.allLists=[],this.historyTypeEle=null;for(let e of c.sitesConfig)await this.createType(e);this.initHistorySites(),this.initSort(),this.buildAllPageGroupTab(),et&&this.appendBar()}}waitForHide(e){let t=this;if(this.bar.classList.contains("grabbing")||this.hiding)return;e===0&&(this.hiding=!0,setTimeout(()=>{t.hiding=!1},500)),this.touched=!1;var r=()=>{if(t.bar.classList.remove("search-jumper-isTargetImg"),t.bar.classList.remove("search-jumper-isTargetAudio"),t.bar.classList.remove("search-jumper-isTargetVideo"),t.bar.classList.remove("search-jumper-isTargetLink"),t.bar.classList.remove("initShow"),t.tips.style.opacity=0,t.tips.style.display="none",t.tips.innerHTML=ee(""),t.funcKeyCall)if(t.setFuncKeyCall(!1),ae&&!ae.hideNotMatch&&!c.prefConfig.hideOnSearchEngine||t.con.classList.contains("resizePage")){t.initPos();let s=t.bar.querySelector(".search-jumper-type:nth-child(1)>span");if(s&&!s.classList.contains("search-jumper-open"))if(s.onmousedown)s.onmousedown();else{let n=new PointerEvent("mousedown");s.dispatchEvent(n)}}else t.bar.style.display="none";c.prefConfig.autoClose&&t.closeOpenType(),t.hideTimeout=null};this.hideTimeout&&clearTimeout(this.hideTimeout);let i=typeof e>"u"?this.funcKeyCall?500:c.prefConfig.autoDelay||1e3:e;i?this.hideTimeout=setTimeout(r,i):r(),this.preList&&(this.preList.style.visibility="hidden",this.listArrow.style.cssText="")}searchEngineWords(e){return e=e.replace(/( |^)-\S+/g,""),/".+"/.test(e)&&(e=e.replace(/"(.+)"/g,(t,r,i,s)=>`\u25CE${r}\u25CE`).replace(/^◎|◎$/g,"")),this.lastSearchEngineWords=e.replace(/['";]/g," "),this.lastSearchEngineWords}setInPageWords(e,t,r){this.initInPageWords.push(e),this.con.classList.add("in-find");let i=()=>{setTimeout(async()=>{if(_(document).style.display==="none"&&(_(document).style.display=""),this.lockWords)this.initInPageWords=[];else{for(;document.hidden;)await $e(1e3);K.setItem("lastHighlight",location.hostname);let s=this.initInPageWords.shift();for(;s;)this.searchJumperInPageInput.value=s,this.submitInPageWords(!!r),s=this.initInPageWords.shift()}t&&t(),await $e(100),K.setItem("lastHighlight","")},300)};if(document.readyState!="complete"){let s=n=>{document.readyState=="complete"&&(document.removeEventListener("readystatechange",s),window.removeEventListener("load",s),i())};document.addEventListener("readystatechange",s),window.addEventListener("load",s)}else i()}searchInPageRule(){if(c.prefConfig.disableAutoHighlight){let e=c.prefConfig.disableAutoHighlight.trim().split(`
`);for(let t=0;t<e.length;t++){let r=e[t],i=!1;if(r.indexOf("/")===0){let s=r.match(/^\/(.*)\/([igm]*)$/);s&&(i=new RegExp(s[1],s[2]).test(ue))}else i=this.globMatch(r,ue);if(i){this.disableAutoHighlight=!0;return}}}if(Ji===location.hostname&&(this.disableAutoHighlight=!0),c.prefConfig.inPageRule){let e=Object.keys(c.prefConfig.inPageRule);for(let t=0;t<e.length;t++){let r=e[t];if(!r)continue;let i=!1;if(r.indexOf("/")===0){let s=r.match(/^\/(.*)\/([igm]*)$/);s&&(i=new RegExp(s[1],s[2]).test(ue))}else i=this.globMatch(r,ue);if(i){let s=c.prefConfig.inPageRule[r];if(!s)continue;this.inPageRuleKey=r,this.disableAutoHighlight=!0,this.setInPageWords(s);break}}}}checkSearchJump(){if(this.inPageRuleKey||this.disableAutoHighlight)return;let e;if(c.prefConfig.showInSearchJumpPage&&zt&&!Ht&&$i.indexOf(zt)!=-1){Ee&&this.wordModeBtn.classList.add("checked"),e=Ee;try{e=decodeURIComponent(e),e=this.searchEngineWords(e)}catch{}}if(e=e||Ne,e){this.appendBar();let t=this;this.setInPageWords(e,()=>{!t.navMarks.innerHTML&&t.bar.style.display==="none"&&t.removeBar()},!0)}else if(!this.searchJumperInPageInput.value&&$i.indexOf(zt)!=-1&&Ee){e=Ee,this.wordModeBtn.classList.add("checked");try{e=decodeURIComponent(e)}catch{}this.searchJumperInPageInput.value=e}}inSearchEngine(){if(!this.currentType||!ae||St||this.inPageRuleKey||this.disableAutoHighlight)return;if(!/sidesearch=(1|true)$/i.test(location.search)&&(!/#p{/.test(ae.url)||ae.keywords)){if(this.appendBar(),this.currentType.classList.contains("search-jumper-needInPage"))this.bar.classList.add("search-jumper-isTargetPage");else if(this.currentType.classList.contains("search-jumper-targetAll")||this.currentType.classList.contains("search-jumper-targetImg")||this.currentType.classList.contains("search-jumper-targetAudio")||this.currentType.classList.contains("search-jumper-targetVideo")||this.currentType.classList.contains("search-jumper-targetLink")||this.currentType.classList.contains("search-jumper-targetPage"))return;c.prefConfig.hideOnSearchEngine||(this.bar.style.display="",this.initPos())}this.insertHistory(this.currentType,!0),this.wordModeBtn.classList.add("checked");let e=c.prefConfig.showInSearchEngine?this.searchEngineWords(Oe):Ne;e&&this.setInPageWords(e,null,!0)}getSuggest(e){let t=this.suggestDatalist;if(t.innerHTML=ee(),!e)return;let r=(i,s,n)=>{Be({method:"GET",url:i,responseType:n?"blob":"",headers:{referer:i,origin:i},onload:function(a){let o=a.response;if(!(a.status>=400||!o))if(n){let p=new FileReader;p.onload=()=>{s(p.result)},p.readAsText(o,n)}else s(o)},onerror:function(a){he(a)},ontimeout:function(a){he(a)}})};switch(c.prefConfig.suggestType){case"google":r("https://suggestqueries.google.com/complete/search?client=youtube&q=%s&jsonp=window.google.ac.h".replace("%s",e),i=>{if(i=i.match(/window.google.ac.h\((.*)\)$/,"$1"),i){i=JSON.parse(i[1])[1];for(let s in i){let n=document.createElement("option");n.value=i[s][0],t.appendChild(n)}}});break;case"baidu":r("https://suggestion.baidu.com/su?wd=%s&cb=".replace("%s",e),i=>{if(i=i.match(/.*,s:(.*)}\);$/,"$1"),i){i=JSON.parse(i[1]);for(let s in i){let n=document.createElement("option");n.value=i[s],t.appendChild(n)}}},"GBK");break;case"bing":r("https://api.bing.com/qsonhs.aspx?type=json&q=%s".replace("%s",e),i=>{if(i){i=JSON.parse(i).AS.Results;for(let s in i){let n=i[s].Suggests;for(let a in n){let o=document.createElement("option");o.value=n[a].Txt,t.appendChild(o)}}}});break;default:break}}searchSiteBtns(e){let t=e.indexOf("**"),r="",i=!1;t>0&&(r=e.slice(0,t),e=e.slice(t+2)),e.indexOf("^")===0?i=!0:(r=r.toLowerCase(),e=e.toLowerCase()),e?this.con.classList.add("searching"):this.con.classList.remove("searching");let s=!/[^\w\.\/\:\*\?\^\$]/.test(e);this.allListBtns.forEach(o=>{o.classList.add("input-hide")}),Se.forEach(o=>{o.classList.add("input-hide")});let n=0;this.filterGlob.innerHTML=ee(),this.allSiteBtns.forEach(o=>{let p=o[0],d=o[1],u=p.parentNode,m=p.dataset.type,h=p.dataset.name,f=p.title;i||(m=m.toLowerCase(),h=h.toLowerCase(),f=f.toLowerCase());let b="";if(r){if(!this.globMatch(r,m))return;b=p.dataset.type+"**"}let S=!1;if(p.dataset.clone||(this.globMatch(e,h)?(S=!0,b+="^"+p.dataset.name+"$"):p.title&&this.globMatch(e,f)&&(S=!0,b+="^"+p.title+"$")),!S){if(s){if(!p.dataset.host){let L=/^https?:\/\/([^\/]*)\/[\s\S]*$/,x=d.url;p.dataset.host=L.test(x)?x.replace(L,"$1"):x,p.dataset.host&&(p.dataset.host=p.dataset.host.toLowerCase())}S=this.globMatch(e,p.dataset.host)}S?b+="^"+p.dataset.host+"$":p.classList.add("input-hide")}if(S){p.classList.remove("input-hide"),u&&u.classList.remove("input-hide");let L;for(let x=0;x<this.allListBtns.length;x++)if(this.allListBtns[x].id=="list"+p.dataset.id){L=this.allListBtns[x];break}if(L&&L.classList.remove("input-hide"),n<50&&e&&this.searchInput.value!==b){n++;let x=document.createElement("option");x.value=b,this.filterGlob.appendChild(x)}}}),Se.forEach(o=>{let p;for(let d=0;d<this.allLists.length;d++)if(this.allLists[d].dataset.type==o.dataset.type){p=this.allLists[d];break}p&&(o.classList.contains("input-hide")?p.classList.add("input-hide"):p.classList.remove("input-hide"))});let a=this.bar.querySelector(".search-jumper-type:not(.input-hide)");if(a){if(!a.classList.contains("search-jumper-open")){let o=a.querySelector("span.search-jumper-btn");if(o.onmousedown)o.onmousedown();else{let p=new PointerEvent("mousedown");o.dispatchEvent(p)}}if(this.searchJumperExpand.parentNode==a){let o=new PointerEvent("click");this.searchJumperExpand.dispatchEvent(o)}}}globMatch(e,t,r){if(t.length>500)return!1;try{if(e.length==0||e==="*")return!0;if(e.length===1&&e[0]==="$")return!t||t.length===0;if(e.length>1&&e[0]==="*"&&(!t||t.length===0))return!1;if(!r)if(r=!0,e.length>1&&e[0]==="^"&&t&&t.length!==0){if(e=e.substring(1),e[0]!==t[0])return!1}else e[0]!=="*"&&(e="*"+e);if(e.length>1&&e[0]==="?"||e.length!=0&&t&&t.length!==0&&e[0]===t[0])return this.globMatch(e.substring(1),t.substring(1),!!r);if(e.length>0&&e[0]==="*")return this.globMatch(e.substring(1),t,!!r)||this.globMatch(e,t&&t.substring(1),!!r)}catch(i){he(i)}return!1}setCurrentSite(e,t){ae=e,t.classList.add("current"),Oe="",!/#p{|^(showTips|find)/.test(e.url)&&ft.test(e.url)&&(this.updateCacheKeywords(),K.setItem("referrer",location.hostname))}updateCacheKeywords(){let e=Xe();e&&e!=Ee&&(Ee=e,K.setItem("cacheKeywords",e))}refresh(){this.refreshInPageTimer&&clearTimeout(this.refreshInPageTimer),this.refreshInPageTimer=setTimeout(()=>{let e=this.curHighlightWords;if(this.highlight(""),this.highlight(e),this.bar.style.display=="none"){ae=null;let t;for(let r in c.sitesConfig){if(ae)break;if(t=c.sitesConfig[r],!t)continue;let i=t.sites;for(let s in i){if(ae)break;let n=i[s];if(!n||!n.url)continue;let a;if(n.match!=="0"){if(n.match)new RegExp(n.match).test(ue)&&(a=n);else if(n.url.indexOf(location.hostname)!=-1){if(n.url.indexOf("site")!=-1){let o=n.url.match(/site(%3A|:)([\s\S]+?)[\s%]/);o&&ue.indexOf(o[2])!=-1&&n.url.replace(o[0],"").indexOf(location.hostname)!=-1&&(a=n)}else if(!ae&&n.url.replace(/^https?:\/\//,"").replace(location.host,"").replace(/\/?[\?#][\s\S]*/,"")==location.pathname.replace(/\/$/,"")){let o=n.url.match(/[^\/\?&]+(?=%[stb])/g);o&&(o=o.join(".*"),new RegExp(o).test(ue)&&(a=n))}}}if(a){let o=this.getTargetSitesByName([a.name])[0];this.currentType=o.parentNode,this.setCurrentSite(a,o)}}}if(ae&&ft.test(ae.url)&&(!/#p{/.test(ae.url)||ae.keywords)&&!c.prefConfig.hideOnSearchEngine){if(this.currentType.classList.contains("search-jumper-targetAll")||this.currentType.classList.contains("search-jumper-targetImg")||this.currentType.classList.contains("search-jumper-targetAudio")||this.currentType.classList.contains("search-jumper-targetVideo")||this.currentType.classList.contains("search-jumper-targetLink")||this.currentType.classList.contains("search-jumper-targetPage"))return;this.appendBar(),this.bar.style.display="",this.initPos();let r=this.bar.querySelector(`.search-jumper-type[data-type="${t.type}"]>span`);if(r&&!r.classList.contains("search-jumper-open")&&(this.bar.insertBefore(r.parentNode,this.bar.children[0]),!c.prefConfig.disableAutoOpen&&!c.prefConfig.disableTypeOpen))if(r.onmousedown)r.onmousedown();else{let i=new PointerEvent("mousedown");r.dispatchEvent(i)}}}},500)}initSort(){if(c.prefConfig.shiftLastUsedType&&this.historyTypeEle&&(ae?this.bar.insertBefore(this.historyTypeEle,this.bar.children[1]):this.bar.insertBefore(this.historyTypeEle,this.bar.children[0])),c.prefConfig.sortType){let e=this;Se.sort((i,s)=>{let n=Le[i.dataset.type]||0;return(Le[s.dataset.type]||0)-n});let t=!1,r=!e.bar.children[0].classList.contains("search-jumper-open");for(let i=Se.length-1;i>=0;i--){let s=Se[i],n=Le[s.dataset.type]||0;if(i==Se.length-1)n>0&&(t=!0,Le[s.dataset.type]=0);else{let a=Le[Se[i+1].dataset.type]||0;n-a>10&&(t=!0,Le[s.dataset.type]=a+10)}e.bar.insertBefore(s,e.bar.children[r?0:1])}t&&K.setItem("sortTypeNames",Le)}}initHistorySites(){this.historySiteBtns=[],this.txtHistorySiteBtns=[],this.imgHistorySiteBtns=[],this.linkHistorySiteBtns=[],this.videoHistorySiteBtns=[],this.audioHistorySiteBtns=[];let e=this;Ve.forEach(async t=>{for(let r of c.sitesConfig){let i=!1,s=r.bookmark||r.sites.length>100||/^BM/.test(r.type)&&r.icon==="bookmark";for(let n=0;n<r.sites.length;n++){let a=r.sites[n];if(a.name==t){let o=await e.createSiteBtn(c.prefConfig.noIcons?"0":a.icon,a,!0,s,r,!0);o.classList.add("historySite"),e.historySiteBtns.push(o),!r.selectImg&&!r.selectLink&&!r.selectPage&&!r.selectVideo&&!r.selectAudio&&e.txtHistorySiteBtns.push(o),r.selectImg&&e.imgHistorySiteBtns.push(o),(r.selectLink||r.selectPage)&&e.linkHistorySiteBtns.push(o),r.selectVideo&&e.videoHistorySiteBtns.push(o),r.selectAudio&&e.audioHistorySiteBtns.push(o),i=!0;break}}if(i)break}})}insertHistory(e,t){if(!c.prefConfig.historyLength)return;e.style.width="auto",e.style.height="auto";let r=this;this.historyInserted=!0;let i=0,s=!t&&c.prefConfig.historyInsertFirst,n=!1,a=0;s||(n=this.searchJumperExpand.parentNode==e&&!c.prefConfig.expandType,n&&(a=(c.prefConfig.numPerLine||7)-1,a=c.prefConfig.historyLength<a?a+a-c.prefConfig.historyLength:a,c.prefConfig.hideTileType&&a++));let o=this.historySiteBtns;e.classList.contains("search-jumper-needInPage")?o=this.txtHistorySiteBtns:e.classList.contains("search-jumper-targetImg")?o=this.imgHistorySiteBtns:e.classList.contains("search-jumper-targetAudio")?o=this.audioHistorySiteBtns:e.classList.contains("search-jumper-targetVideo")?o=this.videoHistorySiteBtns:(e.classList.contains("search-jumper-targetLink")||e.classList.contains("search-jumper-targetPage"))&&(o=this.linkHistorySiteBtns);for(let p=0;p<o.length;p++){let d=o[p];if(d.style.display=="none")continue;let u=d.querySelector("img");if(u&&u.dataset.src&&(u.src=u.dataset.src,delete u.dataset.src),d.parentNode!=e){let m=e.querySelectorAll("a.search-jumper-btn"),h=!1;for(let f=0;f<m.length;f++){let b=m[f];if((b.dataset.oriName||b.dataset.name)==(d.dataset.oriName||d.dataset.name)){h=!0;break}}if(h)continue;if(s)e.children.length>1?e.insertBefore(d,e.children[1]):e.appendChild(d);else if(n){let f=e.querySelectorAll("a.search-jumper-btn");f.length>a?e.insertBefore(d,f[a]):e.insertBefore(d,r.searchJumperExpand)}else e.appendChild(d);if(++i>=c.prefConfig.historyLength)break}else s&&(e.children.length>1?e.insertBefore(d,e.children[1]):e.appendChild(d))}e.style.width=e.scrollWidth+"px",e.style.height=e.scrollHeight+"px"}recoveHistory(){if(!c.prefConfig.historyLength||!this.historyInserted)return;this.historyInserted=!1;let e=this,t;for(let r=0;r<this.historySiteBtns.length;r++){let i=this.historySiteBtns[r];i.classList.contains("historySite")&&(t=i.parentNode,this.siteBtnReturnHome(i))}t&&t.classList.contains("search-jumper-open")&&(t.style.width="auto",t.style.height="auto",t.style.width=t.scrollWidth+"px",t.style.height=t.scrollHeight+"px")}bindSite(e,t){if(e.getAttribute("bind"))return;e.setAttribute("bind",!0);let r=this;t.href&&(e.href=t.href),e.style.display=t.style.display,e.addEventListener("mousedown",async i=>{t.dataset.showTips?(r.con.classList.contains("search-jumper-showall")?B=e.parentNode:r.waitForHide(0),t.dispatchEvent(new CustomEvent("showTips"))):(await r.siteSetUrl(t,{button:i.button,altKey:i.altKey,ctrlKey:i.ctrlKey,shiftKey:i.shiftKey,metaKey:i.metaKey}),t.href&&(e.href=t.href),e.setAttribute("target",t.target)),e.onclick||(e.onclick=s=>(t.dataset.showTips||t.click(),s.stopPropagation(),s.preventDefault(),!1))},!1),e.addEventListener("dragover",i=>{i.preventDefault()},!0),e.addEventListener("dragenter",i=>{r.dragTarget&&r.dragTarget.classList.remove("dragTarget"),r.dragTarget=e,r.dragTarget.classList.add("dragTarget"),clearTimeout(r.dragTimer),r.dragTimer=setTimeout(()=>{e.scrollIntoView({behavior:"smooth",block:"center",inline:"center"})},1e3)},!0),e.addEventListener("dragleave",i=>{e.classList.remove("dragTarget")},!0),e.addEventListener("drop",i=>{clearTimeout(r.dragTimer),r.dragTarget&&r.dragTarget.classList.remove("dragTarget"),r.searchBySiteName(t.dataset.name,i)},!0)}async createList(e,t,r){let i=this,s=document.createElement("div");s.className="sitelist",s.style.visibility="hidden";let n=document.createElement("div");n.className="sitelistCon",s.appendChild(n),s.addEventListener("mouseenter",p=>{i.listArrow.style.cssText=""});let a=document.createElement("p");a.innerText=t.dataset.title,a.title=M("batchOpen"),a.addEventListener("click",p=>{i.batchOpen(r,{ctrlKey:p.ctrlKey,shiftKey:p.shiftKey,altKey:p.altKey,metaKey:p.metaKey,button:p.ctrlKey||p.shiftKey||p.altKey||p.metaKey?0:2})}),s.dataset.type=t.dataset.type,n.appendChild(a);function o(p,d){let u=document.createElement("div");u.id="list"+d;let m=p.querySelector("img"),h=document.createElement("a");if(h.setAttribute("ref","noopener noreferrer"),i.bindSite(h,p),u.appendChild(h),i.allListBtns.push(u),m&&!c.prefConfig.noIcons){let b=m.src||m.dataset.src,S=document.createElement("img");h.appendChild(S),S.onload=L=>{S.style.width="",S.style.height="",S.style.display=""},S.onerror=L=>{S.src=hi},S.style.width="1px",S.style.height="1px",S.style.display="none",b?(/^data:/.test(b)||(S.\u03BFnerr\u03BFr=L=>{S.src=hi,S.onerror=null,S.style.width="",S.style.height="",S.style.display=""}),S.dataset.src=b):S.dataset.src=hi}let f=document.createElement("p");f.innerText=p.dataset.name,u.title=p.title,u.dataset.name=p.dataset.name,h.appendChild(f),n.appendChild(u)}try{for(let[p,d]of e.entries())o(d,d.dataset.id),p%50===49&&await $e(1)}catch{for(let d=0;d<e.length;d++){let u=e[d];o(u,u.dataset.id)}}return this.allLists.push(s),s}async initList(e){e.dataset.inited||(e.style.display="none",e.dataset.inited=!0,[].forEach.call(e.querySelectorAll("div>a>img"),t=>{t.dataset.src&&(t.src=t.dataset.src,delete t.dataset.src)}),await $e(0))}async listPos(e,t){await this.initList(t),t.style="",this.preList=t;let r=e.clientWidth,i=e.clientHeight,s=e.offsetLeft+r/2-this.con.scrollLeft,n=e.offsetTop+i/2-this.con.scrollTop,a=e.offsetParent;for(;a!==null;)s+=a.offsetLeft,n+=a.offsetTop,a=a.offsetParent;let o=window.innerWidth||document.documentElement.clientWidth,p=window.innerHeight||document.documentElement.clientHeight,d=this.listArrow.style;if(d.visibility="visible",d.opacity=1,this.funcKeyCall){t.style.display="block",d.opacity=0;const u=e.getBoundingClientRect();s=u.x+r/2-this.con.scrollLeft,n=u.y+i/2-this.con.scrollTop,s-=t.clientWidth/2;let m=e.getBoundingClientRect().top;m>p/2?(m<t.clientHeight+10&&(t.style.height=m-20+"px"),n-=t.clientHeight+i/2+5):(n+=i/2+5,m+t.clientHeight+i+10>p&&(t.style.height=p-m-i-20+"px")),s<20&&(s=20);let h=o-t.clientWidth-30;s>h&&(s=h),t.style.left=s+"px",t.style.top=n+"px",t.style.display=""}else if(this.bar.clientWidth>this.bar.clientHeight){let u=s;s<30?u=30:s>o-40&&(u=o-40),d.left=u-10+"px",n-i/2<100?(t.style.top=this.bar.clientHeight+"px",d.top=this.bar.clientHeight-10+"px"):(t.style.bottom=this.bar.clientHeight+"px",d.bottom=this.bar.clientHeight-9+"px"),s-=t.scrollWidth/2,s>o-t.scrollWidth-10&&(s=o-t.scrollWidth-10),s<0&&(s=0),t.style.left=s+"px"}else{let u=n;n<30?u=30:n>p-30&&(u=p-30),d.top=u-10+"px",s-r/2<100?(t.style.left=this.bar.clientWidth+"px",d.left=this.bar.clientWidth-9+"px"):(t.style.right=this.bar.clientWidth+"px",d.right=this.bar.clientWidth-9+"px"),n-=t.scrollHeight/2,n>p-t.scrollHeight&&(n=p-t.scrollHeight),n<0&&(n=0),t.style.top=n+"px",t.style.maxHeight="100vh"}}clingPos(e,t,r){let i=e.clientWidth||e.offsetWidth,s=e.clientHeight||e.offsetHeight;const n=e.getBoundingClientRect();let a,o,p=this.con&&this.con.classList.contains("search-jumper-showall"),d=window.innerWidth||document.documentElement.clientWidth,u=window.innerHeight||document.documentElement.clientHeight;if(this.tips.style.position="",t.style.height="",!e||/^(body|html)$/i.test(e.nodeName))this.tips.style.transition="none",this.tips.style.position="fixed",t.style.right="",t.style.bottom="",t.style.left=(d-t.clientWidth)/2+"px",t.style.top="min(11%,110px)";else if(p)a=n.x+i/2,o=n.y+s/2,a-=t.clientWidth/2-this.con.scrollLeft,o+=this.con.scrollTop,o>u/2?o-=t.clientHeight+s/2+10:o+=s/2+10,t.style.right="",t.style.bottom="",t.style.left=a+"px",t.style.top=o+"px";else if(this.funcKeyCall){let m=window.pageYOffset||document.documentElement.scrollTop||_(document).scrollTop,h=window.pageXOffset||document.documentElement.scrollLeft||_(document).scrollLeft;a=n.x+i/2-this.con.scrollLeft+h,o=n.y+s/2-this.con.scrollTop+m,a-=t.clientWidth/2;let f=e.getBoundingClientRect().top;f>u/2?(f<t.clientHeight+10&&(t.style.height=f-20+"px"),o-=t.clientHeight+s/2+5):(o+=s/2+5,f+t.clientHeight+s+10>u&&(t.style.height=u-f-s-20+"px")),a<20&&(a=20);let b=d+h-t.clientWidth-30;a>b&&(a=b),t.style.right="",t.style.bottom="",t.style.left=a+"px",t.style.top=o+"px"}else{a=e.offsetLeft+i/2-this.con.scrollLeft-e.parentNode.scrollLeft,o=e.offsetTop+s/2-this.con.scrollTop-e.parentNode.scrollTop;let m=e.offsetParent;for(;m!==null;)a+=m.offsetLeft,o+=m.offsetTop,m=m.offsetParent;o<s?(a-=t.clientWidth/2,o+=t.clientHeight/2,a<5?(a=5,t.style.left="5px",t.style.right="",t.style.bottom=""):a>d-t.clientWidth?(t.style.left="",t.style.right="5px",t.style.bottom=""):(t.style.left=a+"px",t.style.right="",t.style.bottom=""),t.style.top=(r?s:s+20)+"px"):o>u-s-10?(a-=t.clientWidth/2,a<5?(t.style.left="5px",t.style.right="",t.style.top=""):a>d-t.clientWidth?(t.style.left="",t.style.right="5px",t.style.top=""):(t.style.left=a+"px",t.style.right="",t.style.top=""),t.style.bottom=(r?s:s+20)+"px"):a>d-i-10?(t.style.left="",t.style.bottom="",o-=t.clientHeight/2,o<5&&(o=5),t.style.right=(r?i:i+20)+"px",t.style.top=o+"px"):a<i?(t.style.right="",t.style.bottom="",o-=t.clientHeight/2,o<5&&(o=5),t.style.left=(r?i:i+20)+"px",t.style.top=o+"px"):(t.style.right="",t.style.bottom="",t.style.left=a+"px",t.style.top=o+"px")}}tipsPos(e,t){this.tips.innerHTML=ee(t),this.tips.style.pointerEvents="",this.tips.style.display="",this.tips.style.opacity=1,this.clingPos(e,this.tips),clearTimeout(this.hideTips),this.tips.style.transition&&setTimeout(()=>{this.tips.style.transition=""},1);let r=this;[].forEach.call(this.tips.querySelectorAll("iframe"),i=>{let s=i.innerHTML;if(s)if(i.innerHTML=ee(),i.src)i.addEventListener("load",n=>{try{if(!i||!i.parentNode)return;let a=i.contentDocument||i.contentWindow.document,o=a.createElement("div");a.body.appendChild(o),o.outerHTML=ee(s)}catch{}});else try{let n=i.contentDocument||i.contentWindow.document;n.open(),n.write(s),n.close()}catch{}}),[].forEach.call(this.tips.querySelectorAll("img,video"),i=>{i.addEventListener("load",s=>{r.clingPos(e,r.tips)})}),window.markdownit&&(r.md||(r.md=window.markdownit()),[].forEach.call(this.tips.querySelectorAll(".markdown"),i=>{i.innerHTML=ee(r.md.render(i.innerHTML))}))}checkKwFilter(e,t){t.length>600&&(t=t.slice(0,500)+t.slice(t.length-10));let r=e.match(/^@{(.*?)}/);if(r){if(!B)return!1;let n=r[1];if(![].some.call(ni(n,document),o=>o===B))return!1;e=e.replace(r[0],"")}let i,s=e.match(/^\/(.*)\/(\w*)$/);return s?i=new RegExp(s[1],s[2]):i=new RegExp(e,"i"),i.test(t||"")}async createType(e){let t=this,r=e.type,i=e.icon,s=e.selectTxt,n=e.selectImg,a=e.selectAudio,o=e.selectVideo,p=e.selectLink,d=e.selectPage,u=e.sites,m=!1,h=typeof e.openInNewTab>"u"?c.prefConfig.openInNewTab:e.openInNewTab,f=[],b=document.createElement("span");b.className="search-jumper-type",!c.prefConfig.expandType&&u.length>10&&b.classList.add("not-expand"),e.match==="0"?(b.style.display="none",b.classList.add("notmatch")):e.match&&(new RegExp(e.match).test(ue)==!1?(b.style.display="none",b.classList.add("notmatch")):m=!0),typeof e.description<"u"?b.dataset.title=r+" - "+e.description:b.dataset.title=r,b.dataset.type=r;let S=document.createElement("span"),L=document.createElement("img"),x=document.createElement("b");r.length>=3?(x.innerText=r.trim().substr(0,4),/^[\w \-]+$/.test(x.innerText.substr(0,3))||(x.innerText=x.innerText.substr(0,2))):x.innerText=r,S.appendChild(x),L.style.display="none",b.appendChild(S),S.classList.add("search-jumper-word"),S.classList.add("search-jumper-btn"),S.classList.add("noIcon");let N=/^BM/.test(r)&&e.icon==="bookmark";if(i){S.classList.remove("noIcon");let D=/^[a-z\- ]+$/.test(i);if(L.onload=T=>{L.style.display="",x.innerText="",x.style.display="none",D||S.classList.remove("search-jumper-word")},D){let T=be[i.trim().replace(/ /g,"_")];T==="fail"||!T?(x.className=i.indexOf("fa")===0?i:"fa fa-"+i,this.fontPool.push(x)):(L.src=T,L.style.width="100%",L.style.height="100%",S.appendChild(L))}else{if(/^data:/.test(i))L.src=i;else{let w=c.prefConfig.cacheSwitch&&be[i];w==="fail"||(w?L.src=w:(L.src=i,!be[i]&&!N&&Je.push(L)))}S.appendChild(L)}}b.addEventListener("mouseleave",D=>{t.listArrow.style.cssText="",t.dockerScaleBtns.forEach(T=>{T.style.setProperty("--scale",1)})});let W=[],I=D=>{switch(c.prefConfig.batchOpenConfirm){case 1:window.confirm(M("batchOpenConfirm"))&&t.batchOpen(W,D);break;case 2:t.batchOpen(W,D);break;default:(b.classList.contains("search-jumper-open")||D.shiftKey||D.altKey||D.ctrlKey||D.metaKey||window.confirm(M("batchOpenConfirm")))&&t.batchOpen(W,D);break}};if(c.prefConfig.shortcut&&e.shortcut&&!b.classList.contains("notmatch")){let D=e.shortcut.replace("Key","").replace("Digit","").toUpperCase();D.length==1&&(b.dataset.title+=` (${D})`),document.addEventListener("keydown",T=>{if(!(c.prefConfig.shortcut==2&&!ae)&&T.target.id!=="searchJumperInput"&&!(!e.ctrl==T.ctrlKey||!e.alt==T.altKey||!e.shift==T.shiftKey||!e.meta==T.metaKey)&&!(!c.prefConfig.enableInInput&&!e.ctrl&&!e.alt&&!e.shift&&!e.meta&&Ct(document))){var w=(T.key||String.fromCharCode(T.keyCode)).toLowerCase();(e.shortcut==T.code||e.shortcut==w)&&(I(T),T.stopPropagation())}})}let H=0,V=this.scale*40,F=(D,T)=>{T?(D.style.display="",b.children.length>2&&b.insertBefore(D,b.children[2])):(D.style.display="none",t.searchJumperExpand.parentNode==b?b.insertBefore(D,t.searchJumperExpand):b.appendChild(D))},y=D=>{if(D){if(D.button===2)return I(D),!1;if(D.button===0&&(D.shiftKey||D.altKey||D.ctrlKey))return!1}if(t.funcKeyCall)return t.showAllSites(),!1;let T=t.con.classList.contains("search-jumper-left")||t.con.classList.contains("search-jumper-right");if(t.preList&&(t.preList.style.visibility="hidden",t.listArrow.style.cssText=""),b.classList.remove("search-jumper-move"),b.classList.contains("search-jumper-open"))c.prefConfig.minSizeMode&&t.bar.classList.add("minSizeModeClose"),b.classList.remove("search-jumper-open"),T?(b.style.height=V+"px",b.style.width=""):(b.style.height="",b.style.width=V+"px"),b.style.flexWrap="",c.prefConfig.disableTypeOpen&&(te.style.visibility="hidden");else{t.recoveHistory(),b.classList.add("search-jumper-open"),c.prefConfig.minSizeMode&&t.bar.classList.remove("minSizeModeClose");let w=!1;B&&(w=Di(B));let g=B&&(B.href||B.src),C=Xe();H=0,f.forEach((J,R)=>{let U=u[R],ce=!0;if(U.kwFilter){let fe;J.dataset.link?fe=g||C:fe=J.dataset.txt?C||B&&B.innerText||"":g||C||location.href,ce=t.checkKwFilter(U.kwFilter,fe)}ce&&J.dataset.paste?(ce=w,F(J,ce)):U.kwFilter&&F(J,ce);let oe=J.querySelector("img");J.style.display!="none"&&H++,oe&&!oe.src&&oe.dataset.src&&(oe.src=oe.dataset.src,delete oe.dataset.src)}),H>(c.prefConfig.expandTypeLength||12)&&!c.prefConfig.expandType&&(b.classList.add("not-expand"),b.appendChild(t.searchJumperExpand));let E=Math.max(b.scrollWidth,b.scrollHeight)+5+"px";c.prefConfig.disableTypeOpen&&(E=V+"px",D&&t.listPos(b.children[0],te)),T?(b.style.height=E,b.style.width=""):(b.style.width=E,b.style.height=""),setTimeout(()=>{b.classList.contains("search-jumper-open")&&(b.style.flexWrap="nowrap",b.classList.add("search-jumper-move"))},c.prefConfig.typeOpenTime),Se.forEach(J=>{b!=J&&(J.classList.remove("search-jumper-open"),J.style.width=V+"px",J.style.height=V+"px",J.style.flexWrap="")})}c.prefConfig.disableTypeOpen||setTimeout(()=>{t.checkScroll()},c.prefConfig.typeOpenTime)},j=!1,A,P,$=D=>{document.removeEventListener("mouseup",$),document.removeEventListener("mousemove",Z),j||y(D),j=!1},Z=D=>{j?(t.bar.style.left=P.x+D.clientX-A.x+"px",t.bar.style.top=P.y+D.clientY-A.y+"px"):(t.tips.style.opacity=0,j=!0,A={x:D.clientX,y:D.clientY},P={x:parseInt(t.bar.style.left),y:parseInt(t.bar.style.top)})};S.onmouseup=function(D){if(D&&t.funcKeyCall&&D.button===0&&!(D.shiftKey||D.altKey||D.ctrlKey)){j=!1,D.preventDefault&&D.preventDefault(),document.addEventListener("mouseup",$),document.addEventListener("mousemove",Z);return}y(D)},S.oncontextmenu=function(D){D.preventDefault()},S.addEventListener("click",D=>(t.batchOpen(W,D),!1),!1),S.addEventListener("dblclick",D=>{D.stopPropagation(),D.preventDefault()},!0);let pe,te,v=window.screen.availWidth||window.innerWidth||document.documentElement.clientWidth,z=window.screen.availHeight||window.innerHeight||document.documentElement.clientHeight,G=!Wt||v>600&&z>600;b.addEventListener("sitelist",async D=>{b.appendChild(te),await t.listPos(D.detail.bind,te),te.style.display="block"},!1),S.addEventListener("mouseenter",D=>{if(!j&&(!t.funcKeyCall&&c.prefConfig.showSiteLists&&(c.prefConfig.alwaysShowSiteLists||!b.classList.contains("search-jumper-open"))?(b.appendChild(te),t.listPos(b.children[0],te)):G&&t.tipsPos(S,b.dataset.title),c.prefConfig.overOpen)){if(b.classList.contains("search-jumper-open"))return;clearTimeout(pe),pe=setTimeout(()=>{y(D)},500)}},!1),S.addEventListener("mouseleave",D=>{t.tips.style.opacity=0,c.prefConfig.overOpen&&clearTimeout(pe)},!1);let O=!1,ie=u&&u.length>200;b.dataset.id=t.siteIndex,t.stopInput=!1;async function re(D,T){if(!D.name)return;let w=await t.createSiteBtn(ie||c.prefConfig.noIcons?"0":D.icon,D,h,N,e);w&&(w.classList.contains("notmatch")||H++,w.dataset.type=r,w.dataset.id=t.siteIndex,t.siteIndex++,t.allSiteBtns.push([w,D]),b.appendChild(w),f.push(w),!D.nobatch&&D.match!=="0"&&W.push(D.name),!O&&!ae&&(w.dataset.current||m)&&!b.classList.contains("notmatch")&&(O=!0,w.dataset.current&&(c.prefConfig.showCurrent||(w.style.display="none"),t.setCurrentSite(D,w)),t.currentType=b))}try{for(let[D,T]of u.entries())await re(T,D),D%100===99&&await $e(1)}catch{for(let T=0;T<u.length;T++)re(u[T],T);await $e(1)}if(c.prefConfig.sortSite&&b.children.length>1){f.sort((T,w)=>{let g=Pe[T.dataset.name]||0;return(Pe[w.dataset.name]||0)-g});let D=!1;for(let T=f.length-1;T>=0;T--){let w=f[T],g=Pe[w.dataset.name]||0;if(T==f.length-1)g>0&&(D=!0,Pe[w.dataset.name]=0);else{let C=Pe[f[T+1].dataset.name]||0;g-C>10&&(D=!0,Pe[w.dataset.name]=C+10)}b.insertBefore(w,b.children[1])}D&&K.setItem("sortSiteNames",Pe)}if(f.forEach(D=>{D.classList.contains("notmatch")&&b.appendChild(D)}),te=await t.createList(f,b,W),O){if(c.prefConfig.currentTypeFirst?t.bar.insertBefore(b,t.bar.children[0]):t.bar.insertBefore(b,t.bar.children[t.bar.children.length-1]),!c.prefConfig.disableAutoOpen&&!c.prefConfig.disableTypeOpen){b.classList.add("search-jumper-open"),b.classList.add("search-jumper-move"),H>(c.prefConfig.expandTypeLength||12)&&!c.prefConfig.expandType&&(b.classList.add("not-expand"),b.appendChild(t.searchJumperExpand));let D=-1,T=[];if(document.readyState!=="complete"){D=3;let w=g=>{document.readyState==="complete"&&(document.removeEventListener("readystatechange",w),window.removeEventListener("load",w),T.forEach(C=>{C&&!C.src&&C.dataset.src&&(C.src=C.dataset.src,delete C.dataset.src)}),T=[])};document.addEventListener("readystatechange",w),window.addEventListener("load",w)}f.forEach((w,g)=>{let C=w.querySelector("img"),E=u[g];if(E&&Oe&&E.kwFilter&&(t.checkKwFilter(E.kwFilter,Oe)?w.style.display="":(w.style.display="none",t.searchJumperExpand.parentNode==b?b.insertBefore(w,t.searchJumperExpand):b.appendChild(w))),w.style.display!="none"&&C&&!C.src&&C.dataset.src){if(D>=0&&!/^data/.test(C.dataset.src))if(D!==0)D--;else{T.push(C);return}C.src=C.dataset.src,delete C.dataset.src}})}}else t.historyTypeEle||kt==r&&(t.historyTypeEle=b),t.bar.insertBefore(b,t.bar.children[t.bar.children.length-1]);return b.style.width=b.scrollHeight+"px",b.style.height=b.scrollHeight+"px",te.style.display="none",b.appendChild(te),s&&n&&a&&o&&p&&d?b.classList.add("search-jumper-targetAll"):(s&&b.classList.add("search-jumper-needInPage"),n&&b.classList.add("search-jumper-targetImg"),a&&b.classList.add("search-jumper-targetAudio"),o&&b.classList.add("search-jumper-targetVideo"),p&&b.classList.add("search-jumper-targetLink"),d&&b.classList.add("search-jumper-targetPage")),Se.push(b),b}async openSiteBtn(e,t,r=!1){await this.siteSetUrl(e);let i=e.dataset.isPage;t||(t="_blank"),i&&e.setAttribute("target",t),i&&t=="_blank"&&e.href?ge(e.href,{active:r,insert:!0}):e.click(),e.setAttribute("target",e.dataset.target==1?"_blank":"_self")}async batchOpen(e,t,r){let i=this;if(i.batchOpening=!0,i.customInput=!1,t.altKey&&t.shiftKey){let s=i.getTargetSitesByName(e),n=window.innerWidth||document.documentElement.clientWidth,a="<title>SearchJumper Multi</title><style>body{background: black; margin: 0;}iframe{box-sizing: border-box;padding: 5px}</style>",o=window.open("","_blank"),p=1;for(let d of s)if(d.dataset.isPage){if(await i.siteSetUrl(d),i.stopInput)return;if(!d.href)continue;let u=document.createElement("iframe");u.width=s.length<=2||n<=1280?"50%":"33%",u.height="100%",u.frameBorder="0",u.sandbox="allow-same-origin allow-scripts allow-popups allow-forms",u.id="searchJumper"+p++,u.style.display="none",a+=u.outerHTML,Be({method:"GET",url:d.href,headers:{referer:d.href,origin:d.href,"User-Agent":navigator.userAgent},onload:function(m){let h=o.document.querySelector("iframe#"+u.id),f=()=>{let b=h.contentDocument||h.contentWindow&&h.contentWindow.document;if(b)try{h.style.display="",h.src=d.href;let S=`<base href="${d.href.replace(/[^\/]*$/,"")}" />`,L=m.response.indexOf("<head")!==-1?m.response.replace(/(\<head.*?\>)/,"$1"+S):S+m.response;b.write(L)}catch{}else setTimeout(()=>{f()},500)};h&&f()},onerror:function(m){he(m)},ontimeout:function(m){he(m)}})}o.document.write(a),o.document.close()}else if((t.ctrlKey||t.metaKey)&&t.shiftKey){let s=i.getTargetSitesByName(e);for(let n of s){if(await i.siteSetUrl(n),i.stopInput)return;if(n.dataset.isPage&&n.href){let a={};B&&(a={src:B.src||B.href||"",title:B.title||B.alt}),e=e.filter(o=>o!==n.dataset.name),K.setItem("lastSign",{target:a,sites:e}),setTimeout(()=>{ge(n.href,{incognito:!0})},300),setTimeout(()=>{K.setItem("lastSign",!1)},2e3);break}}}else if(t.altKey){let s=i.getTargetSitesByName(e),n=[];for(let m of s)if(m.dataset.isPage){if(await i.siteSetUrl(m),i.stopInput)return;if(!m.href)continue;n.push(m.href)}let a=window.screen.availWidth||window.innerWidth||document.documentElement.clientWidth,o=window.screen.availHeight||window.innerHeight||document.documentElement.clientHeight,p=parseInt(a/800);p>n.length&&(p=n.length);let d=parseInt(a/p),u=o/(parseInt((n.length-1)/p)+1)-65;for(let m=0;m<n.length;m++){let h=m%p*d,f=parseInt(m/p)*(u+70);window.open(n[m]+"#searchJumperMin","_blank",`width=${d-10}, height=${u}, location=0, resizable=1, status=0, toolbar=0, menubar=0, scrollbars=0, left=${h}, top=${f}`)}}else if(t.shiftKey){let s=i.getTargetSitesByName(e);for(let n of s){if(await i.siteSetUrl(n),i.stopInput)return;if(n.dataset.isPage&&n.href){let a={};B&&(a={src:B.src||B.href||"",title:B.title||B.alt}),e=e.filter(o=>o!==n.dataset.name),K.setItem("lastSign",{target:a,sites:e}),window.open(n.href,"_blank"),setTimeout(()=>{K.setItem("lastSign",!1)},2e3);break}}}else if(t.ctrlKey||t.metaKey){let s=i.getTargetSitesByName(e).reverse();for(let n of s){if(await i.siteSetUrl(n),n.dataset.isPage&&n.href){ge(n.href,{active:!1,insert:!0});continue}if(i.stopInput)return;n.click()}}else t.button===2&&i.getTargetSitesByName(e).reverse().forEach(n=>{n.dataset.current||i.openSiteBtn(n,"_blank",!!r)});i.batchOpening=!1}async siteSetUrl(e,t){return new Promise(r=>{let i=n=>{e.removeEventListener("actionOver",i),r(!0)};e.addEventListener("actionOver",i);let s=new PointerEvent("mousedown",t);e.dispatchEvent(s)})}getTargetSitesByName(e,t){let r=this,i=[];return e.forEach(s=>{for(let n=0;n<r.allSiteBtns.length;n++){let a=r.allSiteBtns[n][0];if(a.dataset.name==s){if(!t&&a.dataset.pointer){if(a.dataset.oriName){let o=r.getTargetSitesByName([a.dataset.oriName],!0);if(o.length){i.push(...o);break}}}else i.push(a);break}}}),i}async submitAction(e){if(e=e.slice(),document.readyState!=="complete"&&document.readyState!=="interactive"){await $e(300),this.submitAction(e);return}let t,r,i=!1,s=this,n=!1,a=0,o=[],p=!1,d=[],u=await K.getItem("copyStore");u&&(d=JSON.parse(u));let m=async(h,f)=>{let b=!0;if(h[0]==="sleep"||h[0]==="@sleep")await $e(h[1]),he(`sleep ${h[1]}`);else if(h[0]==="@click")i=!0,await Ui(h[1],f)||(b=!1);else if(h[0]==="@dblclick")i=!0,await wr(h[1],f)||(b=!1);else if(h[0]==="@rclick")i=!0,await Sr(h[1],f)||(b=!1);else if(h[1]==="click"&&h[0].indexOf("@")===0)i=!0,await Ui(h[0].substr(1),f)||(b=!1);else if(h[0]==="@copy"){let S=await Lt(h[1],f);S&&S!==!0&&(d.push(S.innerText),ct||(b=!1))}else if(h[0]==="@call"){let S=s.getTargetSitesByName([h[1]])[0];if(S)Nt=Nt||Xe()||Ee,await s.siteSetUrl(S),S.click();else{let L=window[h[1]]||new ai('"use strict";'+h[1]);L&&await L()}}else if(h[0]==="@open"){let S=await Rt(h[1]);p?ge(S.href):(p=!0,setTimeout(()=>{location.href=S.href},50))}else if(h[0]!=="@reload")if(h[0]==="@wait")h[1].indexOf("!")===0?await vr(h[1].slice(1)):await Rt(h[1]);else{let S=h[1];if(Oe||(Oe=S),S.indexOf("%input{")!==-1){let x=await s.showCustomInputWindow(S);if(x)S=x;else return K.setListItem("inPagePostParams",location.hostname,""),!0}await Fi(h[0],S,f)||(b=!1),h[0]!=="@"&&(r=bt(h[0]))}return b};for(let h of e){if(h[0]==="@loopStart")n=!0,o=[],a=parseInt(h[1])||1;else if(h[0]==="@loopEnd")for(n=!1;a-- >0;){let f=!1,b=0;for(;!f;){f=!0;for(let S of o)await m(S,b)||(f=!1);b++}}else n?o.push(h):await m(h);if(Ge&&(Ge.shift(),Ge&&Ge.length?(K.setListItem("inPagePostParams",location.hostname,Ge),K.setItem("copyStore",JSON.stringify(d))):(Re(d.join(`
`)),K.setListItem("inPagePostParams",location.hostname,""),K.setItem("copyStore","")),h[0]==="@reload")){location.reload(!!h[1]);return}}if(n)for(n=!1;a-- >0;){let h=!1,f=0;for(;!h;){h=!0;for(let b of o)await m(b,f)||(h=!1);f++}}if(!i&&r){for(t=r.parentNode;t.nodeName.toUpperCase()!="FORM"&&(t=t.parentNode,!!t););if(t){let h=t.querySelector("[type=submit]");h?h.click():t.submit()}else xr()}}getCloneData(e){for(let t=0;t<c.sitesConfig.length;t++){let r=c.sitesConfig[t];for(let i=0;i<r.sites.length;i++){let s=r.sites[i];if(!/^\[/.test(s.url)&&s.name==e)return s}}return null}async createSiteBtn(e,t,r,i,s,n){let a=this,o=document.createElement("a");o.setAttribute("ref","noopener noreferrer"),o.setAttribute("referrerPolicy","no-referrer");let p=t.name,d=t.match,u=!1,m,h=!i&&/^\[/.test(t.url),f=t.description,b=t.shortcut;if(typeof t.openInNewTab<"u"&&(r=t.openInNewTab),h){o.dataset.pointer=!0;let g=JSON.parse(t.url);if(g.length===1){o.dataset.clone=!0;let C=this.getCloneData(g[0]);C&&(o.dataset.oriName=C.name,t=C,t.icon&&e!=="0"&&(e=t.icon),t.description&&(f=t.description))}}/^d:/.test(t.url)?(o.setAttribute("download",""),t.url=t.url.replace(/^d:/,"")):/^showTips:/.test(t.url)&&(u=!0,o.dataset.showTips=!0),/^paste:/.test(t.url)&&(o.dataset.paste=!0);let S=/^(https?|ftp):/.test(t.url);S&&(o.dataset.isPage=S),o.className="search-jumper-btn",typeof f<"u"&&(o.title=f),o.dataset.name=p,o.classList.add("search-jumper-word"),o.dataset.inPagePost=t.url.indexOf("#p{")!=-1?"t":"f";let L=o.dataset.inPagePost==="t";if(d==="0")o.style.display="none",o.classList.add("notmatch");else if(!i&&(!ae||t.hideNotMatch)&&window.top==window.self){if(d){let g,C=d.match(/^\/(.*)\/(\w*)$/);C?g=new RegExp(C[1],C[2]):g=new RegExp(d,"i"),g.test(ue)&&(o.dataset.current=!0)}else if(!h&&location.hostname&&t.url.indexOf(location.hostname)!=-1){this.inSiteMatch||(this.inSiteMatch=/site(%3A|:)(.+?)[\s%]/);let g=t.url.match(this.inSiteMatch);if(g)ue.indexOf(g[2])!=-1&&t.url.replace(g[0],"").indexOf(location.hostname)!=-1&&(o.dataset.current=!0);else if(this.pathMatch||(this.pathMatch=new RegExp("^https?://"+location.host+location.pathname+"?([\\?#].*|[%:#]p{|$)")),this.pathMatch.test(t.url))if(this.postMatch||(this.postMatch=/[#:%]p{/),this.postMatch.test(t.url))o.dataset.current=!0;else{this.paramMatch||(this.paramMatch=/[^\/\?&]+(?=%[stb])/g);let C=t.url.match(this.paramMatch);C?(C=C.join(".*"),new RegExp(C).test(ue)&&(o.dataset.current=!0)):o.dataset.current=!0}else t.url.indexOf("http")===0&&t.url.indexOf("?")===-1&&(this.keywordMatch||(this.keywordMatch=/%[stb][a-z]?\b/g),new RegExp(t.url.replace(/^https?/,"").replace(/[#%]\w+{.*/,"").replace(/\./g,"\\.").replace(this.keywordMatch,".*")).test(ue)&&(o.dataset.current=!0))}o.dataset.current||t.hideNotMatch&&(o.style.display="none",o.classList.add("notmatch"))}let x=document.createElement("span");!i&&p.length>=3?(x.innerText=p.substr(0,4),/^[\w \-]+$/.test(x.innerText.substr(0,3))||(x.innerText=x.innerText.substr(0,2))):x.innerText=p,o.appendChild(x);let N=document.createElement("img");if(N.style.display="none",o.appendChild(N),!n&&c.prefConfig.shortcut&&b&&!o.dataset.clone&&!o.classList.contains("notmatch")){let g=document.createElement("div"),C=b.replace("Key","").replace("Digit","").toUpperCase();C.length==1&&(g.innerText=C,o.appendChild(g)),document.addEventListener("keydown",async E=>{if(!(c.prefConfig.shortcut==2&&!ae)&&E.target.id!=="searchJumperInput"&&!(!a.hideTimeout&&(!t.ctrl==E.ctrlKey||!t.alt==E.altKey||!t.shift==E.shiftKey||!t.meta==E.metaKey))&&a.bar.contains(o)&&!(!c.prefConfig.enableInInput&&!t.ctrl&&!t.alt&&!t.shift&&!t.meta&&Ct(document))){var J=(E.key||String.fromCharCode(E.keyCode)).toLowerCase();(b==E.code||b==J)&&(E.stopPropagation(),ui&&(B=ui),u?o.dispatchEvent(new CustomEvent("showTips")):await pe()!==!1&&!a.customInput&&o.click())}})}let W;if(e=="0"||(e?W=e:!i&&S?W=t.url.replace(/\?.*/,"").replace(/^(https?:\/\/[^\/]*\/)[\s\S]*$/,"$1favicon.ico"):/^showTips:https?:\/\//.test(t.url)&&(W=t.url.replace(/\?.*/,"").replace(/^showTips:(https?:\/\/[^\/]*\/)[\s\S]*$/,"$1favicon.ico"))),W)if(N.onload=C=>{o.classList.remove("search-jumper-word"),x.parentNode&&!c.prefConfig.showEngineWords&&x.parentNode.removeChild(x),N.style.display=""},/^data:/.test(W))N.dataset.src=W;else{let C=c.prefConfig.cacheSwitch&&be[W];C==="fail"?o.dataset.current&&W.indexOf(location.host)!=-1&&(N.dataset.src=W,be[W]="",i||setTimeout(()=>{mi(N)},0)):C?N.dataset.src=C:(N.dataset.src=W,!i&&!be[W]&&Je.push(N))}S&&(r?(o.setAttribute("target","_blank"),o.dataset.target=1):o.setAttribute("target","_self"));let I=t.url,H=ft.test(I);H&&(o.dataset.txt=!0),/%[tb]\b/i.test(I)&&(o.dataset.link=!0);let V,F=async g=>{a.customInput=!1,I=t.url,V="";let C=g||a.searchJumperInputKeyWords.value||a.tileInput.value||We();!C&&!mt&&!a.bar.classList.contains("search-jumper-isTargetLink")&&(C=Xe()),C&&!g&&(C!=Ee&&(a.keywordIndex=0,S&&(Ee=C,K.setItem("cacheKeywords",C))),V=C);let E;(L||/^c(opy)?:|^paste:/.test(I))&&(I.indexOf("%input{")!==-1&&(I=await new Promise(X=>{a.showCustomInputWindow(I,Y=>{X(Y)})}),o.dataset.url=""),E=I.match(/#p{([\s\S]*[^\\])}/));let J=location.host,R=location.href,U=(X,Y,q,le)=>{if(X.indexOf(Y+"[")!==-1){let ve=X.match(Ut(Y,"","\\[(.*?)(\\|(.+))?\\]")),de;if(ve){switch(ve[3]?de=q.split(ve[3]):(de=q.split(/[\n\r]/),de.length===1&&(de=q.split(" "))),a.keywordIndex||(a.keywordIndex=0),ve[1]){case"all":V=de.join(`
`);break;case"":q=de[a.keywordIndex],++a.keywordIndex>=de.length&&(a.keywordIndex=0);break;case"-1":--a.keywordIndex<0&&(a.keywordIndex=de.length-1),q=de[a.keywordIndex];break;default:q=de[parseInt(ve[1])||0];break}X=X.replace(ve[0],Y)}}return gi(X,Y,q,le)},ce=!/^showTips:h/i.test(I)&&/^c(opy)?:|[#:%]P{|^javascript:|^showTips:/i.test(I),oe="",fe="",ne="",it="",Ii="",ji=X=>{let Y=X;if(Y=U(Y,"%su",oe),Y=U(Y,"%sl",fe),Y=U(Y,"%sr",ne),Y=U(Y,"%S",Ee||ne),Y=U(Y,"%ss",it),Y=U(Y,"%st",Ii),Y=U(Y,"%se",escape?escape(ne):ne),Y=U(Y,"%s",ne,q=>ce?q:encodeURIComponent(q)),/%bd\b/.test(Y))try{let q=atob(ne);Y=U(Y,"%bd",q)}catch(q){console.log(q)}if(/%be\b/.test(Y))try{let q=btoa(ne);Y=U(Y,"%be",q)}catch(q){console.log(q)}return Y},Hr=X=>{let Y=X.match(/%element{(.*?)}(\.prop\((.*?)\))?/),q=0;for(;Y&&!(q++>100);){let ve=Y[1],de=Y[3],me="";if(ve){let rt=bt(ve);rt&&(de?me=rt.getAttribute(de)||rt[de]:me=rt.innerText)}else try{let rt=window.getSelection(),st=document.createElement("div");for(let we=0,je=rt.rangeCount;we<je;++we)st.appendChild(rt.getRangeAt(we).cloneContents());if([].forEach.call(st.querySelectorAll("style,script,svg,canvas"),we=>{let je=document.createTextNode("");we.parentNode.replaceChild(je,we)}),document.body.appendChild(st),de)for(let we=0;we<st.childNodes.length;we++){let je=st.childNodes[we];je.nodeType==3?(me+=je.nodeValue,me+=`
`):je.nodeType==1&&(me+=je.getAttribute(de)||je[de]||"",me+=`
...
`)),document.body.removeChild(st)}catch(rt){console.error(rt)}X=U(X,Y[0],ce?me:encodeURIComponent(me)),Y=X.match(/%element{(.*?)}(\.prop\((.*?)\))?/)}Y=X.match(/%date({(.*?)})?/),q=0;let le=new Date().getTime();for(;Y&&!(q++>100);){let ve=Y[2],de=le;if(ve){ve=ve.replace(/\s/g,"");let me=ve.match(/(\D*)?(\d+)/);for(;me;){switch(me[1]){case"-":de-=parseInt(me[2]);break;case"*":de*=parseInt(me[2]);break;case"/":me[2]&&me[2]!="0"&&(de=parseInt(de/parseInt(me[2])));break;default:de+=parseInt(me[2]);break}ve=ve.replace(me[0],""),me=ve.match(/(\D*)?(\d+)/)}}else de=le;X=X.replace(Y[0],de),Y=X.match(/%date({(.*?)})?/)}return X};if(!o.dataset.url){let X=I;L&&(X=X.replace(E[0],"")),o.dataset.url=X.replace(/%e\b/g,document.characterSet).replace(/%c\b/g,Wt?"mobile":"pc")}let xe="",vt="",Ei=V||document.title,Qe="",se=Hr(o.dataset.url);if(B&&B.nodeName){if(xe=B.href||B.parentNode&&B.parentNode.href||"",vt=xe||B.parentNode&&B.parentNode.parentNode&&B.parentNode.parentNode.href||"",(s.selectImg||s.selectAudio||s.selectVideo)&&B.src&&(xe=B.src),B.nodeName.toUpperCase()=="VIDEO"||B.nodeName.toUpperCase()=="AUDIO"){if(!xe){let X=B.querySelector("source");X&&(xe=X.src)}xe&&(xe=xe.replace(/^blob:/,""))}Ei=B.title||B.alt||document.title,B.nodeName.toUpperCase()=="IMG"&&/%i\b/.test(I)?B.src&&(/^data/.test(B.src)?Qe=B.src:(a.tipsPos(o,"<span class='loader'></span><font>Loading...</font>"),Qe=await qi(B)),se=se.replace(/%i\b/g,Qe)):(B.nodeName.toUpperCase()=="A"||B.parentNode&&B.parentNode.nodeName.toUpperCase()=="A")&&H&&!C&&B.textContent.trim()&&(C=B.textContent.trim())}for(;se.indexOf("%template{")!==-1;){let X=se.match(/%template{(.*?[^\\])}/);if(!X)return!1;let Y=X[1];c.prefConfig.templateData||(c.prefConfig.templateData={});let q=c.prefConfig.templateData[Y];if(!q){if(a.stopInput)return!1;if(q=window.prompt(M("template",Y))||"",q)c.prefConfig.templateData[Y]=q,K.setItem("searchData",c);else return!1}se=se.replace(X[0],q)}for(;se.indexOf("%input{")!==-1;){let X=se.match(/%input{(.*?[^\\])}/);if(!X||(a.customInput=!0,a.stopInput))return!1;if(a.batchOpening){let Y;if(X[1].indexOf('"')===0&&X[1].indexOf('","')!==-1?Y=X[1].substr(1,X[1].length-2).split('","'):Y=X[1].split(","),Y.length===2?Y=window.prompt(Y[0],Y[1]):Y=window.prompt(X[1]),Y===null)return!1;se=se.replace(X[0],Y)}else break}xe&&(xe=xe.replace(/%(\w{2})/g,(X,Y)=>`%${Y.toUpperCase()}`)),vt&&(vt=vt.replace(/%(\w{2})/g,(X,Y)=>`%${Y.toUpperCase()}`));let wt=xe.replace(/^https?:\/\//i,"");C||(C=ae&&Ee);try{if(typeof navigator.clipboard.readText<"u"&&(!C&&H&&(C=await navigator.clipboard.readText(),C&&!g&&(V=C)),!Qe&&/%i\b/.test(I))){if((await navigator.permissions.query({name:"clipboard-read"})).state!=="denied"){const Y=await navigator.clipboard.read();for(const q of Y)if(q.types.includes("image/png")){const le=await q.getType("image/png");Qe=await new Promise(ve=>{const de=new FileReader;de.onload=function(me){ve(me.target&&me.target.result)},de.readAsDataURL(le)}),Qe&&(se=se.replace(/%i\b/g,Qe))}}if(!Qe){a.customInput=!0;let Y=window.prompt(M("targetUrl"),"https://www.google.com/favicon.ico");if(Y)a.tipsPos(o,"<span class='loader'></span><font>Loading...</font>"),Qe=await Ft(Y);else return!1}}}catch(X){console.error(X.message)}if(!C&&H){if(a.customInput=!0,a.con.classList.contains("search-jumper-showall")||a.inInput||u||a.stopInput)return!1;let X=window.prompt(M("keywords"));if(X===null)return!1;Oe=X,setTimeout(()=>{Oe=""},1),C=X,ne=C,oe=ne.toUpperCase(),fe=ne.toLowerCase(),it=ye.tc2sc?ye.tc2sc(ne):ne,Ii=ye.sc2tc?ye.sc2tc(ne):ne,ce||(C=encodeURIComponent(C)),se=ji(se)}else C&&!oe&&!fe&&!ne&&(ne=C,oe=ne.toUpperCase(),fe=ne.toLowerCase(),it=ye.tc2sc?ye.tc2sc(ne):ne,Ii=ye.sc2tc?ye.sc2tc(ne):ne,ce||(C=encodeURIComponent(C)));if(xe===""){let X=We()||a.searchJumperInputKeyWords.value||a.tileInput.value;if(!H&&X&&/^(http|ftp)/i.test(X))xe=X,xe=xe.replace(/%(\w{2})/g,(Y,q)=>`%${q.toUpperCase()}`);else{let Y=!1,q=()=>!(a.stopInput||u||(Y===!1&&(Y=window.prompt(M("targetUrl"),"https://www.google.com/favicon.ico"),Y&&(Y=Y.replace(/%(\w{2})/g,(le,ve)=>`%${ve.toUpperCase()}`),B={src:Y})),Y===null));if(/%t\b/.test(se)){if(a.customInput=!0,q()===!1)return!1;se=U(se,"%t",Y)}if(/%T\b/.test(se)){if(a.customInput=!0,q()===!1)return!1;se=se.replace(/%T\b/g,encodeURIComponent(Y))}if(/%τ\b/.test(se)){if(a.customInput=!0,q()===!1)return!1;se=se.replace(/%τ\b/g,encodeURIComponent(encodeURIComponent(Y)))}if(/%b\b/.test(se)){if(a.customInput=!0,q()===!1)return!1;se=se.replace(/%b\b/g,Y.replace(/^https?:\/\//i,""))}if(/%B\b/.test(se)){if(a.customInput=!0,q()===!1)return!1;se=se.replace(/%B\b/g,encodeURIComponent(Y.replace(/^https?:\/\//i,"")))}if(/%β\b/.test(se)){if(a.customInput=!0,q()===!1)return!1;se=se.replace(/%β\b/g,encodeURIComponent(encodeURIComponent(Y.replace(/^https?:\/\//i,""))))}}}let Li=J;if((vt||xe)&&!o.dataset.link&&(R=vt||xe,Li=R.replace(/^\w+:\/\/([^\/]+).*/,"$1")),L){let X=[],Y=!1;if(E[1].replace(/([^\\])&/g,"$1SJ^PARAM").split("SJ^PARAM").forEach(q=>{if(q=q.trim(),/^loopStart\(\d+\)$/.test(q)){let le=q.match(/loopStart\((.*)\)/);X.push(["@loopStart",le[1]])}else if(q=="loopEnd")X.push(["@loopEnd",""]);else if(q.startsWith("click(")&&q.endsWith(")")){let le=q.slice(6,q.length-1);le&&X.push(["@click",le.replace(/\\([\=&])/g,"$1").trim()])}else if(q.startsWith("dblclick(")&&q.endsWith(")")){let le=q.slice(9,q.length-1);le&&X.push(["@dblclick",le.replace(/\\([\=&])/g,"$1").trim()])}else if(q.startsWith("rclick(")&&q.endsWith(")")){let le=q.slice(7,q.length-1);le&&X.push(["@rclick",le.replace(/\\([\=&])/g,"$1").trim()])}else if(q.startsWith("copy(")&&q.endsWith(")")){let le=q.slice(5,q.length-1);le&&X.push(["@copy",le.replace(/\\([\=&])/g,"$1").trim()])}else if(q.startsWith("call(")&&q.endsWith(")")){let le=q.slice(5,q.length-1);le&&(X.push(["@call",le.replace(/\\([\=&])/g,"$1").trim()]),Y=!0)}else if(q.startsWith("reload(")&&q.endsWith(")")){let le=q.slice(7,q.length-1);X.push(["@reload",le.trim()])}else if(q.startsWith("wait(")&&q.endsWith(")")){let le=q.slice(5,q.length-1);X.push(["@wait",le.replace(/\\([\=&])/g,"$1").trim()])}else if(q.startsWith("open(")&&q.endsWith(")")){let le=q.slice(5,q.length-1);le&&X.push(["@open",le.replace(/\\([\=&])/g,"$1").trim()])}else if(/^sleep\(\d+\)$/.test(q)){let le=q.match(/sleep\((.*)\)/);le&&X.push(["@sleep",le[1]])}else{q=q.replace(/([^\\])\=/g,"$1SJ^PARAM").replace(/\\([\=&])/g,"$1");let le=q.split("SJ^PARAM");if(le.length===2){let ve=le[0],de=ji(le[1].replace(/\\([\=&])/g,"$1").replace(/%e\b/g,document.characterSet).replace(/%i\b/g,Qe).replace(/%c\b/g,Wt?"mobile":"pc").replace(/%U\b/g,encodeURIComponent(R)).replace(/%υ\b/g,encodeURIComponent(encodeURIComponent(R))).replace(/%h\b/g,Li).replace(/%T\b/g,encodeURIComponent(xe)).replace(/%τ\b/g,encodeURIComponent(encodeURIComponent(xe))).replace(/%b\b/g,wt).replace(/%B\b/g,encodeURIComponent(wt)).replace(/%β\b/g,encodeURIComponent(encodeURIComponent(wt))).replace(/%n\b/g,Ei));de=U(de,"%t",xe),de=U(de,"%u",R),X.push([ve,de])}else(q.endsWith(".click()")||q.endsWith(".click"))&&X.push(["@"+q.replace(/\.click(\(\))?$/,""),"click"])}}),Y&&a.updateCacheKeywords(),se===""||se===location.href)return Ge=X,this.submitAction(X),!1;K.setListItem("inPagePostParams",se.replace(/^https?:\/\/([^\/:]+).*/,"$1"),X)}return se=U(se,"%h",Li),se=U(se,"%t",xe),se=U(se,"%u",R),se=ji(se.replace(/%U\b/g,encodeURIComponent(R)).replace(/%υ\b/g,encodeURIComponent(encodeURIComponent(R))).replace(/%T\b/g,encodeURIComponent(xe)).replace(/%τ\b/g,encodeURIComponent(encodeURIComponent(xe))).replace(/%b\b/g,wt).replace(/%B\b/g,encodeURIComponent(wt)).replace(/%β\b/g,encodeURIComponent(encodeURIComponent(wt))).replace(/%n\b/g,Ei)),r&&/^(https?|ftp):/.test(se)?(o.setAttribute("target","_blank"),o.dataset.target=1):o.dataset.target=0,se},y,j=!1,A,P,$,Z,pe=async g=>{if(delete o.href,g||(g={}),A=g.altKey,P=g.ctrlKey,$=g.metaKey,Z=g.shiftKey,!A&&!P&&!$&&!Z&&(g.button==1||g.button==2?(A=!1,P=!0,$=!1,Z=!1):r===2?(A=!1,P=!0,$=!1,Z=!0):r===3?(A=!0,P=!1,$=!1,Z=!1):r===4&&(A=!1,P=!0,$=!1,Z=!1)),u){o.removeAttribute("target"),m&&(/^(https?|ftp):/.test(m)?(y=m,o.href=y,r?o.setAttribute("target","_blank"):o.setAttribute("target","_self")):(/^copy:/.test(m)&&(m=m.replace(/^copy:/,"")),Re(m))),o.dispatchEvent(new Event("actionOver"));return}if(j=!1,y="",y=await F(),/^(https?|ftp):/.test(y)&&g.stopPropagation&&g.stopPropagation(),/^c(opy)?:|^paste:/.test(t.url)||/^javascript:/.test(t.url)||/^\[/.test(t.url)||/[:%]P{/.test(t.url)||t.charset&&t.charset!="utf-8"||/[:%]p{/.test(t.url))(g.button==1||g.button==2)&&(j=!0);else{if(!y){a.stopInput||(a.stopInput=!0,setTimeout(()=>{a.stopInput=!1},1));return}o.href=y}a.customInput&&y&&(j=!0),o.dispatchEvent(new Event("actionOver")),j&&(g.preventDefault&&g.preventDefault(),o.click())},te=()=>{let g=Math.max(c.prefConfig.historyLength,20),C=o.dataset.current;if(!t.hideNotMatch&&!t.kwFilter&&!o.dataset.clone&&!o.dataset.paste&&d!=="0"&&g&&!C&&K.getItem("historySites",E=>{Ve=E||[],Ve=Ve.filter(J=>J&&J!=p),Ve.unshift(p),Ve.length>g&&(Ve=Ve.slice(0,g)),K.setItem("historySites",Ve)}),c.prefConfig.shiftLastUsedType&&!C){let E=o.parentNode;!(E&&(E.classList.contains("search-jumper-targetAll")||E.classList.contains("search-jumper-targetImg")||E.classList.contains("search-jumper-targetAudio")||E.classList.contains("search-jumper-targetVideo")||E.classList.contains("search-jumper-targetLink")||E.classList.contains("search-jumper-targetPage")||E.classList.contains("search-jumper-needInPage")))&&kt!=o.dataset.type&&(kt=o.dataset.type,K.setItem("historyType",kt))}c.prefConfig.sortType&&K.getItem("sortTypeNames",E=>{Le=E||{},Le[o.dataset.type]?Le[o.dataset.type]=Le[o.dataset.type]+1:Le[o.dataset.type]=1,K.setItem("sortTypeNames",Le)}),c.prefConfig.sortSite&&K.getItem("sortSiteNames",E=>{Pe=E||{},Pe[o.dataset.name]?Pe[o.dataset.name]=Pe[o.dataset.name]+1:Pe[o.dataset.name]=1,K.setItem("sortSiteNames",Pe)})},v=(g,C)=>{Re(C);let E=o;g||(a.appendBar(),a.closeOpenType(),a.con.style.display="",a.setFuncKeyCall(!0),window.getSelection().toString()?E=B||o:E=_(document)),a.tipsPos(E,M("copyOver")),clearTimeout(a.hideTips),a.hideTips=setTimeout(()=>{a.tips.style.opacity=="1"&&(a.tips.style.opacity=0)},1500)},z=g=>{if(g&&g.stopPropagation&&g.stopPropagation(),B&&B.focus&&B.focus(),u&&a.waitForShowTips)return D(o,0),g&&g.preventDefault&&g.preventDefault(),!1;if(j=!0,!y)return g&&g.preventDefault&&g.preventDefault(),!1;g||(g={});let C=/^(https?|ftp):/.test(y);if(!a.batchOpening&&!i&&te(),(c.prefConfig.multiline==1||c.prefConfig.multiline==2)&&V&&ft.test(o.dataset.url)&&V.indexOf(`
`)!==-1&&!/^(c|show)/.test(o.dataset.url)&&(c.prefConfig.multiline==1||confirm(M("multiline")))){let J=V.split(`
`);if(J.length>10&&!confirm(M("multilineTooMuch")))return;let R=0,U=o.target;o.target="_blank";let ce=async()=>{y=await F(J[R++]),o.href=y,o.click(),R<J.length?setTimeout(()=>{ce()},c.prefConfig.multilineGap||1e3):o.target=U};return ce(),o.href="",g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation(),!1}if(y.indexOf("%input{")!==-1){a.showCustomInputWindow(y,J=>{y=J,o.href=J,o.click()}),g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation();return}let E=y.match(/^find(\.addto\((.*?)\))?:(.*)/);if(E){g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation();let J=E[2],R=E[3];if(R)J&&c.prefConfig.inPageRule&&J.indexOf("@")!==0&&(J="@"+J),R.indexOf("%input{")!==-1?a.showCustomInputWindow(R,U=>{J?a.addToHighlightGroup(U,J):(a.searchJumperInPageInput.value=U,a.submitInPageWords(),a.waitForHide(0))}):J?a.addToHighlightGroup(R,J):(a.searchJumperInPageInput.value=R,a.submitInPageWords(),a.waitForHide(0));else return!1;return!1}else if(/^javascript:/.test(t.url)){g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation(),ye.targetElement=B,ye.keywords=Xe(),y=y.replace(/^javascript:/,"");try{y=decodeURIComponent(y)}catch{}let J=/^[_a-zA-Z0-9]+$/.test(y)&&ye[y]||new ai(y);return J&&J(),!1}else if(/^c(opy)?:/.test(t.url)){if(g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation(),y)y.indexOf("%input{")!==-1?a.showCustomInputWindow(y,J=>{v(!0,J.replace(/^c(opy)?:/,""))}):v(g.isTrusted,y.replace(/^c(opy)?:/,""));else return!1;return!1}else if(/^paste:/.test(t.url)){let J=!1;if(B&&/INPUT|TEXTAREA/i.test(B.nodeName)&&B.getAttribute("aria-readonly")!="true")J=!0;else{let R=B;for(;R&&(J=R.contentEditable=="true",!(J||R.nodeName.toUpperCase()=="BODY"));)R=R.parentNode}if(J){if(!y)return!1;y=y.replace(/^paste:/,""),y.indexOf("%input{")!==-1?a.showCustomInputWindow(y,R=>{Ot(B,R)}):y?Ot(B,y):typeof navigator.clipboard.readText<"u"&&navigator.clipboard.readText().then(R=>{Ot(B,R)})}}else if(/^\[/.test(t.url)){g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation();let J=JSON.parse(t.url);return a.batchOpen(J,{button:2,altKey:A||g.altKey,ctrlKey:P||g.ctrlKey,shiftKey:Z||g.shiftKey,metaKey:$||g.metaKey},r===1),!1}else if(/[:%]P{/.test(t.url)){if(g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation(),y===!1)return!1;let J=R=>{let U=R.match(/[:%]P{(.*)}/),ce="";if(U)if(R=R.replace(U[0],""),U=U[1],U.charAt(0)==='"'&&U.charAt(U.length-1)==='"')ce=U.substring(1,U.length-1);else{U=new URLSearchParams(U);let oe={};U.forEach((fe,ne)=>{oe[ne]=fe}),ce=JSON.stringify(oe)}Be({method:"POST",url:R,data:ce,onload:oe=>{he(oe)},onerror:oe=>{Ce(M("postError")+(oe.statusText||oe.error))},ontimeout:oe=>{Ce(M("postError")+(oe.statusText||oe.error))}})};return y.indexOf("%input{")!==-1?a.showCustomInputWindow(y,R=>{J(R)}):J(y),!1}else if(t.charset&&t.charset!="utf-8"||/[:%]p{/.test(t.url)){if(y===!1)return!1;let J=t.url.match(/#(j(umpFrom|f)?|from){(.*?)}/),R=U=>(J?(K.setItem("postUrl",[U,t.charset]),J=J[3],J.indexOf("http")!==0&&(J=U.replace(/(:\/\/.*?\/)[\s\S]*/,"$1"+J)),U=J):(K.setItem("postUrl",[U,t.charset]),U=U.replace(/(:\/\/.*?)\/[\s\S]*/,"$1").replace(/[:%]p{[\s\S]*/,"")),U);if(y.indexOf("%input{")!==-1){a.showCustomInputWindow(y,U=>{U=R(U),U&&(o.href=U,o.target==="_blank"?ge(o.href,{active:!0,insert:!0}):location.href=o.href)}),g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation();return}else{if(y=R(y),!y)return;o.href=y}}if(!(Z&&!P&&!$&&!A&&g.isTrusted)){if(/^(chrome|edge|about|extension|moz-extension)/.test(y))return g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation(),P?ge(y,{active:!1,insert:!0}):ge(y,{active:!0,insert:!0,close:o.getAttribute("target")!=="_blank"}),!1;if((A||P||$||Z)&&C){if((P||$)&&Z)ge(y,{incognito:!0});else if(P||$)ge(y,{active:!1,insert:!0});else if(A){if(t.match){let ne=t.match.replace(/\\/g,""),it=ne.match(/\((www)\|([^\)\|]+)/);for(;it;)y=y.replace(it[1],it[2]),ne=ne.replace(it[0],""),it=ne.match(/\(([^\)\|]+)\|([^\)\|]+)/)}let J=window.screen.availWidth||window.innerWidth||document.documentElement.clientWidth,R=window.screen.availHeight||window.innerHeight||document.documentElement.clientHeight,U=c.prefConfig.popupWidth,ce=c.prefConfig.popupHeight,oe=c.prefConfig.popupLeft,fe=c.prefConfig.popupTop;ce?(ce=parseFloat(ce),ce=R/100*ce):ce=Math.max(R/3*2,R-250),U?(U=parseFloat(U),U=J/100*U):U=Math.min(J,650),oe?(oe=parseFloat(oe),oe=J/100*oe-U/2):oe=J-U-30,fe?(fe=parseFloat(fe),fe=R/100*fe-ce/2):fe=(R-ce)/2,a.closePopupWindow(),a.popupWindow=window.open(y+"#searchJumperMin"+(/#p{/.test(t.url)?"Post":""),"_blank",`width=${U}, height=${ce}, location=0, resizable=1, status=0, toolbar=0, menubar=0, scrollbars=0, left=${oe}, top=${fe}`)}else Z&&ge(y,{active:!0,insert:!0});return g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation(),!1}else if(C&&o.getAttribute("target")==="_blank"&&!(A||P||$||Z)&&g.button===0)return ge(y,{active:!0,insert:!0}),g.preventDefault&&g.preventDefault(),g.stopPropagation&&g.stopPropagation(),!1}};o.addEventListener("mousedown",pe,!0),o.addEventListener("mouseup",g=>{g.stopPropagation&&g.stopPropagation()},!0),o.addEventListener("click",z,!0),o.addEventListener("auxclick",g=>{if(j&&g.preventDefault)return g.preventDefault(),!1},!0),o.addEventListener("contextmenu",g=>{if(j&&g.preventDefault)return g.preventDefault(),!1},!0);let G=o.dataset.name;b&&(G+=` (${t.ctrl?"Ctrl + ":""}${t.shift?"Shift + ":""}${t.alt?"Alt + ":""}${t.meta?"Meta + ":""}${b.replace("Key","")})`);let O=!1,ie=!1,re=async(g,C,E)=>{if(a.tipsPos(g,'<span class="loader"></span><font>Loading...</font>'),ie=!1,C)try{C=C.replace(/^showTips:/,""),O=!0;let J=await a.anylizeShowTips(C,o.dataset.name,g);if(O=!1,a.tips.style.opacity==0||a.tips.innerHTML.indexOf('<span class="loader">')!==0){ie=!0;return}Array&&Array.isArray&&Array.isArray(J)&&(m=J[1],J=J[0]),J&&(J!="null"&&J!="No result"&&(J=`<div>${J}</div>`,ie=!0),a.tipsPos(g,J),te(),setTimeout(()=>{a.tips.style.pointerEvents="all"},100))}catch(J){he(J)}},D=async(g,C=1e3)=>{if(!(!g||g.nodeType!==1)&&(a.preList&&(a.preList.style.visibility="hidden",a.listArrow.style.cssText=""),m=null,clearTimeout(a.requestShowTipsTimer),a.waitForShowTips=!1,a.tipsPos(g,G),u)){a.stopInput=!0;let E=await F();a.stopInput=!1,E&&a.lastUrl===E?O?a.tipsPos(g,"<span class='loader'></span><font>Loading...</font>"):re(g,E):(a.waitForShowTips=!0,a.requestShowTipsTimer=setTimeout(async()=>{if(E=E||await F(),!!E){if(E.indexOf("%input{")!==-1){a.showCustomInputWindow(E,J=>{E=J,re(g,E)});return}a.lastUrl=E,re(g,E),a.waitForShowTips=!1}},C))}},T=!1;o.addEventListener("touchend",g=>{g.stopPropagation&&g.stopPropagation(),u&&(T=!0,a.waitForShowTips=!0)},!1);let w=g=>{if(a.funcKeyCall||c.prefConfig.noAni)return;let C=a.con.classList.contains("search-jumper-left")||a.con.classList.contains("search-jumper-right"),E=[],J=o.getBoundingClientRect(),R=C?Math.abs(g.clientY-J.top)/J.height:Math.abs(g.clientX-J.left)/J.width,U=.1,ce=.1;o.style.setProperty("--scale",1+U+ce),E.push(o);let oe=o.previousElementSibling;if(oe&&/^A$/i.test(oe.nodeName)){oe.style.setProperty("--scale",1+ce+U*(1-R)),E.push(oe);let ne=oe.previousElementSibling;ne&&/^A$/i.test(ne.nodeName)&&(ne.style.setProperty("--scale",1+ce*(1-R)),E.push(ne))}let fe=o.nextElementSibling;if(fe&&/^A$/i.test(fe.nodeName)){fe.style.setProperty("--scale",1+ce+U*R),E.push(fe);let ne=fe.nextElementSibling;ne&&/^A$/i.test(ne.nodeName)&&(ne.style.setProperty("--scale",1+ce*R),E.push(ne))}a.dockerScaleBtns.forEach(ne=>{E.indexOf(ne)===-1&&ne.style.setProperty("--scale",1)}),a.dockerScaleBtns=E};return o.addEventListener("mouseenter",g=>{if(g.stopPropagation&&g.stopPropagation(),!(ie&&a.lastTips===o&&a.tips.style.opacity==1)){if(a.lastTips=o,u){if(T){T=!1;return}if(H&&!(a.searchJumperInputKeyWords.value||a.tileInput.value||Xe())){a.waitForShowTips=!0,a.tipsPos(o,G);return}}D(o)}},!0),o.addEventListener("mousemove",g=>{w(g),a.clingPos(o,a.tips)},!1),o.addEventListener("showTips",g=>{a.appendBar(),a.closeOpenType(),a.con.style.display="",a.setFuncKeyCall(!0),D(B,0)},!1),o.addEventListener("mouseleave",g=>{ie||(a.tips.style.opacity=0,clearTimeout(a.requestShowTipsTimer))},!1),o.addEventListener("drop",g=>{a.searchBySiteName(p,g)},!1),o.addEventListener("dragover",g=>{g.preventDefault()},!1),o}closePopupWindow(){c.prefConfig.closePopupWhenClick&&this.popupWindow&&(this.popupWindow.close(),this.popupWindow=null)}closeOpenType(){let e=this.bar.querySelector(".search-jumper-type.search-jumper-open>span");if(e)if(this.funcKeyCall=!1,e.onmouseup)e.onmouseup();else{let t=new PointerEvent("mouseup");e.dispatchEvent(t)}}addToHighlightGroup(e,t){let r=c.prefConfig.inPageRule[t];if(r){let i=r.match(/^\/(.*)\/([il]*)$/);i?r=`/${i[1]}|${e}/${i[2]||""}`:r=`/${r}|${e}/`}else r=`/${e}/`;c.prefConfig.inPageRule[t]=r,K.setItem("searchData",c),this.refreshPageWords(this.lockWords)}streamUpdate(e){this.streamUpdateCallBack&&this.streamUpdateCallBack(e)}async anylizeShowTips(e,t,r){let i,s=this;try{const n=/([^\\]|^)([\+\-*/])([\d\.]+)$/,a=/\|cache\=(\d+)$/,o=/%p(\{+)/,p=/#headers({.*?})/,d=/#stream({(.*?)})?/,u=/.then{(.*?)}/;if(e=e.replace(/^showTips:/,"").replace(/{name}/g,t).trim(),/^https?:/.test(e)){let m=e.split(`
`);m.length==1&&(m=e.split(" ")),m=m[0],e=e.replace(m,"").trim().replace(/\\{/g,"showTipsLeftBrace").replace(/\\}/g,"showTipsRightBrace").replace(/{url}/g,"\u3010SEARCHJUMPERURL\u3011");let h=m.match(a);h?(h=parseInt(h[1]),m=m.replace(a,"")):h=7200;let f=Date.now()/1e3,b=tt.filter(N=>f<N.time?(!i&&N.url==m&&(i=N.data),!0):!1);b.length!=tt.length&&(tt=b,K.setItem("tipsStorage",tt));let S=[],L=(N,W)=>{let I=e,H=!0;for(;W;){let V=W[1].replace(/\\\|/g,"\u3010searchJumperJsonSplit\u3011").split("|"),F=V[0].replace(/【searchJumperJsonSplit】/g,"|").replace(/\[(\d+)\]/g,".$1").replace(/\[all\]/g,".all").split("."),y=N,j=null;if(F.shift(),F.forEach(A=>{if(j){let P=[];for(let $=0;$<j.length;$++){let Z=j[$];Z&&(Array.isArray(Z)?Z=Z.at?Z.at(A):Z[A]:Z=Z[A]),P.push(Z)}j=P}else if(y&&(Array.isArray(y)?A==="all"?j=y:y=y.at?y.at(A):y[A]:y=y[A]),!y)return null}),j&&(y=j.join("")),V.length!=1){let A=V[1],P=A.match(n);if(P){let $=[];for(;P;)A=A.replace(n,"$1"),$.unshift([P[2],P[3]]),P=A.match(n);$.forEach(Z=>{let pe=parseFloat(Z[1]);switch(Z[0]){case"+":y+=pe;break;case"-":y-=pe;break;case"*":y*=pe;break;case"/":y/=pe;break}}),y=y.toFixed(2)}else{let $=A.match(/^\/(.*)\/(\w?)$/),Z=$?new RegExp($[1],$[2]):new RegExp(A),pe=y.match(Z);pe&&(y=pe[1])}}y?H=!1:y="",S.push(y),I=I.replace(W[0],y),W=I.match(/{(.*?)}/)}return H&&console.log("Error:",N),I=I.replace(/showTipsLeftBrace/g,"{").replace(/showTipsRightBrace/g,"}"),I},x=e.match(/{(.*?)}/);if(i)x&&x[1].indexOf("json")===0&&(e=e.replace(/【SEARCHJUMPERURL】/g,m),i=L(i,x),i=[i,`
`+S.join(",")]);else{let N,W=m.match(o),I={},H=m;if(W){let P=W[1].length;if(W=m.match(new RegExp(`%p{+(.*?)}{${P}}`)),W){let $=W[1];if($.indexOf("%")===0)try{$=decodeURIComponent($)}catch{}I.body=$,I.method="POST",H=H.replace(W[0],"")}}let V=m.match(p);if(V){let P=V[1];if(P.indexOf("%")===0||P.indexOf("%")===1)try{P=decodeURIComponent(P)}catch{}I.headers=JSON.parse(P),H=H.replace(V[0],"")}let F=!1,y,j=x&&x[1].indexOf("json")===0,A=m.match(d);if(A)I.responseType="stream",I.streamMode=A[2]||"concat",H=H.replace(A[0],""),i=await new Promise(P=>{I.onstream=$=>{let Z;if(j){if(Z=$.json(),!Z)return;Z=L(Z,x)}else Z=$.text;s.tipsPos(r,Z),s.tips.style.pointerEvents="all",P&&P(Z)},y=qe(H,I).then($=>(e=e.replace(/【SEARCHJUMPERURL】/g,$.finalUrl),j?$.json():$.text)),y.then($=>{let Z=j?$&&L($,x):$;Z&&(s.tipsPos(r,Z),P&&P(Z))})}),i||(i="No result",F=!0);else if(j){let P=[];y=qe(H,I).then($=>(e=e.replace(/【SEARCHJUMPERURL】/g,$.finalUrl),$.json())),i=await y.then($=>$?(N=$,L($,x)):null),i||(i="No result",F=!0),i=[i,`
`+P.join(",")]}else{let P=!1,$=H.match(u),Z=[];for(;$;){let te=$[1];Z.push(te),H=H.replace($[0],""),$=H.match(u)}for(y=qe(H,I).then(te=>(e.indexOf("\u3010SEARCHJUMPERURL\u3011")!=-1&&(e=e.replace(/【SEARCHJUMPERURL】/g,te.finalUrl),P=!0),te.text()));Z.length;){let te=Z.shift(),v=await y.then(z=>{let G=document.implementation.createHTMLDocument("");G.documentElement.innerHTML=ee(z);let O=bt(te,G);if(!O)return null;let ie=G.querySelector("base");return _i(O.getAttribute("href"),ie?ie.href:H)});if(v)y=qe(v).then(z=>z.text());else return"No result"}let pe;i=await y.then(te=>{if(!e)return te;let v=document.implementation.createHTMLDocument("");v.documentElement.innerHTML=ee(te),pe=v.title;let z=e;for(;x;){let G="";if(x[1]=="title")G=v.title;else{let O=x[1].split("|"),ie=ni(O[0],v);if(ie&&ie.length)if(P=!0,O.length==1)G=ie[0].innerText;else{let re=O[1],D=re.match(/\(.*?\)/g);D?[].forEach.call(ie,T=>{let w=O[1];D.forEach(g=>{g==="()"?w=w.replace(g,T.innerText):(re=g.match(/\((.*)\)/)[1],w=w.replace(g,T.getAttribute(re)||T[re]))}),G+=w}):G=ie[0].getAttribute(re)||ie[0][re]}}z=z.replace(x[0],G),x=z.match(/{(.*?)}/)}return P?(z=z.replace(/showTipsLeftBrace/g,"{").replace(/showTipsRightBrace/g,"}"),z):null}),i?this.insertHistoryUrl(m,pe):(i="No result",F=!0),i=[i,m],N=i}F||(i=this.calcResult(i),tt.push({url:m,data:N,time:Date.now()/1e3+h}),tt.length>50&&tt.shift(),K.setItem("tipsStorage",tt))}}else if(i=/\breturn\b/.test(e)?await new ai("fetch","storage","name",'"use strict";'+e)(qe,K,t):e,i=this.calcResult(i),B&&B.href){let m=B.title||B.alt||B.innerText;this.insertHistoryUrl(B.href,m)}}catch(n){he(n)}return i}calcResult(e){let t=typeof e=="string",r=t?e:e[0];const i=/{([\d\.]+)(([\+\-*/][\d\.]+)+)}/,s=/([\+\-*/])([\d\.]+)/;let n=r.match(i);if(n){let a=[],o=n[0],p=parseFloat(n[1]),d=n[2];for(n=d.match(s);n;)d=d.replace(n[0],""),a.push([n[1],n[2]]),n=d.match(s);a.forEach(u=>{let m=parseFloat(u[1]);switch(u[0]){case"+":p+=m;break;case"-":p-=m;break;case"*":p*=m;break;case"/":p/=m;break}}),p=p.toFixed(2),r=r.replace(o,p)}return t?e=r:e[0]=r,e}insertHistoryUrl(e,t){if(e.indexOf(location.host)===-1)return;let r=location.href,i=document.title;ye.history.pushState("",t,e),document.title=t,ye.history.replaceState("",i,r),document.title=i}checkScroll(e,t){if(this.funcKeyCall||this.bar.style.display=="none")return;let r=window.innerWidth||document.documentElement.clientWidth,i=window.innerHeight||document.documentElement.clientHeight;if(this.bar.scrollWidth>r||this.bar.scrollHeight>i?this.con.classList.contains("search-jumper-scroll")||(this.bar.style.cssText="",this.con.classList.add("search-jumper-scroll"),this.con.style.display=""):this.con.classList.contains("search-jumper-scroll")&&(this.bar.style.cssText="",this.con.classList.remove("search-jumper-scroll")),e)return;let s=this.bar.querySelector(".search-jumper-type.search-jumper-open");s&&(s.style.width==="0px"&&(s.style.width="auto"),s.style.height==="0px"&&(s.style.height="auto"),s!=this.bar.firstElementChild&&setTimeout(()=>{s.scrollIntoView(t?{}:{behavior:"smooth"})},0))}reopenType(e){let t=new PointerEvent("mouseup");e.parentNode.classList.contains("search-jumper-open")&&(e.onmouseup?e.onmouseup():e.dispatchEvent(t)),e.onmouseup?e.onmouseup():e.dispatchEvent(t)}showInPage(e,t){if(this.contains(B)||this.inInput&&Ze||!e&&this.funcKeyCall)return;(!Ze||!Ze.parentNode)&&(Ze=Me(Et),Ke||this.addToShadow(Ze));let r=We();if(e&&r&&r.length<(c.prefConfig.limitPopupLen||1)||this.con&&this.con.classList.contains("search-jumper-showall"))return;if(c.prefConfig.hidePopup&&(e=!1),!B)B=_(document);else if(!r&&B!=_(document)&&(B.className!="searchJumper"||!/^MARK$/i.test(B.nodeName))){let u=B,m;for(;u&&u.nodeName&&!/^(img|audio|video|a)$/i.test(u.nodeName);){if(u.parentNode){if(/^(img|audio|video|a)$/i.test(u.parentNode.nodeName)){u=u.parentNode;break}if(m=u.parentNode.querySelectorAll("audio,video"),m&&m.length!==1&&(m=u.parentNode.querySelectorAll("img")),m&&m.length!==1&&(m=u.parentNode.querySelectorAll("a")),m&&m.length===1){m[0].scrollHeight&&u.scrollHeight/m[0].scrollHeight<2&&(u=m[0]);break}}u=u.parentNode}u&&(B=u)}this.appendBar();let i=this;this.hideTimeout&&clearTimeout(this.hideTimeout);var s=c.prefConfig.autoDelay||1e3,n=()=>{i.bar.classList.remove("search-jumper-isInPage"),i.bar.classList.remove("search-jumper-isTargetImg"),i.bar.classList.remove("search-jumper-isTargetAudio"),i.bar.classList.remove("search-jumper-isTargetVideo"),i.bar.classList.remove("search-jumper-isTargetLink"),i.bar.classList.remove("search-jumper-isTargetPage"),i.bar.classList.remove("initShow"),i.hideTimeout=null};c.prefConfig.autoHide&&(this.hideTimeout=setTimeout(n,s)),this.bar.classList.remove("search-jumper-isInPage"),this.bar.classList.remove("search-jumper-isTargetImg"),this.bar.classList.remove("search-jumper-isTargetAudio"),this.bar.classList.remove("search-jumper-isTargetVideo"),this.bar.classList.remove("search-jumper-isTargetLink"),this.bar.classList.remove("search-jumper-isTargetPage"),this.bar.classList.remove("initShow"),this.tips.style.opacity=0,this.tips.style.display="none",this.tips.style.transition="none",this.tips.innerHTML=ee(""),setTimeout(()=>{this.bar.classList.add("initShow")},10);let a="",o="";if(r)if(this.bar.classList.add("search-jumper-isInPage"),this.bar.style.display=="none"||e)a="needInPage";else{let u=this.bar.querySelector(".search-jumper-type.search-jumper-open");(!u||u.classList.contains("notmatch")||u.classList.contains("search-jumper-targetPage")||u.classList.contains("search-jumper-targetImg")||u.classList.contains("search-jumper-targetAudio")||u.classList.contains("search-jumper-targetVideo")||u.classList.contains("search-jumper-targetLink"))&&(a="needInPage")}else{switch(B.children.length==1&&B.children[0].nodeName.toUpperCase()==="A"&&(B=B.children[0]),B.nodeName.toUpperCase()){case"IMG":this.bar.classList.add("search-jumper-isTargetImg"),a="targetImg";break;case"AUDIO":this.bar.classList.add("search-jumper-isTargetAudio"),a="targetAudio";break;case"VIDEO":this.bar.classList.add("search-jumper-isTargetVideo"),a="targetVideo";break;case"A":this.bar.classList.add("search-jumper-isTargetLink"),a="targetLink";break;default:break}let u=B.parentNode;u&&u.nodeName.toUpperCase()==="A"&&(this.bar.classList.add("search-jumper-isTargetLink"),a?o="targetLink":a="targetLink"),a||(this.bar.classList.add("search-jumper-isTargetPage"),a="targetPage"),a||(a="targetAll")}this.bar.style.display=="none"&&(this.bar.style.display="");let p,d;if(a&&(p=this.bar.querySelector(`.search-jumper-${a}:not(.notmatch)>span`),d=this.bar.querySelectorAll(`.search-jumper-${a}:not(.notmatch)>a>img`)),i.setFuncKeyCall(!1),p&&(!c.prefConfig.disableAutoOpen&&!c.prefConfig.disableTypeOpen||e)){let u=this.bar.querySelectorAll(`.search-jumper-${a}:not(.notmatch)>span:first-child`);[].forEach.call(u,m=>{m!==p&&i.reopenType(m)}),i.reopenType(p),i.insertHistory(p.parentNode),o&&(u=this.bar.querySelectorAll(`.search-jumper-${o}:not(.notmatch)>span:first-child`),[].forEach.call(u,m=>{m!==p&&i.reopenType(m)}),i.reopenType(p))}if(!e&&(c.prefConfig.disableAutoOpen||c.prefConfig.disableTypeOpen)&&this.closeOpenType(),i.setFuncKeyCall(e),e){d&&[].forEach.call(d,L=>{L.parentNode.style.display!="none"&&L.dataset.src&&(L.src=L.dataset.src,delete L.dataset.src)}),i.con.classList.remove("search-jumper-scroll"),i.bar.style.cssText="",i.con.style.cssText="";let u=window.innerWidth||document.documentElement.clientWidth,m=document.documentElement.scrollLeft||document.body.scrollLeft,h=window.innerHeight||document.documentElement.clientHeight,f=c.prefConfig.tileOffset||0,b=pr(t)-i.bar.clientWidth/2-(getComputedStyle(document.documentElement).position!=="static"?document.documentElement.offsetLeft:0);b<0?b=5:b+i.bar.clientWidth>u+m&&(b=u+m-i.bar.clientWidth-20);let S=hr(t);dt(t)>h/5?S-=i.bar.clientHeight+20+f:S+=20+f,ht(t)<u/2?(i.bar.style.left=b+m+"px",i.bar.style.transformOrigin="0 0"):(i.bar.style.right=u-b-i.bar.clientWidth-15+"px",i.bar.style.transformOrigin="100% 0"),i.bar.style.top=S+"px",i.removeBar(),i.bar.style.opacity=0,setTimeout(()=>{i.appendBar(),setTimeout(()=>{i.bar.style.opacity=1,setTimeout(()=>{let L=document.querySelector("#saladict-saladbowl-root>.saladict-external");if(L){let x=L.shadowRoot.querySelector(".saladbowl");x.style.transform=x.style.transform.replace(/\d+px\)/,`${t.clientY-15}px)`)}},100)},1)},1)}else i.bar.style.display="",i.initPos()}setFuncKeyCall(e){this.funcKeyCall=e,this.con.classList.contains("search-jumper-showall")||(e?(this.tileInput.value=Xe(),this.con.classList.add("funcKeyCall"),this.bar.insertBefore(this.tileInput,this.bar.firstChild)):(this.tileInput.value="",this.con.classList.remove("funcKeyCall"),this.tileInput.parentNode&&this.tileInput.parentNode.removeChild(this.tileInput)))}initPos(e,t,r,i){this.preList&&(this.preList.style.visibility="hidden",this.preList.style.opacity=0,this.listArrow.style.cssText=""),typeof e>"u"&&(e=c.prefConfig.position.x),typeof t>"u"&&(t=c.prefConfig.position.y),typeof r>"u"&&(r=c.prefConfig.offset.x),typeof i>"u"&&(i=c.prefConfig.offset.y);let s=this,n=a=>{if(s.bar.style.cssText="",s.con.style.cssText="",s.con.className="search-jumper-searchBarCon "+a,c.prefConfig.resizePage)switch(typeof s.initBodyStyle>"u"?s.initBodyStyle=_(document).style.cssText:_(document).style.cssText=s.initBodyStyle,s.con.classList.add("resizePage"),_(document).style.position="absolute",a){case"search-jumper-left":_(document).style.width=`calc(100vw - ${s.scale*42}px)`,_(document).style.right="0px";break;case"search-jumper-right":_(document).style.width=`calc(100vw - ${s.scale*42}px)`,_(document).style.left="0px";break;case"search-jumper-bottom":_(document).style.width="100%",_(document).style.height=`calc(100vh - ${s.scale*42}px)`,_(document).style.top="0px",_(document).style.overflow="auto";break;default:_(document).style.width="100%",_(document).style.height=`calc(100vh - ${s.scale*42}px)`,_(document).style.bottom="0px",_(document).style.overflow="auto";break}else c.prefConfig.autoHideAll&&s.con.classList.add("hideAll");let o=s.scale*40;setTimeout(()=>{let p=s.con.classList.contains("search-jumper-left")||s.con.classList.contains("search-jumper-right");Se.forEach(d=>{if(!d.classList.contains("search-jumper-open"))p?(d.style.width="",d.style.height=o+"px"):(d.style.width=o+"px",d.style.height="");else{let u=Math.max(d.scrollWidth,d.scrollHeight);u&&(u+="px",p?(d.style.width="",d.style.height=u):(d.style.width=u,d.style.height=""))}})},1)};r<0&&(r=0),i<0&&(i=0),e=="center"&&t=="top"?(n(""),s.bar.style.position="relative"):e=="left"&&t=="top"?r>i?(n(""),s.bar.style.position="fixed",s.bar.style.left=r+"px"):(n("search-jumper-left"),s.bar.style.position="fixed",s.bar.style.top=i+"px"):e=="right"&&t=="top"?r>i?(n(""),s.bar.style.position="fixed",s.bar.style.right=r+"px"):(n("search-jumper-right"),s.bar.style.position="fixed",s.bar.style.top=i+"px"):e=="center"&&t=="bottom"?(n("search-jumper-bottom"),s.bar.style.position="relative"):e=="left"&&t=="bottom"?r>i?(n("search-jumper-bottom"),s.bar.style.position="fixed",s.bar.style.left=r+"px",s.bar.style.bottom="0px",s.bar.style.top="unset"):(n("search-jumper-left"),s.bar.style.position="fixed",s.bar.style.bottom=i+"px"):e=="right"&&t=="bottom"?r>i?(n("search-jumper-bottom"),s.bar.style.position="fixed",s.bar.style.right=r+"px",s.bar.style.bottom="0px",s.bar.style.top="unset"):(n("search-jumper-right"),s.bar.style.position="fixed",s.bar.style.bottom=i+"px"):e=="left"&&t=="center"?(n("search-jumper-left"),s.bar.style.position="relative",s.bar.style.marginTop=i+"px",s.con.style.display="flex",s.con.style.justifyContent="center"):e=="right"&&t=="center"&&(n("search-jumper-right"),s.bar.style.position="absolute",s.bar.style.marginTop=i+"px",s.con.style.display="flex",s.con.style.justifyContent="center",s.con.style.alignItems="flex-end"),c.prefConfig.position.x=e,c.prefConfig.position.y=t,c.prefConfig.offset.x=r,c.prefConfig.offset.y=i,c.prefConfig.disableAutoOpen||c.prefConfig.disableTypeOpen?s.checkScroll(!1,!0):setTimeout(()=>{let a=s.bar.querySelector(".search-jumper-type.search-jumper-open");a&&(a.style.transition="none",a.style.width="auto",a.style.height="auto",setTimeout(()=>{a.style.width=a.scrollWidth+"px",a.style.height=a.scrollHeight+"px",setTimeout(()=>{a.style.transition=""},1),s.checkScroll(!1,!0)},0))},251)}}class br{constructor(){this.clickedIndex=0,this.signList=[],this.clickedEles={},this.exact=!0,this.accu=0,this.wheelScrolling=!1}getSelector(e,t=!0){this.exact=t,this.close(),this.toggle(),this.callback=e}init(){if(this.inited)return;this.inited=!0;let e=this;Me(`
...
`),n=document.createRange();n.selectNodeContents(e);let a=0,o=e.parentNode,p=o.getBoundingClientRect();for(const d of s){if(d.trim()===""){a+=d.length+1;continue}n.setStart(e,a),a+=d.length,n.setEnd(e,a),a++;const u=n.getBoundingClientRect();let m=u.left-p.left,h=u.top-p.top,f=u.width,b=u.height,S={target:{innerText:d,outerHTML:d,parentNode:o,offsetLeft:m+o.offsetLeft,offsetTop:h+o.offsetTop,offsetWidth:f,offsetHeight:b,getBoundingClientRect:()=>{let L=o.getBoundingClientRect();return{left:L.left+m,top:L.top+h,right:L.left+m+f,bottom:L.top+h+b,width:f,height:b}}}};t.children.push(S)}}else e.nodeType===Node.ELEMENT_NODE&&(r.target=e,t.children.push(r));return r}toggle(e){if(this.init(),this.inPicker){this.close();return}this.rectSel=!!e,e?(this.domInfo=this.processNode(_(document),{children:[]}),_(document).addEventListener("mousedown",this.mouseDownHandler,!0),_(document).addEventListener("mouseup",this.mouseUpHandler,!0)):_(document).addEventListener(Mt(),this.wheelHandler,{passive:!1,capture:!0}),this.accu=0,this.inPicker=!0,_(document).classList.add("searchJumper-picker"),k.con.addEventListener("mouseenter",this.leaveHandler,!0),_(document).addEventListener("mousemove",this.moveHandler,!0),_(document).addEventListener("click",this.clickHandler,!0)}}const ke=new br;function xr(l){if(!B)return;let e=l||{key:"Enter",keyCode:13,bubbles:!0},t=new KeyboardEvent("keydown",e);B.dispatchEvent(t),t=new KeyboardEvent("keyup",e),B.dispatchEvent(t),t=new KeyboardEvent("keypress",e),B.dispatchEvent(t),he(B,`press ${l||"Enter"}`)}async function Rt(l){return new Promise(e=>{let t=setInterval(()=>{let r=null;if(l?l==="@"?r=B:r=bt(l):r=document.readyState==="complete",r===!1)return null;r&&(clearInterval(t),e(r))},100)})}async function vr(l){return l?new Promise(e=>{let t=setInterval(()=>{bt(l)||(clearInterval(t),e(null))},100)}):null}let ct=!1;async function Oi(l,e){if(!l)return!0;B=l;let t=new FocusEvent("focusin",{bubbles:!0});l.dispatchEvent(t),t=new Event("focus",{bubbles:!0}),l.dispatchEvent(t);const r=window.getSelection(),i=r.rangeCount?r.getRangeAt(0):new Range;i.selectNode(l),r.removeAllRanges(),r.addRange(i),await $e(1),l.type!=="file"&&l.click&&l.click();let s=l.value;if(l.type=="file"){let u=e;if(u.indexOf("data:")==0)u=Ki(u);else{let h=new Blob([u],{type:"text/plain"});u=new File([h],"noname.txt",{type:h.type})}let m=new DataTransfer;m.items.add(u),l.files=m.files,e="c:/fakepath/fakefile"}else if(/INPUT/i.test(l.nodeName)){var n=Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype,"value").set;n.call(l,e)}else if(/SELECT/i.test(l.nodeName)){var a=Object.getOwnPropertyDescriptor(window.HTMLSelectElement.prototype,"value").set;a.call(l,e)}else if(l.nodeName.toUpperCase()=="TEXTAREA"){var o=Object.getOwnPropertyDescriptor(window.HTMLTextAreaElement.prototype,"value").set;o.call(l,e)}else{let u=l;for(;u&&u.contentEditable!=="true";)u=u.parentNode;if(u)u.dispatchEvent(new InputEvent("beforeinput",{inputType:"insertText",data:e})),await $e(1),l.innerText!==e&&(l.innerHTML=ee(e));else{let m=e;if(m.indexOf("data:")==0)m=Ki(m);else{let h=new Blob([m],{type:"text/plain"});m=new File([h],"noname.txt",{type:h.type})}var p=new ClipboardEvent("paste",{target:document.body,clipboardData:new DataTransfer});p.clipboardData.items.add(m),l.dispatchEvent(p)}}t=new Event("input",{bubbles:!0});let d=l._valueTracker;d&&d.setValue(s),l.dispatchEvent(t),t=new Event("change",{bubbles:!0}),l.dispatchEvent(t),he(l,"input")}async function Lt(l,e=-1){ct=!1;let t;if(e>=0){e===0&&await Rt(l);let r=ni(l);if(r.length===0)return!0;if(r.length===1)t=r[0],ct=!0;else{if(r.length<=e)return!0;t=r[e],r.length===e+1&&(ct=!0)}}else if(t=await Rt(l),!t)return!0;return t}async function Fi(l,e,t=-1){let r=await Lt(l,t);return r===!0?!0:(await Oi(r,e),ct)}async function Ui(l,e=-1){let t=await Lt(l,e);if(t===!0)return!0;if(B=t,!PointerEvent)return t.click();let r={isTrusted:!0,altKey:!1,azimuthAngle:0,bubbles:!0,button:0,buttons:0,clientX:1,clientY:1,cancelBubble:!1,cancelable:!0,composed:!0,ctrlKey:!1,defaultPrevented:!1,detail:1,eventPhase:2,fromElement:null,height:1,isPrimary:!1,metaKey:!1,pointerId:1,pointerType:"mouse",pressure:0,relatedTarget:null,returnValue:!0,shiftKey:!1,toElement:null,twist:0,which:1};t.focus();var i=new PointerEvent("mouseover",r);t.dispatchEvent(i),i=new PointerEvent("pointerover",r),t.dispatchEvent(i),i=new PointerEvent("mousedown",r),t.dispatchEvent(i),i=new PointerEvent("pointerdown",r),t.dispatchEvent(i),i=new PointerEvent("mouseup",r),t.dispatchEvent(i),i=new PointerEvent("pointerup",r),t.dispatchEvent(i);let s=(n,a)=>{let o;try{o=document.createEvent("TouchEvent"),o.initTouchEvent(a,!0,!0)}catch{try{o=document.createEvent("UIEvent"),o.initUIEvent(a,!0,!0)}catch{o=document.createEvent("Event"),o.initEvent(a,!0,!0)}}try{o.targetTouches=[{pageX:1,pageY:1,clientX:1,clientY:1,target:t}],o.touches=[{pageX:1,pageY:1,clientX:1,clientY:1,target:t}],o.changedTouches=[{pageX:1,pageY:1,clientX:1,clientY:1,target:t}]}catch{}n.dispatchEvent(o)};return s(t,"touchstart"),s(t,"touchend"),t.click(),he(t,`click ${l}`),ct}async function wr(l,e=-1){let t=await Lt(l,e);if(t===!0)return!0;B=t;let r={isTrusted:!0,altKey:!1,azimuthAngle:0,bubbles:!0,button:0,buttons:0,clientX:1,clientY:1,cancelBubble:!1,cancelable:!0,composed:!0,ctrlKey:!1,defaultPrevented:!1,detail:2,eventPhase:2,fromElement:null,height:1,isPrimary:!1,metaKey:!1,pointerId:1,pointerType:"mouse",pressure:0,relatedTarget:null,returnValue:!0,shiftKey:!1,toElement:null,twist:0,which:1};t.focus();var i=new PointerEvent("mouseover",r);return t.dispatchEvent(i),i=new PointerEvent("pointerover",r),t.dispatchEvent(i),i=new PointerEvent("mousedown",r),t.dispatchEvent(i),i=new PointerEvent("pointerdown",r),t.dispatchEvent(i),i=new PointerEvent("mouseup",r),t.dispatchEvent(i),i=new PointerEvent("pointerup",r),t.dispatchEvent(i),t.click(),t.click(),i=new MouseEvent("dblclick",{...r,view:ye}),t.dispatchEvent(i),he(t,`dblclick ${l}`),ct}async function Sr(l,e=-1){let t=await Lt(l,e);if(t===!0)return!0;B=t;let r={isTrusted:!0,altKey:!1,azimuthAngle:0,bubbles:!0,button:2,buttons:0,clientX:1,clientY:1,cancelBubble:!1,cancelable:!0,composed:!0,ctrlKey:!1,defaultPrevented:!1,detail:0,eventPhase:2,fromElement:null,height:1,isPrimary:!1,metaKey:!1,pointerId:1,pointerType:"mouse",pressure:0,relatedTarget:null,returnValue:!0,shiftKey:!1,toElement:null,twist:0,which:3};t.focus();var i=new PointerEvent("mouseover",r);return t.dispatchEvent(i),i=new PointerEvent("pointerover",r),t.dispatchEvent(i),i=new PointerEvent("mousedown",r),t.dispatchEvent(i),i=new PointerEvent("pointerdown",r),t.dispatchEvent(i),i=new PointerEvent("mouseup",r),t.dispatchEvent(i),i=new PointerEvent("pointerup",r),t.dispatchEvent(i),i=new PointerEvent("contextmenu",r),t.dispatchEvent(i),he(t,`rclick ${l}`),ct}async function Ot(l,e){if(B)if(B.focus(),typeof l.value<"u"){const t=l.selectionStart,r=l.selectionEnd;let i=l.value.substring(0,t)+e+l.value.substring(r,l.value.length);await Oi(l,i),l.selectionStart=t+e.length,l.selectionEnd=t+e.length}else{const t=window.getSelection(),r=t.getRangeAt(0);t.toString()||r.selectNode(l.childNodes.length===1?l.firstChild:l),r.deleteContents(),r.insertNode(document.createTextNode(e)),t.removeAllRanges(),t.addRange(r)}}function fi(l,e,t){if(e=e.replace(/#(j(umpFrom|f)?|from){(.*?)}/,""),It={charset:l,url:e,target:t},e.indexOf("#submitBySearchJumper")!==-1){It={charset:l,url:e.replace("#submitBySearchJumper",""),target:t},Xi();return}const r="searchJumper_form";var i=document.getElementById(r);i||(i=document.createElement("form"),i.id=r,i.style.display="none",document.documentElement.appendChild(i));var s;let n=e.match(/[:%]p{(.*?)}/),a=e;return n?(a=e.replace(n[0],""),n=n[1],i.method="post",s=new URLSearchParams(n)):(i.method="get",s=new URLSearchParams(new URL(a).search)),l&&(i.acceptCharset=l),i.innerHTML=ee(),i.target=t,i.action=a,s.forEach((o,p)=>{let d=document.createElement("input");d.name=p,d.value=o,i.appendChild(d)}),i.submit()}function Ki(l){try{for(var e=l.split(","),t=e[0].match(/:(.*?);/)[1],r=atob(e[1]),i=r.length,s=new Uint8Array(i);i--;)s[i]=r.charCodeAt(i)}catch(a){he(a)}let n=t.split("/");return n=n.length>1?n[1]:n[0],new File([s],"image."+n,{type:t})}async function qi(l){if(!l||(l.dataset.src&&(l.src=l.dataset.src),!l.src))return null;if(l.src.split("/")[2]==document.domain){let i=getComputedStyle(l);var t=document.createElement("canvas"),r=t.getContext("2d");if(l.complete){t.width=l.naturalWidth||l.width||parseInt(i.width),t.height=l.naturalHeight||l.height||parseInt(i.height),r.drawImage(l,0,0);try{return t.toDataURL("image/png")}catch{return await Ft(l.src)}}else return await new Promise(s=>{l.addEventListener("load",async n=>{t.width=l.naturalWidth||l.width||parseInt(i.width),t.height=l.naturalHeight||l.height||parseInt(i.height),r.drawImage(l,0,0);try{s(t.toDataURL("image/png"))}catch{s(await Ft(l.src))}})})}else return await Ft(l.src)}async function Ft(l){let e=l.split("/");return new Promise(t=>{Be({method:"GET",url:l,responseType:"blob",headers:{origin:e[0]+"//"+e[2],referer:location.href,accept:"*/*"},onload:function(r){try{var i=r.response,s=new FileReader;s.readAsDataURL(i),s.onload=function(n){t(n.target.result)}}catch{t(null)}},onerror:function(){t(null)},ontimeout:function(){t(null)}})})}function Cr(l){let e=getComputedStyle(l),t=getComputedStyle(l,":before").content.replace(/"/g,"");if(!t)return!1;var r=document.createElement("canvas");r.width=l.clientWidth||parseInt(e.lineHeight),r.height=l.clientHeight||parseInt(e.lineHeight);var i=r.getContext("2d");i.font=e.font,i.strokeStyle=e.color||"black",i.fillStyle=e.color||"black",i.textBaseline="top";let s=i.measureText(t);return i.fillText(t,(r.width-s.width)/2,(r.height-parseInt(e.fontSize))/2),r.toDataURL("image/png")}function Tr(l){let e=l.className.trim().replace("fa fa-","").replace(/ /g,"_");if(be[e])return;let t=Cr(l);t=="data:,"||!t||(be[e]=t,K.setItem("cacheIcon",be))}async function mi(l){if(l.nodeName.toUpperCase()=="IMG"){let e=l.src||l.dataset.src;if(e){if(be[e])return;let t=await qi(l);(t=="data:,"||!t)&&(t="fail"),be[e]=t,K.setItem("cacheIcon",be),he(e+" cached, left "+Je.length+" icons")}}else Tr(l);await new Promise(e=>{setTimeout(()=>{e(!0)},1)})}async function Pt(){for(;Je.length>0;)await mi(Je.shift())}async function Gi(l){if(c.prefConfig.cacheSwitch){let e=Je.length>0;await Promise.all([Pt(),Pt(),Pt(),Pt(),Pt()]),e&&(l&&Ce(M("cacheOver")),he(M("cacheOver")))}}async function Vi(l){if(!et){k.con.classList.add("in-input"),k.con.style.visibility="hidden",k.con.style.display="",k.appendBar();let e=Jt.length>0;for(;Jt.length>0;)await mi(Jt.shift());e&&he("All font icons cached!")}}function We(){let l=Nt||ke.getPickerStr()||window.getSelection().toString();if(setTimeout(()=>{Nt=""},1),!l){let e=oi(document);if(e&&/^(TEXTAREA|INPUT)$/i.test(e.nodeName)){let t=e.selectionStart,r=e.selectionEnd;(t||r)&&(l=e.value.substring(t,r))}}if(l){if(l=l.trim(),l)return l}else if(B&&B.className==="searchJumper"&&/^MARK$/i.test(B.nodeName))return B.dataset.matched||B.innerText;return""}function Ut(l,e,t){return t||(/\w$/.test(l)?t="(\\b|$)":t=""),new RegExp(l.replace(/([\*\.\?\+\$\^\[\]\(\)\{\}\|\\\/])/g,"\\$1")+t,e)}function gi(l,e,t,r){if(l.indexOf(e+".replace(/")!==-1){let i=l.match(Ut(e,"",`\\.replace\\(/(.*?[^\\\\])/([gimsuyx]*),\\s*["'](.*?[^\\\\])??["']\\)`));return i?(t=t.replace(new RegExp(i[1],i[2]),i[3]||""),l=l.replace(i[0],e),gi(l,e,t,r)):l.replace(Ut(e,"g"),r?r(t):t)}else return l.replace(Ut(e,"g"),r?r(t.replace(/\$/g,"$$$$")):t.replace(/\$/g,"$$$$"))}function Xe(){let l=We();if(l)return l;if(!ae)return Oe||"";let e,t="",r=!ae.charset||ae.charset=="UTF-8";try{if(ae.keywords){let i=ae.keywords.split(`
`);for(let s=0;s<i.length;s++){let n=i[s];if(!n||!n.trim())continue;let a=i[s].match(/^(.*?)\.replace\(\//);if(a&&(n=a[1]),r){if(/^\w[\w\|]*$/.test(n)){let o=n.split("|"),p=new URLSearchParams(location.search);for(let d=0;d<o.length&&(t=p.get(o[d]),!t);d++);}else if(/\(.+\)/.test(n)&&n.indexOf("@")!==0)try{e=ue.match(new RegExp(n)),e&&(t=e[1]),t&&(t=decodeURIComponent(t))}catch{t=""}}if(!t&&_(document))try{let o=bt(n);o&&(t=o.value||o.innerText)}catch{t=""}if(t&&a&&(t=gi(i[s],n,t)),t)break}}else if(r&&ft.test(ae.url)&&!/[#:%]p{/.test(ae.url)&&(ue.indexOf("?")!=-1&&(e=ae.url.match(new RegExp(`[\\?&]([^&]*?)=${di}.*`)),e&&(t=new URLSearchParams(location.search).get(e[1]))),!t&&(e=ae.url.match(new RegExp(`https?://[^/]*/(.*)${di}`)),e&&(e=ue.match(new RegExp((e[1].replace(/\?/g,"\\?")||location.host.replace(/\./g,"\\.")+"/")+"(.*?)(/|$)")),e&&(t=e[1]),t))))try{t=decodeURIComponent(t)}catch{t=""}if(t==""&&_(document)){let i=_(document).querySelector("input[type=text]:not([readonly]),input:not([type])");i&&(t=i.value)}t&&(Oe=t)}catch(i){he(i)}return Oe||"";//!localKeywords ? cacheKeywords : localKeywords;
}function Yi(l,e){e=e||document.createElement("div"),l="on"+l;var t=l in e;if(!t){e.setAttribute||(e=document.createElement("div"));var r;e.hasAttribute(l)||(r=!0,e.setAttribute(l,"return;")),t=typeof e[l]=="function",r&&e.removeAttribute(l)}return t}function Mt(){var l="DOMMouseScroll";return Yi("wheel")?l="wheel":Yi("mousewheel")&&(l="mousewheel"),l}let mt=!1,Nt="";function kr(){nt(M("settings"),()=>{ge(Ae,{active:!0,insert:!0})}),nt(M("searchInPage"),()=>{k.showInPage(),k.showInPageSearch()}),nt(M("search"),()=>{k.searchAuto(0,{})}),nt(M("addSearchEngine"),()=>{let x=document.head.querySelector('[rel="search"]');if(x)sr(x.href,(N,W)=>{if(N!="load"){W&&he(W.statusText||W.error||W.response||W);let I=_(document).querySelector("input[type=text]:not([readonly]),input[type=search]:not([readonly]),input:not([type])")||_(document).querySelector("textarea");yi(I)}});else{let N=_(document).querySelector("input[type=text]:not([readonly]),input[type=search]:not([readonly]),input:not([type])")||_(document).querySelector("textarea");yi(N)}}),document.addEventListener("searchJumper",x=>{switch(x.detail.action){case"search":x.detail.name?k.searchBySiteName(x.detail.name,x.detail.key||{}):k.searchAuto(x.detail.index,x.detail.key||{});break;case"show":k.setFuncKeyCall(!1),k.showInPage(),(!c.prefConfig.disableInputOnWords||k.inInput||!We())&&k.showSearchInput();break;case"showAll":k.appendBar(),k.showAllSites();break}}),B=_(document);let l=lt.children[0],e=0,t,r=!1,i=x=>{if(clearTimeout(t),k.bar.classList.remove("grabbing"),document.removeEventListener("mouseup",i,!1),document.removeEventListener("mousemove",n,!1),document.removeEventListener("touchend",i,!1),document.removeEventListener("touchmove",n,!1),k.bar.style.marginLeft="",k.bar.style.marginTop="",k.bar.style.transform="",e===1){e=0,k.showAllSites();return}e=0;let N=window.innerWidth||document.documentElement.clientWidth,W=window.innerHeight||document.documentElement.clientHeight,I=N/3,H=W/3,V,F,y,j,A=ht(x),P=dt(x);A<I?(V="left",y=parseInt(k.bar.style.left)>0?parseInt(k.bar.style.left):0):A<I*2?(V="center",y=parseInt(k.bar.style.left)-N/2):(V="right",y=N-parseInt(k.bar.style.left)-k.bar.scrollWidth),P<W/2?(F="top",j=parseInt(k.bar.style.top)):(F="bottom",j=W-parseInt(k.bar.style.top)-k.bar.scrollHeight,j<0&&(j=0)),l.style.cursor="",k.closeOpenType(),k.initPos(V,F,y,j),K.setItem("searchData",c)},s={x:0,y:0},n=x=>{let N=ht(x),W=dt(x);Math.abs(s.x-N)+Math.abs(s.y-W)<50||(e===1&&(clearTimeout(t),l.style.cursor="grabbing",k.bar.style.position="fixed",k.bar.style.marginLeft="0",k.bar.style.marginTop="0",k.bar.style.right="",k.bar.style.bottom="",k.bar.style.transform="unset",k.con.classList.remove("search-jumper-scroll"),k.bar.className="search-jumper-searchBar grabbing"),e=2,k.bar.style.left=N-k.bar.scrollWidth+20+"px",k.bar.style.top=W-k.bar.scrollHeight+20+"px")};if(lt.oncontextmenu=function(x){k.bar.style.display="none",x.preventDefault()},lt.addEventListener("mousedown",x=>{if(r){r=!1;return}if(x.button===2){c.prefConfig.resizePage&&(typeof k.initBodyStyle<"u"&&(_(document).style.cssText=k.initBodyStyle),k.con.classList.remove("resizePage")),document.removeEventListener("mouseup",i,!1),document.removeEventListener("mousemove",n,!1),document.removeEventListener("touchend",i,!1),document.removeEventListener("touchmove",n,!1);return}if(x.preventDefault(),x.stopPropagation(),k.inInput||x.button===1||x.altKey||x.ctrlKey||x.shiftKey||x.metaKey){ge(Ae,{active:!0,insert:!0});return}e=1,s={x:ht(x),y:dt(x)},document.addEventListener("mouseup",i,!1),setTimeout(()=>{e===1&&document.addEventListener("mousemove",n,!1)},100),t=setTimeout(()=>{k.bar.style.display="none",document.removeEventListener("mouseup",i,!1),document.removeEventListener("mousemove",n,!1)},2e3)},!1),lt.addEventListener("touchstart",x=>{x.preventDefault(),x.stopPropagation(),r=!0,e=1,s={x:ht(x),y:dt(x)},document.addEventListener("touchend",i,!1),setTimeout(()=>{e===1&&document.addEventListener("touchmove",n,!1)},100),t=setTimeout(()=>{k.bar.style.display="none",c.prefConfig.resizePage&&(typeof k.initBodyStyle<"u"&&(_(document).style.cssText=k.initBodyStyle),k.con.classList.remove("resizePage")),document.removeEventListener("touchend",i,!1),document.removeEventListener("touchmove",n,!1)},1500)},{passive:!1,capture:!1}),k.bar.addEventListener(Mt(),x=>{if(x.target.parentNode&&(x.target.parentNode.className=="sitelistCon"||x.target.parentNode.parentNode&&x.target.parentNode.parentNode.className=="sitelistCon"))return;let N=k.con.classList;if(N.contains("search-jumper-scroll")&&!(N.contains("search-jumper-left")||N.contains("search-jumper-right"))){var W,I;if(x.type!=="wheel"){var H=0,V=0;typeof x.axis=="number"?x.axis==2?V=x.detail:H=x.detail:typeof x.wheelDeltaY>"u"||x.wheelDeltaY!=0?V=-x.wheelDelta/40:H=-x.wheelDelta/40,I=V,W=H}else W=x.deltaX,I=x.deltaY;x.preventDefault(),x.stopPropagation(),k.con.scrollLeft+=I}},{passive:!1,capture:!1}),c.prefConfig.shortcut&&(c.prefConfig.switchSitesPreKey||c.prefConfig.switchSitesNextKey||c.prefConfig.shortcutKey||c.prefConfig.showAllShortcutKey)){let x=-1,N=!1,W=(I,H,V,F,y,j)=>H&&!I.altKey||V&&!I.ctrlKey||F&&!I.shiftKey||y&&!I.metaKey||(N||(N=(I.key||String.fromCharCode(I.keyCode)).toLowerCase()),j!=N&&j!=I.code)||!c.prefConfig.enableInInput&&x==-1&&(x=1,!V&&!H&&!F&&!y&&Ct(document))?!1:(x=0,I.preventDefault(),I.stopPropagation(),!0);document.addEventListener("mouseenter",I=>{I.target&&!k.contains(I.target)&&(ui=I.target)},!0),document.addEventListener("keydown",I=>{if(I.target.id!=="searchJumperInput"&&(x=-1,N=!1,c.prefConfig.shortcutKey&&W(I,c.prefConfig.callBarAlt,c.prefConfig.callBarCtrl,c.prefConfig.callBarShift,c.prefConfig.callBarMeta,c.prefConfig.shortcutKey)&&(k.setFuncKeyCall(!1),k.showInPage(),(!c.prefConfig.disableInputOnWords||k.inInput||!We())&&k.showSearchInput()),x!=1&&(c.prefConfig.showAllShortcutKey&&W(I,c.prefConfig.showAllAlt,c.prefConfig.showAllCtrl,c.prefConfig.showAllShift,c.prefConfig.showAllMeta,c.prefConfig.showAllShortcutKey)&&(k.appendBar(),k.showAllSites()),ae&&k.bar.style.display!=="none"))){if(c.prefConfig.switchSitesPreKey&&W(I,c.prefConfig.switchSitesAlt,c.prefConfig.switchSitesCtrl,c.prefConfig.switchSitesShift,c.prefConfig.switchSitesMeta,c.prefConfig.switchSitesPreKey)){k.switchSite();return}c.prefConfig.switchSitesNextKey&&W(I,c.prefConfig.switchSitesAlt,c.prefConfig.switchSitesCtrl,c.prefConfig.switchSitesShift,c.prefConfig.switchSitesMeta,c.prefConfig.switchSitesNextKey)&&k.switchSite(!0)}},!0)}let a;if(c.prefConfig.enableInPage){let V=function(y){let j=!1;if(Ct(document))j=!0;else{let A=!1,P=y;for(;P&&(A=P.contentEditable=="true",!(A||P.nodeName.toUpperCase()=="BODY"));)P=P.parentNode;A&&(j=!0)}return j},x=!1,N,W=!1,I;document.addEventListener("selectionchange",y=>{(c.prefConfig.leftMouse||c.prefConfig.middleMouse)&&(window.getSelection().toString()?I=window.getSelection().getRangeAt(0).getBoundingClientRect():I=null)});let H=!1;a=y=>{x&&y.preventDefault(),x=!1,document.removeEventListener("click",a,!0)};let F=y=>{if(H&&y.type==="mousedown"&&y.button===0||y.target.classList&&y.target.classList.contains("search-jumper-btn")||k.contains(y.target)||k.bar.classList.contains("grabbing"))return;let j=V(y.target),A=!c.prefConfig.enableInInput&&j;if(A&&y.type==="dblclick")return;if(c.prefConfig.minPopup==2&&(j?k.con.classList.add("targetInput"):k.con.classList.remove("targetInput")),y.type==="touchstart"){c.prefConfig.selectToShow&&setTimeout(()=>{We()?k.showInPage(!0,y):k.waitForHide(0)},0);return}H=!0,setTimeout(()=>{H=!1},500),x=!1,B=y.target,k.closePopupWindow();let P=!1;if((c.prefConfig.altKey||c.prefConfig.ctrlKey||c.prefConfig.shiftKey||c.prefConfig.metaKey)&&!(c.prefConfig.altKey&&!y.altKey||c.prefConfig.ctrlKey&&!y.ctrlKey||c.prefConfig.shiftKey&&!y.shiftKey||c.prefConfig.metaKey&&!y.metaKey)&&(P=!0),!c.prefConfig.selectToShow&&(y.button===0&&!c.prefConfig.leftMouse||y.button===1&&!c.prefConfig.middleMouse)){k.waitForHide(0);return}let $=y.clientX,Z=y.clientY,pe=!1,te=O=>{Math.abs($-O.clientX)+Math.abs(Z-O.clientY)>2&&(clearTimeout(N),document.removeEventListener("mousemove",te,!0),O.target.removeEventListener("scroll",v),pe=!0)},v=O=>{clearTimeout(N),document.removeEventListener("mousemove",te,!0),O.target.removeEventListener("scroll",v)},z=O=>{mt=!1,k.contains(O.target)||x?O.preventDefault():setTimeout(()=>{x||(j=V(O.target),A=!c.prefConfig.enableInInput&&j,!A&&(P&&O.button===2||(pe||W)&&O.button===0&&c.prefConfig.selectToShow&&We())?k.showInPage(!0,O):(H=!1,k.waitForHide(0)))},0),clearTimeout(N),document.removeEventListener("mouseup",z,!0),document.removeEventListener("mousemove",te,!0),O.target.removeEventListener("scroll",v)};if(y.type==="dblclick"){We()!==""?(x=!0,mt=!1,document.removeEventListener("mouseup",z,!0),document.removeEventListener("mousemove",te,!0),y.target.removeEventListener("scroll",v),clearTimeout(N),setTimeout(()=>{k.showInPage(!0,y)},200)):(W=!0,setTimeout(()=>{W=!1},200));return}N&&clearTimeout(N),N=setTimeout(()=>{mt||B==y.target&&(y.button===1&&!c.prefConfig.middleMouse||y.button===2&&!c.prefConfig.rightMouse||y.button===0&&!c.prefConfig.leftMouse||(c.prefConfig.longPressTile?k.showInPage(!0,y):(k.setFuncKeyCall(!1),k.showInPage()),x=!0))},parseInt(c.prefConfig.longPressTime));let G=!1;if(y.button===2?P&&(G=!0):(y.button===0?c.prefConfig.leftMouse&&(G=!0):y.button===1&&c.prefConfig.middleMouse&&(G=!0),G&&(A?G=!1:I?(y.clientX<I.left||y.clientX>I.left+I.width||y.clientY<I.top||y.clientY>I.top+I.height)&&(G=!1):G=!1)),G)return setTimeout(()=>{mt||k.showInPage(!0,y),document.removeEventListener("mousemove",te,!0),y.target.removeEventListener("scroll",v)},200),x=!0,document.addEventListener("mouseup",z,!0),document.addEventListener("click",a,!0),!1;document.addEventListener("mousemove",te,!0),document.addEventListener("mouseup",z,!0),y.target.addEventListener("scroll",v)};if(document.addEventListener("mousedown",F),document.addEventListener("dblclick",F),c.prefConfig.selectToShow){let y,j,A=P=>{clearTimeout(y),y=setTimeout(()=>{window.getSelection().toString()&&(F(j),document.removeEventListener("selectionchange",A))},300)};document.addEventListener("touchstart",P=>{P.isTrusted!==!1&&(j=P,document.addEventListener("selectionchange",A))})}document.addEventListener("contextmenu",y=>{x&&y.preventDefault(),x=!1})}c.prefConfig.dragToSearch&&!at&&_(document).addEventListener("dragstart",x=>{!x.isTrusted||c.prefConfig.dragAlt&&!x.altKey||c.prefConfig.dragCtrl&&!x.ctrlKey||c.prefConfig.dragShift&&!x.shiftKey||c.prefConfig.dragMeta&&!x.metaKey||!c.prefConfig.enableInInput&&!x.altKey&&!x.ctrlKey&&!x.shiftKey&&!x.metaKey&&Ct(document)||(B=x.target,B.nodeType!==1&&(B=B.parentNode),B.shadowRoot&&(B=B.shadowRoot.activeElement||B),!(B.getAttribute&&B.getAttribute("draggable")=="true")&&(B.parentNode&&B.parentNode.getAttribute&&B.parentNode.getAttribute("draggable")=="true"||(k.waitForHide(0),setTimeout(()=>{Pr(x.clientX,x.clientY)},2),a&&document.removeEventListener("click",a,!0),mt=!0)))}),c.prefConfig.quickAddRule&&document.addEventListener("click",x=>{((x.ctrlKey||x.metaKey)&&x.shiftKey||(x.ctrlKey||x.metaKey)&&x.altKey||x.altKey&&x.shiftKey)&&/^(INPUT|TEXTAREA)$/i.test(x.target.nodeName)&&(/^INPUT$/i.test(x.target.nodeName)&&x.target.type&&x.target.type!="text"&&x.target.type!="search"||yi(x.target))},!0);let o=x=>{setTimeout(()=>{k.refresh()},100)};document.addEventListener("fullscreenchange",x=>{document.fullscreenElement&&(k.bar.style.display="none")});let p=!1,d=x=>{if(p)return;p=!0,setTimeout(()=>{p=!1},300);let N=x.target;if(ae&&N)if(N.nodeName&&N.nodeName.toLowerCase&&N.nodeName.toLowerCase()=="a")k.updateCacheKeywords();else{let W=N.parentNode;W&&W.nodeName&&W.nodeName.toLowerCase&&W.nodeName.toLowerCase()=="a"&&k.updateCacheKeywords()}};_(document).addEventListener("auxclick",d,!0),_(document).addEventListener("click",d,!0);let u=function(x){var N=history[x];return function(){var W=N.apply(this,arguments);let I=location.href.slice(0,500);if(ue!=I){ue=I;var H=new Event("sj_"+x);H.arguments=arguments,window.dispatchEvent(H)}return W}};history.pushState=u("pushState"),history.replaceState=u("replaceState"),window.addEventListener("sj_pushState",o),window.addEventListener("sj_replaceState",o),window.addEventListener("yt-navigate-finish",o),window.addEventListener("securitypolicyviolation",x=>{x.violatedDirective==="form-action"&&Xi()});let m=x=>k.removeMark(x),h=(x,N)=>k.highlight(x,N),f=()=>k.appendBar(),b={childList:!0,characterData:!0,subtree:!0},S=0;new MutationObserver((x,N)=>{if(k.lockWords){if(k.initHighlight&&S>100)return;for(let I of x){if(I.type==="characterData"){let H=I.target.parentNode;if(!H||I.target.previousElementSibling&&I.target.previousElementSibling.className==="searchJumper"||I.target.nextElementSibling&&I.target.nextElementSibling.className==="searchJumper")return;k.checkCharacterData(H),k.initHighlight&&S++}if(I.removedNodes.length&&[].forEach.call(I.removedNodes,H=>{H.nodeType===1&&(H.classList&&H.classList.contains("searchJumper")?m(H):H.children.length&&[].forEach.call(H.querySelectorAll("mark.searchJumper,a.searchJumper,input.searchJumper,textarea.searchJumper"),V=>{m(V)}))}),I.addedNodes.length)for(let H=0;H<I.addedNodes.length;H++){let V=I.addedNodes[H],F;if(V.nodeType===1){if(/^searchJumper$/.test(V.className))continue;F=V}else{if(V.previousElementSibling&&/^searchJumper$/.test(V.previousElementSibling.className))continue;if(V.nextElementSibling&&/^searchJumper$/.test(V.nextElementSibling.className))continue;F=V.parentNode}F&&(setTimeout(()=>{h("insert",F)},0),k.initHighlight&&S++)}}f()}}).observe(_(document),b)}function _i(l,e){if(!l)return"";let t,r;if(e)t=e.replace(/(^https?:\/\/.+)\/[^\/]*$/,"$1"),r=e;else{if(l.charAt(0)=="#")return location.href+l;if(l.charAt(0)=="?")return location.href.replace(/^([^\?#]+).*/,"$1"+l);t=location.protocol+"//"+location.host;let o=document.querySelector("base");r=o?o.href:location.href}let i=r||t;i=i.replace(/(\?|#).*/,""),/https?:\/\/[^\/]+$/.test(i)&&(i=i+"/"),i.indexOf("http")!==0&&(i=t+i);for(var s=/^[^\?#]*\//.exec(i)[0],n=/^\w+\:\/\/\/?[^\/]+/.exec(s)[0],a=/^\w+\:\/\//;l.indexOf("../")===0;)l=l.substr(3),s=s.replace(/\/[^\/]+\/$/,"/");return l=l.replace(/\.\//,""),/^\/\/\/?/.test(l)&&(l=location.protocol+l),a.test(l)?l:(l.charAt(0)=="/"?n:s)+l}function yi(l){if(Te)return;let e,t=location.href;if(l&&l.name)for(e=l.parentNode;e;){if(e.nodeName.toUpperCase()==="FORM"){let s=e.target;if(s&&typeof s=="string"&&s!="_blank"&&s!="_self"&&s!="_parent"&&s!="_top"&&!_(document).querySelector(s)){e=null;break}break}e=e.parentNode}let r=()=>!window.confirm(M("noValidItemAsk"));if(e){t=_i(e.getAttribute("action")||t);let s=[],n=new FormData(e);for(let[a,o]of n)l.name===a?o="%s":o=encodeURIComponent(o),s.push(a+"="+o);if(e.method.toLowerCase()=="post")t+="%p{"+s.join("&")+"}",e.action.indexOf(location.origin)==0&&location.pathname&&location.pathname!=="/"&&(t+=`#from{${location.pathname.slice(1)}}`);else{let a=t.match(/\?(.*)/);a&&(t=t.replace(a[0],""),a[1].split("&").forEach(o=>{let p=o.split("="),d=p[0];if(s.findIndex(m=>m.indexOf(d+"=")===0)!==-1)return;let u=p[1];u==l.value&&(u="%s"),s.push(d+"="+u)})),t+="?"+s.join("&")}}else if(l&&l.value)if(location.href.indexOf(l.value)!==-1)t=location.href.replace(l.value,"%s");else{let s=encodeURIComponent(l.value);if(location.pathname.indexOf(s)!==-1||location.search.indexOf(s)!==-1)t=location.origin+location.pathname.replace(s,"%s")+location.search.replace(s,"%s");else if(s=escape&&escape(l.value),s&&location.pathname.indexOf(s)!==-1||location.search.indexOf(s)!==-1)t=location.origin+location.pathname.replace(s,"%se")+location.search.replace(s,"%se");else if(r())return}else if(r())return;let i=[];[].forEach.call(document.querySelectorAll("link[rel='shortcut icon'],link[rel='icon'],link[rel='fluid-icon'],link[rel='apple-touch-icon']"),s=>{i.indexOf&&i.indexOf(s.href)!==-1||i.push(s.href)}),Qt(document.title.replace(l?l.value:"","").replace(/^\s*[-_]\s*/,""),"",t,i,document.characterSet)}const Zi="https://hoothin.github.io/SearchJumper/jump.html";function Xi(){let l=`${Zi}#jump{url=${encodeURIComponent(It.url)}&charset=${It.charset}}`;It.target=="_self"?location.href=l:ge(l,{active:!0,insert:!0})}function Ir(){if(ue.indexOf(Zi)!=-1){let l=ue.match(/#jump{url=(.*)&charset=(.*)}/);l&&fi(l[2],decodeURIComponent(l[1]),"_self")}}var Te;async function jr(){if(ue.indexOf(Ae)===0||(document.title==="SearchJumper"||document.querySelector('[name="from"][content="SearchJumper"]'))&&document.querySelector('[name="author"][content="Hoothin"]')){Te=document.querySelector('[name="engines"]');let l=document.getElementById("spotlight");if(Te)try{if(Te=Te.getAttribute("content"),Te.indexOf("http")===0){if(l){const r=M("loadingCollection");l.innerText=r,l.setAttribute("spotlight",r)}let t=await new Promise(r=>{Be({method:"GET",url:Te,onload:function(i){var s=null;try{s=JSON.parse(i.responseText),r(s)}catch(n){console.log(n),r(!1)}},onerror:function(i){console.log(i),r(!1)},ontimeout:function(i){console.log(i),r(!1)}})});t?(c.sitesConfig=t,Te=!0):Te=!1}else c.sitesConfig=JSON.parse(decodeURI(Te)),Te=!0}catch{Te=!1}let e=ue.indexOf(Ae.replace(/\/config.*/,""))===0||ue.indexOf(ii)===0||ue.indexOf(or)===0||location.hostname==="localhost";return e&&(et=!!Te||/all(\.html)?$/.test(location.pathname)),l?l.style.display="none":setTimeout(()=>{l=document.getElementById("spotlight"),l&&(l.style.display="none")},500),e}return!1}async function Er(){if(at=await jr(),!at&&c.webdavConfig&&(ot=new cr(c.webdavConfig.host+"/SearchJumper"+(c.webdavConfig.path||"").replace(/^\/*/,"/").replace(/\/*$/,"/"),c.webdavConfig.username,c.webdavConfig.password)),at&&!et){let l,e=!1,t=()=>{l=setTimeout(()=>{e||t()},50),window.postMessage({searchData:c,cacheIcon:be,version:pt.script.version||0,command:"loadConfig"},"*")},r=setTimeout(()=>{e||location.reload()},3e3);document.addEventListener("received",n=>{e=!0,clearTimeout(l),clearTimeout(r),Je.length>0&&c.prefConfig.cacheSwitch&&(he(`Start cache ${Je.length} icons!`),Gi())}),document.addEventListener("downloadCache",n=>{Mr()}),document.addEventListener("importCache",n=>{let a=n.detail?n.detail.cacheData:n.cacheData;Nr(a),Ce("Cache imported successfully!")}),document.addEventListener("showSiteAdd",n=>{let a=n.detail?n.detail.site:n.site;a&&(a.url?Qt(a.name,a.description,a.url,a.icon?[a.icon]:[],a.charset,a.kwFilter,a.match,a.hideNotMatch):Qi.open(a))}),t(),document.addEventListener("dataChanged",n=>{t()});let i=(n,a,o,p)=>{window.postMessage({url:n,name:a,status:o,finalUrl:p,command:"verifyResult"},"*")};document.addEventListener("verifyUrl",n=>{let a=n.detail?n.detail.url:n.url,o=n.detail?n.detail.name:n.name;Be({method:"GET",url:a,headers:{referer:a,"User-Agent":navigator.userAgent},onload:function(p){i(a,o,p&&p.status,p&&p.finalUrl)},onerror:function(p){i(a,o,"error","")},ontimeout:function(p){i(a,o,"timeout","")}})});let s=c.prefConfig.cacheSwitch;document.addEventListener("saveConfig",n=>{c=(n.detail?n.detail.searchData:n.searchData)||ye.searchData,K.setItem("searchData",c);let a={},o=be?Object.keys(be).length:0;s==c.prefConfig.cacheSwitch?(c.sitesConfig.forEach(p=>{if(/^[a-z\- ]+$/.test(p.icon||"")||/^http/.test(p.icon)){let d=p.icon.trim().replace(/ /g,"_"),u=be[d];u&&(a[d]=u)}p.sites.forEach(d=>{let u=d.icon;if(u||(u=d.url.replace(/^showTips:/,"").replace(/\?.*/,"").replace(/^(https?:\/\/[^\/]*\/)[\s\S]*$/,"$1favicon.ico")),/^http/.test(u)){let m=be[u];m&&(a[u]=m)}})}),o!==Object.keys(a).length&&(be=a,K.setItem("cacheIcon",a))):(c.sitesConfig.forEach(p=>{if(/^http/.test(p.icon)){let d=be[p.icon];if(d)if(d==="fail"){let u=document.createElement("img");u.src=p.icon,Je.push(u)}else a[p.icon]=d}p.sites.forEach(d=>{let u=d.icon;if(u||(u=d.url.replace(/^showTips:/,"").replace(/\?.*/,"").replace(/^(https?:\/\/[^\/]*\/)[\s\S]*$/,"$1favicon.ico")),/^http/.test(u)){let m=be[u];if(m)if(m==="fail"){let h=document.createElement("img");h.src=u,Je.push(h)}else a[u]=m}})}),K.setItem("cacheIcon",a),c.prefConfig.cacheSwitch&&(Je.length>0&&(Ce(M("startCache")),Gi(!0)),Vi())),s=c.prefConfig.cacheSwitch,(n.notification||n.detail&&n.detail.notification)&&Ce("Configuration imported successfully!")}),document.addEventListener("copyConfig",n=>{let a=c.sitesConfig.filter(o=>o&&!(/^BM/.test(o.type)&&o.icon==="bookmark"));Re(JSON.stringify(a,null,2)),Ce("Configuration copied successfully!")})}else if(Pi.test(ue)){let l=Me(`
                    #import-btns-con {
                        position: absolute;
                        display: block;
                        font-size: 20px;
                ...
                `),e,t=0,r=document.createElement("button");r.id="import-btn",r.className="btn Button--secondary Button";let i=document.createElement("button");i.id="filter-btn",i.className="btn Button--secondary Button";let s=document.createElement("h3"),n=document.createElement("div");n.id="import-btns-con",n.appendChild(l),n.appendChild(r),n.appendChild(i),n.appendChild(s),n.addEventListener("click",o=>{e&&(e.style.filter=""),n.classList.add("hide")}),r.innerText=M("import"),r.addEventListener("click",o=>{if(Te||!e)return;let p=e.innerText.trim(),d;if(p){try{d=JSON.parse(p)}catch(u){Ce(u.toString());return}switch(t){case 0:window.confirm(M("importOrNot"))&&(n.parentNode&&n.parentNode.removeChild(n),Dt(()=>{c.sitesConfig=d,c.lastModified=new Date().getTime(),K.setItem("searchData",c),Ce(M("siteAddOver")),k.refreshEngines()},!0));break;case 1:Qt(d.name,"",d.url,d.icon?[d.icon]:[],d.charset,d.kwFilter,d.match,d.hideNotMatch);break;case 2:c.prefConfig.inPageRule||(c.prefConfig.inPageRule={}),Object.keys(d).forEach(u=>{let m=d[u];if(!m)return;if(u.indexOf("@")===0){c.prefConfig.inPageRule[u]=m;return}if(!m.words||m.words.length===0)return;let h="",f=m.sep||"";f?h="$c"+f:(f=" ",m.words.length===1&&m.words[0].indexOf(" ")!==-1&&(f="",h="$o")),c.prefConfig.inPageRule[u]=h+m.words.join(f)}),K.setItem("searchData",c),Ce("Over!");break}}}),i.innerText=M("filter"),i.addEventListener("click",o=>{if(e){n.parentNode&&n.parentNode.removeChild(n);let p=e.innerText.trim(),d;if(!p||p.indexOf("[")!==0)return;try{d=JSON.parse(p),Qi.open(d)}catch(u){Ce(u.toString())}}});let a=o=>{if(o==e&&n.parentNode)return;let p=o.offsetTop+"px",d=o.innerText.trim();if(d){if(s.innerText="",/^\[/.test(d))t=0,n.style.top=p,n.classList.add("filter");else if(/^\{\s*"name"/.test(d))t=1,n.style.top=p,n.classList.remove("filter"),s.innerText=d.match(/"name":\s*"(.*)"/)[1];else if(/^\{/.test(d))t=2,n.style.top=p,n.classList.remove("filter");else return;e&&(e.style.filter=""),o.parentNode.appendChild(n),o.style.filter="blur(5px)",e=o,n.classList.remove("hide")}};window.addEventListener("load",o=>{if(!e){let p=document.querySelector(".highlight>pre");p&&a(p)}}),document.addEventListener("mouseover",o=>{if(Pi.test(ue))if(o.target.nodeName==="PRE")a(o.target);else{let p=o.target.children[0];p&&p.nodeName==="PRE"&&a(p)}})}}class Lr{constructor(){this.inited=!1}init(){if(this.inited)return;this.inited=!0;let e=this;this.openList=[],this.filterCss=`
                    #searchJumperFilter {
                        width: 100%;
                        height: 100%;
                        position: fixed;
                ...
                <div class="searchJumperFrame-body">
                    <a href="${Ae}" class="searchJumperFrame-title" target="_blank">
                        <img onerror="this.style.display='none'" width="32px" height="32px" src="${ut}" />${M("addSearchEngine")}
                    </a>
                    <div class="searchJumperFrame-buttons">
                        <button id="expandAll" type="button">${M("expandAll")}</button>
                        <button id="collapseAll" type="button">${M("collapseAll")}</button>
                    </div>
                    <div class="sitesCon"></div>
                    <div class="searchJumperFrame-buttons">
                        <button id="cancel" type="button">${M("siteCancel")}</button>
                        <button id="selectAll" type="button">${M("selectAll")}</button>
                        <button id="add" type="button">${M("import")}</button>
                    </div>
                </div>
                `),this.sitesCon=this.filterFrame.querySelector(".sitesCon");let t=this.filterFrame.querySelector("#add"),r=this.filterFrame.querySelector("#selectAll"),i=this.filterFrame.querySelector("#expandAll"),s=this.filterFrame.querySelector("#collapseAll"),n=!1;i.addEventListener("click",a=>{[].forEach.call(this.filterFrame.querySelectorAll("details"),o=>{o.setAttribute("open","open")})}),s.addEventListener("click",a=>{[].forEach.call(this.filterFrame.querySelectorAll("details"),o=>{o.removeAttribute("open")})}),r.addEventListener("click",a=>{n=!n,[].forEach.call(this.filterFrame.querySelectorAll("input[type=checkbox]"),o=>{o.checked=n})}),t.addEventListener("click",a=>{Te||Dt(()=>{let o=!1;[].forEach.call(this.filterFrame.querySelectorAll("details"),p=>{let d=p.children[0].children[0],u=e.typeDict[d.title];if(u.type=d.innerText.trim(),u.sites=[],[].forEach.call(p.querySelectorAll('div>[type="checkbox"]'),m=>{if(m.checked){o=!0;let h=e.siteDict[m.parentNode.title],f=m.nextElementSibling;if(!h||!f)return;if(f.value==="0")u.sites.push(h);else{let b=e.searchType(f.value);c.sitesConfig[b].sites.push(h)}}}),u.sites.length){let m=e.searchType(u.type);m===!1?c.sitesConfig.push(u):c.sitesConfig[m].sites=c.sitesConfig[m].sites.concat(u.sites)}}),o&&(c.lastModified=new Date().getTime(),K.setItem("searchData",c),Ce(M("siteAddOver")),k.refreshEngines(),this.close())})}),this.filterFrame.addEventListener("click",a=>{(a.target.id=="searchJumperFilter"||a.target.id=="cancel")&&this.close()})}searchType(e){for(let t=0;t<c.sitesConfig.length;t++)if(c.sitesConfig[t].type==e)return t;return!1}searchUrl(e){for(let t=0;t<c.sitesConfig.length;t++){let r=c.sitesConfig[t].sites;for(let i=0;i<r.length;i++)if(r[i].url.replace(/^https?/,"")==e.replace(/^https?/,""))return!0}return!1}searchName(e){for(let t=0;t<c.sitesConfig.length;t++){let r=c.sitesConfig[t].sites;for(let i=0;i<r.length;i++)if(r[i].name==e){let s=e+"_1";return this.searchName(s)}}return e}anylizeType(e){let t=this,r=document.createElement("details"),i=document.createElement("summary"),s=document.createElement("span");s.title=e.type,s.innerText=e.type,i.appendChild(s);let n=document.createElement("input");n.type="checkbox",i.appendChild(n);let a=document.createElement("button");a.innerText=M("rename"),a.addEventListener("click",p=>{let d=window.prompt(M("rename"),s.innerText);d&&(s.innerText=d)}),i.appendChild(a),r.appendChild(i);for(let p=0;p<this.openList.length;p++)if(this.openList[p]==e.type){r.setAttribute("open","open");break}let o=[];this.typeDict[e.type]=e,e.sites&&e.sites.forEach(p=>{let d=document.createElement("div"),u=document.createElement("span");if(u.innerText=p.name,p.name=t.searchName(p.name),d.appendChild(u),d.title=p.url,r.appendChild(d),t.searchUrl(p.url)){d.classList.add("exist");return}let m=document.createElement("input");m.type="checkbox",m.onclick=b=>{if(!m.checked)n.checked=!1;else{let S=!0;for(let L=0;L<o.length;L++)if(!o[L].checked){S=!1;break}S&&(n.checked=!0)}},d.appendChild(m),d.addEventListener("click",b=>{b.target.nodeName.toUpperCase()=="SPAN"&&m.click()});let h=document.createElement("select"),f=document.createElement("option");f.value=0,f.innerText=M("currentType"),h.appendChild(f);for(let b=0;b<c.sitesConfig.length;b++){let S=c.sitesConfig[b];if(S.type!=e.type){let L=document.createElement("option");L.value=S.type,L.innerText=S.type,h.appendChild(L)}}d.appendChild(h),t.siteDict[p.url]=p,o.push(m)}),o.length==0&&(n.style.display="none",a.style.display="none"),n.addEventListener("click",p=>{o.forEach(d=>{d.checked=n.checked})}),this.sitesCon.appendChild(r)}close(){this.openList=[],[].forEach.call(this.sitesCon.querySelectorAll("details"),e=>{e.hasAttribute("open")&&this.openList.push(e.querySelector("summary").innerText)}),this.filterFrame.parentNode&&this.filterFrame.parentNode.removeChild(this.filterFrame)}open(e){this.init();let t=this;this.siteDict={},this.typeDict={},(!this.filterCssEle||!this.filterCssEle.parentNode)&&(this.filterCssEle=Me(this.filterCss)),document.documentElement.appendChild(this.filterFrame),this.sitesCon.innerHTML=ee(""),e.forEach(r=>{t.anylizeType(r)})}}const Qi=new Lr;var Ie,De,bi,xi,vi,wi,Kt,qt,Gt,Vt;function Pr(l,e){if(!k||!k.bar)return;let t=k.bar.querySelector(".search-jumper-type.search-jumper-open"),r=()=>{if(document.removeEventListener("dragend",vi,!0),document.removeEventListener("dragenter",wi,!0),De.parentNode&&(De.parentNode.removeChild(De),Ie.style.opacity="",Ie.style.transform=""),mt=!1,clearTimeout(Kt),ae&&!ae.hideNotMatch&&!c.prefConfig.hideOnSearchEngine||k.con.classList.contains("resizePage")){if(t&&!t.classList.contains("search-jumper-open"))if(t.children[0].onmousedown)t.children[0].onmousedown();else{let m=new PointerEvent("mousedown");t.children[0].dispatchEvent(m)}}else k.bar.style.display="none"};if(!qt&&!Gt&&(Vt=(c.prefConfig.zoomDrag||100)/100,qt=Vt*190,Gt=Vt*190),!Ie){let m=`
                    #dragCon {
                      position: fixed;
                      top: 0;
                      left: 0;
                ...
                `,h=Me(m);bi=[],xi=[],Ie=document.createElement("div"),Ie.id="searchJumperWrapper",Ie.innerHTML=ee(`
                <div class="panel"></div>
                <div class="dragLogo">${pi}</div>
                `),Ke||Ie.appendChild(h);const f=6,b=10;let S=Ie.querySelector(".panel"),L=360/f,x=360/b,N=-L/2,W=-x/2,I,H=Ie.querySelector(".dragLogo"),V;H.addEventListener("dragover",$=>{$.preventDefault()},!0),H.addEventListener("dragenter",$=>{clearTimeout(V),I&&(I.style.transform=`rotate(${I.dataset.deg}deg) ${c.prefConfig.hideDragHistory?"scale(1.2)":""}`,I.classList.remove("over")),I=null,H.style.transform="scale(1.35)",$.preventDefault(),clearTimeout(Kt),Kt=setTimeout(()=>{r(),k.appendBar(),k.showAllSites()},1e3)},!0);let F=($,Z,pe)=>{let te=document.createElement("div");te.className=$;let v=document.createElement("div");v.className="sector-inner";let z=document.createElement("span");v.appendChild(z),te.appendChild(v);let G=`rotate(${Z}deg)`;return z.style.transform=pe,te.style.transform=G+(c.prefConfig.hideDragHistory?"scale(1.2)":""),te.dataset.deg=Z,S.appendChild(te),z.addEventListener("dragover",O=>{O.clientX<50?De.style.left="0px":O.clientX>document.documentElement.clientWidth-50&&(De.style.left=document.documentElement.clientWidth-(qt<<1)+"px"),O.clientY<50?De.style.top="0px":O.clientY>document.documentElement.clientHeight-50&&(De.style.top=document.documentElement.clientHeight-(Gt<<1)+"px"),O.preventDefault()},!0),z.addEventListener("dragenter",O=>{clearTimeout(V),z.innerText&&(I&&(I.style.transform=`rotate(${I.dataset.deg}deg) ${c.prefConfig.hideDragHistory?"scale(1.2)":""}`,I.classList.remove("over")),H.style.transform="",te.style.transform=`scale(${c.prefConfig.hideDragHistory?"1.6":"1.25"}) ${G}`,te.classList.add("over"),I=te,clearTimeout(Kt))},!0),z};for(let $=0;$<f;$++){let Z=F("sector",N+L*$,`translateX(-10px) translateY(-10px) rotate(${N-L*$}deg)`);bi.push(Z)}for(let $=0;$<b;$++){let Z=F("sector out",W+x*$,`translateX(12px) translateY(-15px) rotate(${W-x*$}deg)`);xi.push(Z)}vi=$=>{r()},Ie.addEventListener("click",$=>{r()}),Ie.addEventListener("drop",$=>{$.target===H?(k.setFuncKeyCall(!1),k.showInPage()):I&&(r(),k.searchBySiteName(I.children[0].dataset.name,$),I.style.transform=`rotate(${I.dataset.deg}deg)`,I.classList.remove("over"),I=null),$.preventDefault()});let y,j,A,P;wi=$=>{clearTimeout(V),Ie.contains($.target)||(V=setTimeout(()=>{r()},300))},De=document.createElement("div"),De.id="dragCon",De.appendChild(Ie)}k.recoveHistory();let i=k.autoGetFirstType(),s=i.querySelectorAll("a.search-jumper-btn:not(.notmatch)"),n=0,a=()=>{let m=null;for(let h=n;h<s.length;h++){let f=s[h];if(f.style.display!=="none"){m=f,n=h+1;break}}return m};const o=(m,h)=>{m.parentNode.dataset.name=h.dataset.name;let f=document.createElement("p");if(f.innerText=h.dataset.name.substr(0,10).trim(),!/^\w+$/.test(f.innerText)){let L="",x=0;for(let N of f.innerText)if(L+=N,/^\w+$/.test(N)?x++:x+=2,x>10){L+="...";break}f.innerText=L}let b=document.createElement("img");b.style.display="none",m.appendChild(b),m.appendChild(f),b.onload=L=>{b.style.display=""};let S=h.querySelector("img");if(S){let L=S.src||S.dataset.src;L&&(b.src=L)}};bi.forEach((m,h)=>{m.innerHTML=ee();let f=a();if(!f){m.parentNode.parentNode.style.filter="contrast(0.5)";return}m.parentNode.parentNode.style.filter="",o(m,f)});let p=0,d;i.classList.contains("search-jumper-needInPage")?d=k.txtHistorySiteBtns:i.classList.contains("search-jumper-targetImg")?d=k.imgHistorySiteBtns:i.classList.contains("search-jumper-targetAudio")?d=k.audioHistorySiteBtns:i.classList.contains("search-jumper-targetVideo")?d=k.videoHistorySiteBtns:(i.classList.contains("search-jumper-targetLink")||i.classList.contains("search-jumper-targetPage"))&&(d=k.linkHistorySiteBtns),d?(d=d.concat(k.historySiteBtns),d=d.filter((m,h,f)=>f.indexOf(m)===h)):d=k.historySiteBtns;let u=()=>{if(c.prefConfig.reuseDragHistory)return a();if(c.prefConfig.hideDragHistory)return!1;let m=null;for(let h=p;h<d.length;h++){let f=d[h];if(f.style.display!=="none"){m=f,p=h+1;break}}return m};xi.forEach((m,h)=>{let f=new DragEvent("dragleave");m.dispatchEvent(f),m.innerHTML=ee(),m.parentNode.parentNode.style.opacity=.6;let b=u();if(!b)return;let S=b.querySelector("img");S&&S.dataset.src&&(S.src=S.dataset.src,delete S.dataset.src),m.parentNode.parentNode.style.opacity=1,o(m,b)}),De.style.left=l-qt+"px",De.style.top=e-Gt+"px",Ie.style.opacity="",Ie.style.transform="",setTimeout(()=>{document.addEventListener("dragend",vi,!0),k.addToShadow(De),setTimeout(()=>{Ie.style.opacity=1,Ie.style.transform="scale(1)"},10),setTimeout(()=>{getComputedStyle(Ie).zIndex!="2147483647"?r():document.addEventListener("dragenter",wi,!0)},100)},0)}var Q,Yt,Bt,ze,gt,He,At,$t,er,tr,ir,_t,Zt,Xt,rr;function Qt(l,e,t,r,i,s,n,a){if(self.kwFilter=s,self.charset=i,self.hideNotMatch=a,self.match=n,!Q){let p=Me(`
                    .searchJumperFrame-body,
                ...
                <div class="searchJumperFrame-body">
                    <a href="${Ae}" class="searchJumperFrame-title" target="_blank" draggable="false">
                        <img width="32px" height="32px" src="${ut}" />${M("addSearchEngine")}
                    </a>
                    <div class="searchJumperFrame-maxBtn">
                        <svg id="maxBtn" fill="white" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><title>${M("maxAddSiteBtn")}</title><path d="M192 832h160a32 32 0 0 1 0 64H160a32 32 0 0 1-32-32V672a32 32 0 0 1 64 0zM182.72 886.72a32 32 0 0 1-45.44-45.44l224-224a32 32 0 0 1 45.44 45.44zM832 832V672a32 32 0 0 1 64 0v192a32 32 0 0 1-32 32H672a32 32 0 0 1 0-64zM886.72 841.28a32 32 0 0 1-45.44 45.44l-224-224a32 32 0 0 1 45.44-45.44zM192 192v160a32 32 0 0 1-64 0V160a32 32 0 0 1 32-32h192a32 32 0 0 1 0 64zM137.28 182.72a32 32 0 0 1 45.44-45.44l224 224a32 32 0 0 1-45.44 45.44zM832 192H672a32 32 0 0 1 0-64h192a32 32 0 0 1 32 32v192a32 32 0 0 1-64 0zM841.28 137.28a32 32 0 1 1 45.44 45.44l-224 224a32 32 0 0 1-45.44-45.44z"></path></svg>
                        <svg id="minBtn" fill="white" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><title>${M("minAddSiteBtn")}</title><path d="M672 352h160a32 32 0 0 1 0 64H640a32 32 0 0 1-32-32V192a32 32 0 0 1 64 0zM662.72 406.72a32 32 0 0 1-45.44-45.44l224-224a32 32 0 1 1 45.44 45.44zM352 352V192a32 32 0 0 1 64 0v192a32 32 0 0 1-32 32H192a32 32 0 0 1 0-64zM406.72 361.28a32 32 0 0 1-45.44 45.44l-224-224a32 32 0 0 1 45.44-45.44zM672 672v160a32 32 0 0 1-64 0V640a32 32 0 0 1 32-32h192a32 32 0 0 1 0 64zM617.28 662.72a32 32 0 0 1 45.44-45.44l224 224a32 32 0 0 1-45.44 45.44zM192 672a32 32 0 0 1 0-64h192a32 32 0 0 1 32 32v192a32 32 0 0 1-64 0V672zM361.28 617.28a32 32 0 0 1 45.44 45.44l-224 224a32 32 0 0 1-45.44-45.44z"></path></svg>
                    </div>
                    <div class="searchJumperFrame-inputs">
                        <div class="searchJumperFrame-input-title">${M("siteName")}</div>
                        <input name="siteName" type="text" />
                        <div class="searchJumperFrame-input-title">${M("siteUrl")}</div>
                        <textarea name="url" type="text"></textarea>
                        <svg id="crawlBtn" class="sideIcon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><title>${M("crawlInfo")}</title><path d="M385 926.3c-11 0-21.4-4.3-29.2-12l-0.6-0.6c-0.7-0.7-65.6-70.4-108.4-112.7-42.8-42.3-118.6-111.4-119.3-112.1l-0.6-0.5c-15.9-15.7-24.6-36.6-24.5-58.8s9-43.1 25-58.6c28.6-27.7 72.2-31 104.6-8.2l90.5 44-83.1-290.1c-4.9-17.1-4.2-34.9 2.1-51.6 6.3-16.6 17.5-30.5 32.5-40.1 22-14.1 47.7-17.7 70.3-10 22.6 7.7 40.7 26.3 49.5 50.9L431 369.8V176.9c0-43.4 35.3-78.7 78.7-78.7 20.7 0 40.2 7.9 55 22.4 14.8 14.4 23.2 33.8 23.7 54.4v0.2l2.4 165.5L625 229.1l0.1-0.4c8.2-23.2 26.2-41.1 49.4-49.3 23.2-8.2 48.5-5.5 69.4 7.3 15.6 9.6 27.7 24.3 33.9 41.6s6.4 36.3 0.6 53.7L736 409.5l42.9-48.6 0.3-0.3c15.7-16.2 34.4-25.7 54.1-27.3 19.8-1.6 39.1 4.7 56 18.1 33 26.4 40.8 60.1 22.7 97.5l-0.5 1.1-0.6 1c-41.8 65.2-107.1 171.9-115.8 199-12.4 38.6-41 140.7-41.3 141.7l-0.2 0.7-34.5 107.2-0.6 1.2c-6.8 14.3-21.5 23.7-37.4 23.8l-295.9 1.6c0 0.1-0.1 0.1-0.2 0.1z"></path></svg>
                        <div class="searchJumperFrame-input-title">${M("siteDesc")}</div>
                        <textarea name="description" type="text"></textarea>
                        <div class="searchJumperFrame-input-title">${M("siteIcon")}</div>
                    ...
                    <div class="searchJumperFrame-inputs moreItem">
                        <div class="searchJumperFrame-input-title">${M("siteKeywords")}</div>
                        <input name="siteKeywords" placeholder="kw|key" type="text" />
                        <div class="searchJumperFrame-input-title">${M("siteMatch")}</div>
                        <input name="siteMatch" placeholder="(www|m)\\.google\\.com" type="text" />
                        <div class="searchJumperFrame-input-title">${M("openSelect")}</div>
                        <select name="openSelect">
                            <option value="-1">${M("openInDefault")}</option>
                            <option value="true">${M("openInNewTab")}</option>
                            <option value="false">${M("openInCurrent")}</option>
                        </select>
                    </div>
                    <div class="iconsCon"></div>
                    <div class="searchJumperFrame-input-title">${M("siteType")}</div>
                    <select name="typeSelect">
                    </select>
                    <div class="searchJumperFrame-buttons">
                        <button id="test" type="button">${M("siteTest")}</button>
                        <button id="cancel" type="button">${M("siteCancel")}</button>
                        <button id="add" type="button">${M("siteAdd")}</button>
                    </div>
                </div>
                <div class="searchJumperFrame-crawlBody searchJumperFrame-hide">
                    <a href="${Ae}" class="searchJumperFrame-title" target="_blank">
                        <img width="32px" height="32px" src="${ut}" />${M("addAction")}
                    </a>
                    ...
                    <div class="searchJumperFrame-buttons">
                        <button id="input" type="button" title="${M("emuInputTips")}">${M("inputAction")}</button>
                        <button id="click" type="button" title="${M("emuClickTips")}">${M("clickAction")}</button>
                        <button id="sleep" type="button" title="${M("emuWaitTips")}">${M("sleepAction")}</button>
                    </div>
                    <div class="searchJumperFrame-buttons">
                        <button id="copy" type="button" title="${M("emuCopyTips")}">${M("copyAction")}</button>
                    </div>
                    <div class="searchJumperFrame-buttons">
                        <button id="record" type="button" title="${M("emuRecordTips")}">${M("recordAction")}</button>
                    </div>
                    <div class="searchJumperFrame-buttons">
                        <button id="loop" type="button" title="${M("emuLoopTips")}">${M("loopAction")}</button>
                    </div>
                    <div class="searchJumperFrame-buttons">
                        <button id="submitCrawl" type="button" title="${M("emuStopTips")}">${M("submitCrawl")}</button>
                    </div>
                </div>
                `),Ke||Q.appendChild(p);let d=Q.children[0];Yt=Q.querySelector("[name='siteName']"),Bt=Q.querySelector("[name='description']"),ze=Q.querySelector("[name='url']"),gt=Q.querySelector("[name='icon']"),He=Q.querySelector(".searchJumperFrame-inputs>img"),At=Q.querySelector(".iconsCon"),er=Q.querySelector("#test"),tr=Q.querySelector("#cancel"),ir=Q.querySelector("#add"),$t=Q.querySelector("select[name='typeSelect']"),_t=Q.querySelector("[name='siteKeywords']"),Zt=Q.querySelector("[name='siteMatch']"),Xt=Q.querySelector("select[name='openSelect']");let u=Q.querySelector(".searchJumperFrame-title"),m,h,f=!1,b=T=>{f||(Q.classList.add("draging"),f=!0);let w=T.clientX-m.x+h.x,g=T.clientY-m.y+h.y;d.style.marginLeft=w+"px",d.style.marginTop=g+"px"},S=T=>{T.preventDefault(),T.stopPropagation(),Q.classList.remove("draging"),document.removeEventListener("mousemove",b),document.removeEventListener("mouseup",S)};u.addEventListener("mousedown",T=>{T.preventDefault(),T.stopPropagation(),f=!1,m={x:T.clientX,y:T.clientY};let w=getComputedStyle(d);h={x:parseInt(w.marginLeft||0),y:parseInt(w.marginTop||0)},document.addEventListener("mousemove",b),document.addEventListener("mouseup",S)}),He.onload=T=>{He.style.display=""},Q.querySelector("#maxBtn").addEventListener("click",T=>{Q.classList.add("maxContent")}),Q.querySelector("#minBtn").addEventListener("click",T=>{Q.classList.remove("maxContent")});for(let T=0;T<c.sitesConfig.length;T++){let w=c.sitesConfig[T],g=document.createElement("option");g.value=T,ci!==""&&ci==T&&(g.selected="selected"),g.innerText=w.type,$t.appendChild(g)}er.addEventListener("click",T=>{if(/#p{/.test(ze.value)){let w=ze.value.match(/#p{(.*)}/);if(!w)return;let g=[];w[1].replace(/([^\\])&/g,"$1SJ^PARAM").split("SJ^PARAM").forEach(C=>{if(C=C.trim(),/^loopStart\(\d+\)$/.test(C)){let E=C.match(/loopStart\((.*)\)/);g.push(["@loopStart",E[1]])}else if(C=="loopEnd")g.push(["@loopEnd",""]);else if(C.startsWith("click(")&&C.endsWith(")")){let E=C.slice(6,C.length-1);E&&g.push(["@click",E.replace(/\\([\=&])/g,"$1").trim()])}else if(C.startsWith("dblclick(")&&C.endsWith(")")){let E=C.slice(9,C.length-1);E&&g.push(["@dblclick",E.replace(/\\([\=&])/g,"$1").trim()])}else if(C.startsWith("rclick(")&&C.endsWith(")")){let E=C.slice(7,C.length-1);E&&g.push(["@rclick",E.replace(/\\([\=&])/g,"$1").trim()])}else if(C.startsWith("copy(")&&C.endsWith(")")){let E=C.slice(5,C.length-1);E&&g.push(["@copy",E.replace(/\\([\=&])/g,"$1").trim()])}else if(C.startsWith("call(")&&C.endsWith(")")){let E=C.slice(5,C.length-1);E&&g.push(["@call",E.replace(/\\([\=&])/g,"$1").trim()])}else if(C.startsWith("wait(")&&C.endsWith(")")){let E=C.slice(5,C.length-1);g.push(["@wait",E.replace(/\\([\=&])/g,"$1").trim()])}else if(/^sleep\(\d+\)$/.test(C)){let E=C.match(/sleep\((.*)\)/);E&&g.push(["@sleep",E[1]])}else if(/^reload\(\d?\)$/.test(C)){let E=C.match(/reload\((.*)\)/);g.push(["@reload",E[1]])}else{C=C.replace(/([^\\])\=/g,"$1SJ^PARAM").replace(/\\([\=&])/g,"$1");let E=C.split("SJ^PARAM");if(E.length===2){let J=E[0],R=E[1].replace(/\\([\=&])/g,"$1");g.push([J,R])}else(C.endsWith(".click()")||C.endsWith(".click"))&&g.push(["@"+C.replace(/\.click(\(\))?$/,""),"click"])}}),Ge=g,k.submitAction(g)}else/[:%]p{/.test(ze.value)||i&&i.toLowerCase()!="utf-8"?fi(i,ze.value.replace(/%se?\b/g,"searchJumper"),"_blank"):ge(ze.value.replace(/%se?\b/g,"searchJumper"),{active:!0,insert:!0})}),tr.addEventListener("click",T=>{Q.parentNode&&Q.parentNode.removeChild(Q)}),ir.addEventListener("click",T=>{Te||Dt(()=>{let w=null;for(let g=0;g<c.sitesConfig.length;g++){let C=c.sitesConfig[g];for(let E=0;E<C.sites.length;E++){let J=C.sites[E];if(J.url==ze.value){if(g==parseInt($t.value)){alert("Already added!");return}if(window.confirm(M("siteExist")))w={name:J.name+" - "+C.type,url:`["${J.name}"]`};else return}}}w==null&&(w={name:Yt.value,url:ze.value},gt.value&&gt.value!=ze.value.replace(/\?.*/,"").replace(/^(https?:\/\/[^\/]*\/)[\s\S]*$/,"$1favicon.ico")&&(w.icon=gt.value),Bt.value&&Bt.value!=Yt.value&&(w.description=Bt.value),_t.value&&(w.keywords=_t.value),Zt.value&&(w.match=Zt.value),Xt.value&&Xt.value!="-1"&&(w.openInNewTab=Xt.value==="true"),self.charset&&i.toLowerCase()!="utf-8"&&(w.charset=self.charset),self.kwFilter&&(w.kwFilter=self.kwFilter),self.match&&(w.match=self.match),self.hideNotMatch&&(w.hideNotMatch=self.hideNotMatch)),c.sitesConfig[$t.value].sites.push(w),c.lastModified=new Date().getTime(),K.setItem("lastAddType",$t.value),K.setItem("searchData",c),Ce(M("siteAddOver")),Q.parentNode&&Q.parentNode.removeChild(Q),window.postMessage({searchData:c,version:pt.script.version||0,command:"loadConfig"},"*"),k.refreshEngines()})}),rr=Q.querySelector("#crawlBtn");let N=Q.querySelector(".searchJumperFrame-closeBtn"),W=Q.querySelector(".actionCon"),I=Q.querySelector("#input"),H=Q.querySelector("#click"),V=Q.querySelector("#sleep"),F=Q.querySelector("#copy"),y=Q.querySelector("#submitCrawl"),j=Q.querySelector("#record"),A=Q.querySelector("#loop"),P,$=(T,w="",g="")=>{let C=document.createElement("div"),E=T;switch(T){case"input":E=M("inputOutput",[w,g]);break;case"click":E=M("clickOutput",w);break;case"dblclick":E=M("dblclickOutput",w);break;case"rclick":E=M("rclickOutput",w);break;case"copy":E=M("copyOutput",w);break;case"loopStart":E=M("loopStart",g);break;case"loopEnd":E=M("loopEnd");break;case"sleep":E=M("sleepOutput",g);break;default:break}E&&(C.innerHTML=ee(E),C.dataset.type=T,C.dataset.sel=w,C.dataset.val=g,C.draggable="true",C.ondragover=J=>{J.preventDefault()},C.ondragstart=J=>{P=C},C.ondrop=J=>{W.insertBefore(P,C)},C.onclick=J=>{let R=J.target;if(R.nodeName.toUpperCase()=="SPAN")if(R.className=="element")ke.getSelector(U=>{R.innerText=U,R.title=U,Q.style.display="",C.dataset.sel=U}),Q.style.display="none";else{let U=prompt(M("inputNewValue"),R.innerText);U&&(R.innerText=U,R.title=U,C.dataset.val=U)}else confirm(M("deleteConfirm"))&&W.removeChild(C)},C.oncontextmenu=J=>{let R=J.target;if(R.nodeName.toUpperCase()=="SPAN")if(J.preventDefault(),R.className=="element"){let U=prompt("Selector",R.innerText);U&&(R.innerText=U,R.title=U,C.dataset.sel=U)}else{let U=prompt(M("inputNewValue"),R.innerText);U&&(R.innerText=U,R.title=U,C.dataset.val=U)}},W.appendChild(C))},Z=()=>{W.innerHTML=ee();let T=ze.value.match(/#p{(.*)}/);T&&T[1].replace(/([^\\])&/g,"$1SJ^PARAM").split("SJ^PARAM").forEach(w=>{if(w=w.trim(),/^loopStart\(\d+\)$/.test(w)){let g=w.match(/loopStart\((.*)\)/);$("loopStart","",g[1])}else if(w=="loopEnd")$("loopEnd");else if(w.startsWith("click(")&&w.endsWith(")")){let g=w.slice(6,w.length-1);g&&$("click",g.replace(/\\([\=&])/g,"$1").trim())}else if(w.startsWith("dblclick(")&&w.endsWith(")")){let g=w.slice(9,w.length-1);g&&$("dblclick",g.replace(/\\([\=&])/g,"$1").trim())}else if(w.startsWith("rclick(")&&w.endsWith(")")){let g=w.slice(7,w.length-1);g&&$("rclick",g.replace(/\\([\=&])/g,"$1").trim())}else if(w.startsWith("copy(")&&w.endsWith(")")){let g=w.slice(5,w.length-1);g&&$("copy",g.replace(/\\([\=&])/g,"$1").trim())}else if(w.startsWith("call(")&&w.endsWith(")")){let g=w.slice(5,w.length-1);g&&$("call","",g.replace(/\\([\=&])/g,"$1").trim())}else if(w.startsWith("wait(")&&w.endsWith(")")){let g=w.slice(5,w.length-1);g&&$("wait","",g.replace(/\\([\=&])/g,"$1").trim())}else if(w.startsWith("open(")&&w.endsWith(")")){let g=w.slice(5,w.length-1);g&&$("open","",g.replace(/\\([\=&])/g,"$1").trim())}else if(/^sleep\(\d+\)$/.test(w)){let g=w.match(/sleep\((.*)\)/);g&&$("sleep","",g[1])}else if(/^reload\(\d?\)$/.test(w)){let g=w.match(/reload\((.*)\)/);$("reload","",g[1])}else{w=w.replace(/([^\\])\=/g,"$1SJ^PARAM").replace(/\\([\=&])/g,"$1");let g=w.split("SJ^PARAM");g.length===2?$("input",g[0],g[1].replace(/\\([\=&])/g,"$1")):(w.endsWith(".click()")||w.endsWith(".click"))&&$("click",w.replace(/\.click(\(\))?$/,""))}})},pe=()=>{let T=[];return[].forEach.call(W.children,w=>{if(!w)return;let g=w.dataset.sel,C=w.dataset.val||"";switch(w.dataset.type){case"click":T.push(`click(${g.replace(/([=&])/g,"\\$1")})`);break;case"dblclick":T.push(`dblclick(${g.replace(/([=&])/g,"\\$1")})`);break;case"rclick":T.push(`rclick(${g.replace(/([=&])/g,"\\$1")})`);break;case"copy":T.push(`copy(${g.replace(/([=&])/g,"\\$1")})`);break;case"input":T.push(`${g.replace(/([=&])/g,"\\$1")}=${C}`);break;case"sleep":T.push(`sleep(${C})`);break;case"loopEnd":T.push("loopEnd");break;default:T.push(`${w.dataset.type}(${C.replace(/([=&])/g,"\\$1")})`);break}}),T.join("&")};rr.addEventListener("click",T=>{Z(),Q.classList.add("crawling")}),N.addEventListener("click",T=>{Q.classList.remove("crawling")});let te,v,z=T=>{Q.style.display!==""&&(/INPUT|TEXTAREA|SELECT|OPTION/i.test(T.target.nodeName)||(clearTimeout(v),v=setTimeout(()=>{$("click",ke.geneSelector(T.target,!0))},300)))},G=T=>{Q.style.display!==""&&(/INPUT|TEXTAREA|SELECT|OPTION/i.test(T.target.nodeName)||(clearTimeout(v),$("dblclick",ke.geneSelector(T.target,!0))))},O=T=>{Q.style.display!==""&&(/INPUT|TEXTAREA|SELECT|OPTION/i.test(T.target.nodeName)||(T.preventDefault(),clearTimeout(v),$("rclick",ke.geneSelector(T.target,!0))))},ie=T=>{Q.style.display!==""&&$("input",ke.geneSelector(T.target,!0),T.target.value)},re=T=>{if(Q.style.display==="")return;let w=!1;T.keyCode==27?w=!0:T.keyCode==13&&(T.preventDefault(),T.stopPropagation(),T.target&&T.target.blur&&T.target.blur(),w=!0),w&&(Q.style.display="",document.removeEventListener("keydown",re,!0),document.removeEventListener("click",z),document.removeEventListener("dblclick",G),document.removeEventListener("contextmenu",O),document.removeEventListener("change",ie))};j.addEventListener("click",T=>{alert(M("startRecord")),Q.style.display="none",setTimeout(()=>{document.addEventListener("keydown",re,!0),document.addEventListener("click",z),document.addEventListener("dblclick",G),document.addEventListener("contextmenu",O),document.addEventListener("change",ie)},100)});let D=!1;A.addEventListener("click",T=>{if(D)$("loopEnd"),A.innerText=M("loopAction");else{let w=prompt(M("loopTimes"),1);if(!w)return;$("loopStart","",w||"1"),A.innerText=M("loopActionEnd")}D=!D}),I.addEventListener("click",T=>{ke.getSelector(w=>{$("input",w,"%s"),Q.style.display=""},!D),Q.style.display="none"}),F.addEventListener("click",T=>{ke.getSelector(w=>{$("copy",w,"%s"),Q.style.display=""},!D),Q.style.display="none"}),H.addEventListener("dblclick",T=>{clearTimeout(v),T.preventDefault(),T.stopPropagation(),ke.getSelector(w=>{$("dblclick",w),Q.style.display=""},!D),Q.style.display="none"}),H.addEventListener("contextmenu",T=>{clearTimeout(v),T.preventDefault(),T.stopPropagation(),ke.getSelector(w=>{$("rclick",w),Q.style.display=""},!D),Q.style.display="none"}),H.addEventListener("click",T=>{clearTimeout(v),v=setTimeout(()=>{ke.getSelector(w=>{$("click",w),Q.style.display=""},!D),Q.style.display="none"},250)}),V.addEventListener("click",T=>{let w=prompt(M("sleepPrompt"),1e3);w=w&&parseInt(w),w&&$("sleep","",w)}),y.addEventListener("click",T=>{let w=pe();w&&(ze.value=location.href+"#p{"+w+"}"),Q.classList.remove("crawling")})}k.addToShadow(Q),_t.value="",Zt.value="",Yt.value=l||"",Bt.value=e||"",ze.value=t||"",r&&r[0]?(He.style.display="",t.indexOf(location.origin)===0?(He.onerror=o=>{He.onerror=null,gt.value=r[0],He.src=r[0]},He.src=location.origin+"/favicon.ico"):(gt.value=r[0],He.src=r[0])):(He.style.display="none",He.src=(/^(showTips:)?https?:/.test(t)?t.split(`
`)[0].replace(/\?.*/,"").replace(/^(showTips:)?(https?:\/\/[^\/]+).*/,"$2"):location.origin)+"/favicon.ico"),At.innerHTML=ee(),r&&r.length>1?(At.style.opacity="",r.forEach(o=>{let p=document.createElement("img");p.src=o,p.addEventListener("click",d=>{gt.value=o,He.src=o}),p.onload=d=>{p.title=p.naturalWidth+" x "+p.naturalHeight+`
`+o.replace(/.*\/([^\/]+)/,"$1")},At.appendChild(p)})):At.style.opacity=0}function Mr(){let l=document.createElement("a");l.download="searchJumperCache.json",l.target="_blank";let e=[JSON.stringify({sortTypeNames:Le,cacheIcon:be,sortSiteNames:Pe},null,4)],t=new Blob(e,{type:"application/json"});l.href=window.URL.createObjectURL(t),l.click()}function Nr(l){l.cacheIcon&&(be=l.cacheIcon,K.setItem("cacheIcon",be),Je=[],c.prefConfig.cacheSwitch=!0,K.setItem("searchData",c)),l.sortTypeNames&&(Le=l.sortTypeNames,K.setItem("sortTypeNames",Le)),l.sortSiteNames&&(Pe=l.sortSiteNames,K.setItem("sortSiteNames",Pe))}function sr(l,e){Be({method:"GET",url:l,headers:{referer:l,origin:l},onload:t=>{let r=t&&t.responseXML&&t.responseXML.querySelector('Url[type="text/html"]');if(!r){e("error",t);return}let i=t.responseXML.querySelector("ShortName"),s=t.responseXML.querySelector("Description"),n=t.responseXML.querySelector("Image"),a=t.responseXML.querySelector("InputEncoding"),o=r.querySelectorAll("Param"),p=i&&i.textContent,d=s&&s.textContent,u=r.getAttribute("template"),m=n&&n.textContent,h=a&&a.textContent;if(o.length>0){let f=[];[].forEach.call(o,b=>{f.push(`${b.getAttribute("name")}=${b.getAttribute("value")}`)}),u+=`%p{${f.join("&")}}`}Qt(p,d,u.replace(/{searchTerms\??}/g,"%s").replace(/{startPage\??}/g,"1").replace(/{count\??}/g,"10").replace(/{startIndex\??}/g,"1").replace(/{startPage\??}/g,"1").replace(/{language\??}/g,"*").replace(/{inputEncoding\??}/g,"UTF-8").replace(/{outputEncoding\??}/g,"UTF-8"),[m],h),e("load",t)},onerror:t=>{e("error",t)},ontimeout:t=>{e("error",t)}})}function Br(){if(location.hostname!=="mycroftproject.com")return;Me(`
            ...
            `);let l=()=>{let t=document.querySelectorAll("img.icon~a[href^='/install']");if(t.length<=0)return;let r=!1;[].forEach.call(t,i=>{if(i.previousElementSibling&&i.previousElementSibling.classList.contains("searchJumperIcon")||i.previousElementSibling&&i.previousElementSibling.previousElementSibling&&i.previousElementSibling.previousElementSibling.classList.contains("searchJumperIcon"))return;let s=i.href.match(/\?id=(\d+)&basename=(.+?)&/);if(s===null)return;let n=document.createElement("img");n.className="icon searchJumperIcon",n.style.cssText="border: 1px solid #4c4c4c; border-radius: 9px; box-sizing: border-box; margin-right: 4px; cursor: pointer;",n.title="Add to SearchJumper",n.src=ut,i.parentNode.insertBefore(n,i),n.onclick=a=>{r||(r=!0,n.classList.add("searchJumper-loading"),sr(`https://mycroftproject.com/installos.php/${s[1]}/${s[2]}.xml`,(o,p)=>{r=!1,n.classList.remove("searchJumper-loading"),o!="load"&&Ce(p.statusText||p.error)}))}})};l();let e=setInterval(()=>{l()},1e3);window.addEventListener("load",t=>{clearInterval(e),l()})}function Ar(){k=new yr}function $r(){if(et){if(k.appendBar(),k.showAllSites(),setTimeout(()=>{k.con.style.zIndex=0},5),location.hash){let l=location.hash.slice(1);try{l=decodeURIComponent(l)}catch{}k.searchJumperInputKeyWords.value=l}else if(location.search){let l=location.search.slice(1).split("&"),e,t,r;l.forEach(i=>{let s=i.split("="),n=s[0],a=s[1];try{a=decodeURIComponent(a)}catch{}switch(n){case"kw":e=a;break;case"engine":t=a;break;case"self":r=a;break}}),e&&(k.searchJumperInputKeyWords.value=e||""),t&&k.searchBySiteName(t,{},!!r)}if(_(document).style.cssText=`
                    ...
                    overflow: hidden;
                `,c.prefConfig.bgUrl&&(_e=c.prefConfig.bgUrl,_e.length)){_(document).style.backgroundImage=`url("${_e}")`;return}K.getItem("allPageBg",l=>{l?(_e=l.url,_(document).style.backgroundImage=`url("${l.base64||_e}")`):l={url:""},Be({method:"GET",url:"https://global.bing.com/HPImageArchive.aspx?format=js&idx=0&pid=hp&video=1&n=1",onload:function(e){var t=null;try{t=JSON.parse(e.responseText);var r=t.images[0].url;if(/^https?:\/\//.test(r)||(r="https://global.bing.com"+r),_e=r,r==l.url)return;Be({method:"GET",url:r,responseType:"blob",onload:function(i){var s=i.response,n=new FileReader;n.readAsDataURL(s),n.onload=function(a){var o=a.target.result;l={url:r,base64:o},K.setItem("allPageBg",l)}}}),l.base64||(_(document).style.backgroundImage=`url("${r}")`)}catch(i){console.log(i)}}})})}}async function Wr(){await k.initRun(),kr(),$r()}async function $e(l){await new Promise(e=>{setTimeout(()=>{e()},l)})}async function Dr(){let l=await new Promise(e=>{K.getItem("searchData",t=>{e(t)})});Ee=await new Promise(e=>{K.getItem("cacheKeywords",t=>{e(t||"")})}),xt=await new Promise(e=>{K.getItem("cacheFilter",t=>{e(t||"")})}),li=await new Promise(e=>{K.getItem("disableState",t=>{e(t||!1)})}),tt=await new Promise(e=>{K.getItem("tipsStorage",t=>{e(t||[])})}),Tt=await new Promise(e=>{K.getItem("lastSign",t=>{e(t||!1)})}),K.setItem("lastSign",!1),Ge=await K.getListItem("inPagePostParams",location.hostname),be=await new Promise(e=>{K.getItem("cacheIcon",t=>{e(t||{})})}),Ve=await new Promise(e=>{K.getItem("historySites",t=>{e(t||[])})}),kt=await new Promise(e=>{K.getItem("historyType",t=>{e(t||"")})}),Le=await new Promise(e=>{K.getItem("sortTypeNames",t=>{e(t||{})})}),Pe=await new Promise(e=>{K.getItem("sortSiteNames",t=>{e(t||{})})}),Ne=await new Promise(e=>{K.getItem("globalInPageWords",t=>{e(t||"")})}),Ye=await new Promise(e=>{K.getItem("navEnable",t=>{e(typeof t>"u"?!0:t)})}),zt=await new Promise(e=>{K.getItem("referrer",t=>{e(t||"")})}),Ht=await new Promise(e=>{K.getItem("disableHighlight",t=>{e(t||"")})}),Ji=await new Promise(e=>{K.getItem("lastHighlight",t=>{e(t||"")})}),zi=await new Promise(e=>{K.getItem("allPageNewMode",t=>{e(t||!1)})}),ci=await new Promise(e=>{K.getItem("lastAddType",t=>{e(t||"")})}),l&&(c=l,jt=c.lastModified),c.lastModified||(c.sitesConfig=sitesConfig),c.prefConfig.lang&&c.prefConfig.lang!="0"&&(Fe=c.prefConfig.lang),Ai(),c.prefConfig.firstRun&&K.supportCrossSave()&&(c.prefConfig.firstRun=!1,K.setItem("searchData",c),setTimeout(()=>{K.getItem("searchData",e=>{e.prefConfig.firstRun===!1&&ge(Ni,{active:!0,insert:!0})})},100)),typeof c.prefConfig.customSize>"u"&&(c.prefConfig.customSize=100),typeof c.prefConfig.tilesZoom>"u"&&(c.prefConfig.tilesZoom=100),typeof c.prefConfig.tipsZoom>"u"&&(c.prefConfig.tipsZoom=100),typeof c.prefConfig.typeOpenTime>"u"&&(c.prefConfig.typeOpenTime=250),typeof c.prefConfig.longPressTime>"u"&&(c.prefConfig.longPressTime=500),typeof c.prefConfig.cacheSwitch>"u"&&(c.prefConfig.cacheSwitch=!1),typeof c.prefConfig.noIcons>"u"&&(c.prefConfig.noIcons=!1),typeof c.prefConfig.noAni>"u"&&(c.prefConfig.noAni=!1),typeof c.prefConfig.quickAddRule>"u"&&(c.prefConfig.quickAddRule=!0),typeof c.prefConfig.multiline>"u"&&(c.prefConfig.multiline=2),typeof c.prefConfig.multilineGap>"u"&&(c.prefConfig.multilineGap=1e3),typeof c.prefConfig.historyLength>"u"&&(c.prefConfig.historyLength=0),typeof c.prefConfig.dragToSearch>"u"&&(c.prefConfig.dragToSearch=!0),typeof c.prefConfig.firstFiveWordsColor>"u"&&(c.prefConfig.firstFiveWordsColor=[]),typeof c.prefConfig.inPageWordsStyles>"u"&&(c.prefConfig.inPageWordsStyles=[]),typeof c.prefConfig.rightMouse>"u"&&(c.prefConfig.rightMouse=!0),typeof c.prefConfig.mouseLeaveToHide>"u"&&(c.prefConfig.mouseLeaveToHide=!0),typeof c.prefConfig.currentTypeFirst>"u"&&(c.prefConfig.currentTypeFirst=!0),typeof c.prefConfig.disableAddon>"u"&&(c.prefConfig.disableAddon={}),typeof c.prefConfig.suggestType>"u"&&(Fe==="zh-CN"?c.prefConfig.suggestType="baidu":c.prefConfig.suggestType="google"),typeof c.prefConfig.syncBuild>"u"&&(c.prefConfig.syncBuild=!0),c.prefConfig.minSizeMode&&(c.prefConfig.disableAutoOpen=!1,c.prefConfig.disableTypeOpen=!1),c.prefConfig.configPage?Ae=c.prefConfig.configPage:c.prefConfig.configPage=Ae}function ei(l,e){return l==="*"||l.length==0&&e.length==0?!0:l.length>1&&l[0]=="*"&&e.length==0?!1:l.length>1&&l[0]=="?"||l.length!=0&&e.length!=0&&l[0]==e[0]?ei(l.substring(1),e.substring(1)):l.length>0&&l[0]=="*"?ei(l.substring(1),e)||ei(l,e.substring(1)):!1}if(ue.indexOf("#searchJumperMin")!=-1)if(Ri=!0,ue.indexOf("#searchJumperMinPost")!=-1)window.history.replaceState(null,"",ue.replace(/#searchJumperMin(Post)?/,""));else{if(ue.indexOf("#searchJumperMinMobile")!=-1){Object.defineProperty(Object.getPrototypeOf(navigator),"userAgent",{get:function(){return Mi}}),Be({method:"GET",url:location.href,headers:{referer:location.href,"User-Agent":Mi},onload:function(l){document.open(),document.write(l.response),document.close()},onerror:function(){},ontimeout:function(){}});return}window.history.replaceState(null,"",location.href.replace(/#searchJumperMin(Mobile)?/,""))}if(document.title=="SearchJumper Multi")return;var ar=!1,Si,Ci,yt;async function Ti(l){if(ar){l&&l();return}if(ar=!0,Ir(),await Dr(),!li){if(c.prefConfig.blacklist&&c.prefConfig.blacklist.length>0){let e=!1;for(let t=0;t<c.prefConfig.blacklist.length;t++){let r=c.prefConfig.blacklist[t];if(r&&r.indexOf("//")!=0){if(e){/\*\/$/.test(r)&&(e=!1);continue}if(r.indexOf("/*")==0){e=!0;continue}if(r.indexOf("/")==0){let i=r.match(/^\/(.*)\/(\w*)$/);if(i&&new RegExp(i[1],i[2]).test(ue))return}else if(ei(r,ue))return}}}Ar(),await Er(),Br(),Wr(),l&&l(),yt=document.title}}function Jr(){if(document.hidden){if(k)k.closeShowAll();else return;if(!c.prefConfig.globalSearchNow)return;Si=setInterval(async()=>{let l=Ne;Ne=await K.getItem("globalInPageWords"),(l||"")!=(Ne||"")&&(k.refreshPageWords(),k.navMarks.innerHTML&&(clearInterval(Si),clearInterval(Ci),yt=document.title,Ci=setInterval(()=>{document.title=document.title==yt?"\u{1F6A9}":yt},500)))},parseInt(500+Math.random()*500));return}Ti(async()=>{(at||c.prefConfig.syncBuild)&&(c=await K.getItem("searchData"),k&&c.lastModified&&jt!=c.lastModified&&(k.refreshEngines(),document.dispatchEvent(new Event("dataChanged"))));let l=Ne||"";K.getItem("globalInPageWords",t=>{Ne=t||"",l!=Ne&&k&&k.refreshPageWords()});let e=Ye||!1;K.getItem("navEnable",t=>{Ye=typeof t>"u"?!0:t,e!=Ye&&k&&k.refreshNav()})})}var ki=!1;function zr(){!document.head||!_(document)||St||li||(c.prefConfig.globalSearchNow&&(clearInterval(Si),clearInterval(Ci),document.hidden?yt=document.title:yt&&(document.title=yt)),!ki&&(ki=!0,setTimeout(()=>{Jr(),ki=!1},500)))}K.getItem("postUrl",l=>{if(l&&l[0].indexOf(location.hostname.replace(/.*\.(\w+\.\w+)/,"$1"))!=-1)K.setItem("postUrl",""),fi(l[1],l[0],"_self");else{if(document.head&&_(document))Ti();else{let e=()=>{document.head&&_(document)?Ti():setTimeout(()=>{e()},10)};e()}document.addEventListener("visibilitychange",zr)}})}if(document&&document.documentElement)Bi();else{let Fe=()=>{document&&document.documentElement?Bi():setTimeout(()=>{Fe()},10)};Fe()}})();
