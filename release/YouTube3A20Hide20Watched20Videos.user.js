...
// @grant        GM_getValue
// @grant        GM_setValue
// @downloadURL https://raw.githubusercontent.com/AzimsTech/Userscripts/release/release/YouTube3A20Hide20Watched20Videos.user.js
// @updateURL https://raw.githubusercontent.com/AzimsTech/Userscripts/release/release/YouTube3A20Hide20Watched20Videos.meta.js
// ==/UserScript==
const REGEX_CHANNEL=/.*\/(user|channel|c)\/.+\/videos/u,REGEX_USER=/.*\/@.*/u;(V=>{if(typeof trustedTypes<"u"&&trustedTypes.defaultPolicy===null){const e=s=>s;trustedTypes.createPolicy("default",{createHTML:e,createScript:e,createScriptURL:e})}const a=document.createElement("a");a.textContent="YouTube: Hide Watched Videos Settings",a.href="https://github.com/EvHaus/youtube-hide-watched",a.target="_blank";const p=new GM_config({events:{save(){this.close()}},fields:{HIDDEN_THRESHOLD_PERCENT:{default:10,label:"Hide/Dim Videos Above Percent",max:100,min:0,type:"int"}},id:"YouTubeHideWatchedVideos",title:a});localStorage.YTHWV_WATCHED=localStorage.YTHWV_WATCHED||"false";const l=(...e)=>{};(e=>{const s=document.getElementsByTagName("head")[0];if(s){const t=document.createElement("style");return t.setAttribute("type","text/css"),t.textContent=e,s.appendChild(t),t}return null})(`
